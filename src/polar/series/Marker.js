goog.provide('anychart.polar.series.Marker');
 ...
 * <b>Note:</b> Better for use methods {@link anychart.polar.Chart#marker}.
 * @example
 * anychart.polar.series.marker([1, 4, 7, 1]).container(stage).draw();
 ...
 */
anychart.polar.series.Marker = function(data, opt_csvSettings) {
  ...
  this.marker_.zIndex(anychart.polar.series.Base.ZINDEX_SERIES);
...
goog.inherits(anychart.polar.series.Marker, anychart.polar.series.Base);
anychart.polar.series.Base.SeriesTypesMap[anychart.enums.PolarSeriesType.MARKER] = anychart.polar.series.Marker;
 ...
 *    return path;
 *  }</code>.
 * @return {!anychart.polar.series.Marker} {@link anychart.polar.series.Marker} instance for method chaining.
 *//**
 * @ignoreDoc
 * @param {(string|anychart.enums.MarkerType|
 *          function(acgraph.vector.Path, number, number, number):acgraph.vector.Path)=} opt_value .
 * @return {!anychart.polar.series.Marker|anychart.enums.MarkerType|string|
 *          function(acgraph.vector.Path, number, number, number):acgraph.vector.Path} .
 */
anychart.polar.series.Marker.prototype.type = function(opt_value) {
 ...
 * @example <c>By Enum value.</c>
 * anychart.polar.series.marker([10, 11, 17, 7, 21])
 *    .type('star4')
 *    .hoverType('star6')
 ...
 *          function(acgraph.vector.Path, number, number, number):acgraph.vector.Path} .
 */
anychart.polar.series.Marker.prototype.hoverType = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {anychart.polar.series.Marker} {@link anychart.polar.series.Marker} class for method chaining.
 *//**
 * @ignoreDoc
 * @param {number=} opt_value .
 * @return {anychart.polar.series.Marker|number} .
 */
anychart.polar.series.Marker.prototype.size = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {anychart.polar.series.Marker|number} .
 */
anychart.polar.series.Marker.prototype.hoverSize = function(opt_value) {
  if (goog.isDef(opt_value)) {
...
/** @inheritDoc */
anychart.polar.series.Marker.prototype.drawSubsequentPoint = function() {
...
/** @inheritDoc */
anychart.polar.series.Marker.prototype.createPositionProvider = function(position) {
...
/** @inheritDoc */
anychart.polar.series.Marker.prototype.startDrawing = function() {
  ...
  if (this.hasInvalidationState(anychart.ConsistencyState.HATCH_FILL)) {
    ...
    if (!this.hatchFillElement_ && !anychart.utils.isNone(fill)) {
      ...
      this.hatchFillElement_.container(/** @type {acgraph.vector.ILayer} */(this.rootLayer));
      this.hatchFillElement_.zIndex(anychart.polar.series.Base.ZINDEX_HATCH_FILL);
...
/** @inheritDoc */
anychart.polar.series.Marker.prototype.finalizeDrawing = function() {
 ...
 * @return {!anychart.polar.series.Marker} {@link anychart.polar.series.Marker} instance for method chaining.
 */
anychart.polar.series.Marker.prototype.hoverSeries = function() {
  this.unhover();
  return this;
};
 ...
 * @return {!anychart.polar.series.Marker} {@link anychart.polar.series.Marker} instance for method chaining.
 */
anychart.polar.series.Marker.prototype.hoverPoint = function(index, event) {
 ...
 * @return {!anychart.polar.series.Marker} {@link anychart.polar.series.Marker} instance for method chaining.
 */
anychart.polar.series.Marker.prototype.unhover = function() {
 ...
 * @private
 */
anychart.polar.series.Marker.prototype.drawMarker_ = function(hovered, opt_updateMarker) {
 ...
 * @protected
 */
anychart.polar.series.Marker.prototype.applyHatchFill = function(hovered) {
  if (this.hatchFillElement_) {
    var iterator = this.getIterator();
 ...
 * @private
 */
anychart.polar.series.Marker.prototype.handleMouseOver_ = function(event) {
 ...
 * @private
 */
anychart.polar.series.Marker.prototype.handleMouseOut_ = function(event) {
  var markerElement = this.marker_.getMarker(event['markerIndex']).getDomElement();
 ...
 * @private
 */
anychart.polar.series.Marker.prototype.handleMouseMove_ = function(event) {
 ...
 * @inheritDoc
 */
anychart.polar.series.Marker.prototype.getType = function() {
 ...
 * @inheritDoc
 */
anychart.polar.series.Marker.prototype.serialize = function() {
...
/** @inheritDoc */
anychart.polar.series.Marker.prototype.restoreDefaults = function() {
 ...
 * @inheritDoc
 */
anychart.polar.series.Marker.prototype.deserialize = function(config) {
 ...
 * @param {Object.<string, (string|boolean)>=} opt_csvSettings If CSV string is passed, you can pass CSV parser settings
 *    here as a hash map.
 * @return {!anychart.polar.series.Marker}
 */
anychart.polar.series.marker = function(data, opt_csvSettings) {
  return new anychart.polar.series.Marker(data, opt_csvSettings);
};


//exports
goog.exportSymbol('anychart.polar.series.marker', anychart.polar.series.marker);
anychart.polar.series.Marker.prototype['stroke'] = anychart.polar.series.Marker.prototype.stroke;
anychart.polar.series.Marker.prototype['hoverStroke'] = anychart.polar.series.Marker.prototype.hoverStroke;
anychart.polar.series.Marker.prototype['fill'] = anychart.polar.series.Marker.prototype.fill;
anychart.polar.series.Marker.prototype['hoverFill'] = anychart.polar.series.Marker.prototype.hoverFill;
anychart.polar.series.Marker.prototype['size'] = anychart.polar.series.Marker.prototype.size;
anychart.polar.series.Marker.prototype['hoverSize'] = anychart.polar.series.Marker.prototype.hoverSize;
anychart.polar.series.Marker.prototype['type'] = anychart.polar.series.Marker.prototype.type;
anychart.polar.series.Marker.prototype['hoverType'] = anychart.polar.series.Marker.prototype.hoverType;
anychart.polar.series.Marker.prototype['startDrawing'] = anychart.polar.series.Marker.prototype.startDrawing;
anychart.polar.series.Marker.prototype['finalizeDrawing'] = anychart.polar.series.Marker.prototype.finalizeDrawing;
anychart.polar.series.Marker.prototype['hoverSeries'] = anychart.polar.series.Marker.prototype.hoverSeries;
anychart.polar.series.Marker.prototype['hoverPoint'] = anychart.polar.series.Marker.prototype.hoverPoint;
anychart.polar.series.Marker.prototype['unhover'] = anychart.polar.series.Marker.prototype.unhover;
anychart.polar.series.Marker.prototype['hatchFill'] = anychart.polar.series.Marker.prototype.hatchFill;
anychart.polar.series.Marker.prototype['hoverHatchFill'] = anychart.polar.series.Marker.prototype.hoverHatchFill;
