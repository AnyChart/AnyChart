goog.provide('anychart.polar.series.Base');
 ...
 * <b>Note:</b> Better for use methods {@link anychart.polar.Chart#line} or {@link anychart.Chart#lineChart}.
 * @example
 * anychart.polar.series.line([1, 4, 7, 1]).container(stage).draw();
 ...
 */
anychart.polar.series.Base = function(data, opt_csvSettings) {
...
goog.inherits(anychart.polar.series.Base, anychart.VisualBaseWithBounds);
 ...
 */
anychart.polar.series.Base.SeriesTypesMap = {};
 ...
 */
anychart.polar.series.Base.prototype.calculateSizeScale = goog.nullFunction;
 ...
 * @param {number} max .
 */
anychart.polar.series.Base.prototype.setAutoSizeScale = goog.nullFunction;
 ...
 * @type {number}
 */
anychart.polar.series.Base.prototype.SUPPORTED_SIGNALS =
 ...
 * @type {number}
 */
anychart.polar.series.Base.prototype.SUPPORTED_CONSISTENCY_STATES =
 ...
 */
anychart.polar.series.Base.DEFAULT_HATCH_FILL_TYPE = acgraph.vector.HatchFill.HatchFillType.DIAGONAL_BRICK;
 ...
 * @type {number}
 */
anychart.polar.series.Base.ZINDEX_SERIES = 1;
 ...
 * @type {number}
 */
anychart.polar.series.Base.ZINDEX_HATCH_FILL = 2;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.name_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.index_;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.rootLayer;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.meta_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.data_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.startAngle_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.statistics_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.parentView_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.parentViewToDispose_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.iterator_;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.firstPointDrawn = false;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.yScale_ = null;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.xScale_ = null;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.labels_ = null;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.hoverLabels_ = null;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.tooltip_ = null;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.radius;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.cx;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.cy;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.color_ = null;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.autoColor_ = null;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.autoHatchFill_;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.hatchFill_ = (function() {
 ...
 * @private
 */
anychart.polar.series.Base.prototype.hoverHatchFill_;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.autoMarkerType;
 ...
 * @private
 */
anychart.polar.series.Base.prototype.fill_ = (function() {
 ...
 * @private
 */
anychart.polar.series.Base.prototype.hoverFill_ = (function() {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.strokeInternal = (function() {
 ...
 * @private
 */
anychart.polar.series.Base.prototype.hoverStroke_ = null;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.handleLabelMouseOver = function(event) {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.handleLabelMouseOut = function(event) {
  var labelElement = this.labels().getLabel(event['labelIndex']).getDomElement();
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.handleLabelMouseMove = function(event) {
 ...
 * @return {anychart.polar.series.Base|Object.<number>|number}
 */
anychart.polar.series.Base.prototype.statistics = function(opt_name, opt_value) {
 ...
 * @return {!anychart.polar.series.Base} {@link anychart.polar.series.Base} instance for method chaining.
 *//**
 * @ignoreDoc
 * @param {string=} opt_value Series name value.
 * @return {!(string|anychart.polar.series.Base|undefined)} Series name value or itself for method chaining.
 */
anychart.polar.series.Base.prototype.name = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {anychart.polar.series.Base|number}
 */
anychart.polar.series.Base.prototype.index = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 */
anychart.polar.series.Base.prototype.meta = function(opt_object_or_key, opt_value) {
 ...
 * @return {(!anychart.polar.series.Base|!anychart.data.View)} Returns itself if used as a setter or the mapping if used as a getter.
 */
anychart.polar.series.Base.prototype.data = function(opt_value, opt_csvSettings) {
  if (goog.isDef(opt_value)) {
 ...
 * @private
 */
anychart.polar.series.Base.prototype.dataInvalidated_ = function(e) {
 ...
 * @return {(string|number|anychart.polar.series.Base)} .
 */
anychart.polar.series.Base.prototype.startAngle = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 */
anychart.polar.series.Base.prototype.getIterator = function() {
 ...
 */
anychart.polar.series.Base.prototype.getResetIterator = function() {
 ...
 */
anychart.polar.series.Base.prototype.getReferenceScaleValues = function() {
 ...
 * @return {Array.<number>} .
 */
anychart.polar.series.Base.prototype.approximateCurve = function(startPoint, endPoint) {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.getValuePointCoords = function() {
  if (!this.enabled())
    return null;
 ...
 * @return {boolean}
 */
anychart.polar.series.Base.prototype.hasMarkers = function() {
  return false;
};
 ...
 */
anychart.polar.series.Base.prototype.drawPoint = function() {
  if (this.enabled()) {
...
/** @inheritDoc */
anychart.polar.series.Base.prototype.remove = function() {
  if (this.rootLayer)
 ...
 */
anychart.polar.series.Base.prototype.startDrawing = function() {
 ...
 */
anychart.polar.series.Base.prototype.finalizeDrawing = function() {
  this.labels().draw();
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.drawLabel = function(hovered) {
 ...
 */
anychart.polar.series.Base.prototype.showTooltip = function(opt_event) {
  var tooltip = /** @type {anychart.elements.Tooltip} */(this.tooltip());
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.hideTooltip = function() {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.createFormatProvider = function() {
  var iterator = this.getIterator();
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.createPositionProvider = function(position) {
  var iterator = this.getIterator();
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.drawFirstPoint = function() {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.drawSubsequentPoint = goog.abstractMethod;
 ...
 */
anychart.polar.series.Base.prototype.getIndexByEvent = function(event) {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.handleMouseOver = function(event) {
  var res = this.dispatchEvent(new anychart.polar.series.Base.BrowserEvent(this, event));
  if (res) {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.handleMouseMove = function(event) {
  var res = this.dispatchEvent(new anychart.polar.series.Base.BrowserEvent(this, event));
  if (res) {
    if (event && event.target) {
      var index = this.getIndexByEvent(event);
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.handleMouseOut = function(event) {
  var res = this.dispatchEvent(new anychart.polar.series.Base.BrowserEvent(this, event));
  if (res) {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.handleBrowserEvents = function(event) {
  this.dispatchEvent(new anychart.polar.series.Base.BrowserEvent(this, event));
};
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.hoverStatus = NaN;


/**
 * Hovers all points of the series. Use <b>unhover</b> method for unhover series.
 * @return {!anychart.polar.series.Base} An instance of the {@link anychart.polar.series.Base} class for method chaining.
 */
anychart.polar.series.Base.prototype.hoverSeries = goog.abstractMethod;
 ...
 * @return {!anychart.polar.series.Base}  {@link anychart.polar.series.Base} instance for method chaining.
 */
anychart.polar.series.Base.prototype.hoverPoint = goog.abstractMethod;
 ...
 * @return {!anychart.polar.series.Base} {@link anychart.polar.series.Base} instance for method chaining.
 */
anychart.polar.series.Base.prototype.unhover = goog.abstractMethod;
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.makeHoverable = function(element, opt_seriesGlobal) {
  if (!element) return;
  if (opt_seriesGlobal)
 ...
 * @ignoreDoc
 * @param {anychart.scales.Base=} opt_value Value to set.
 * @return {(anychart.scales.Base|anychart.polar.series.Base)} Series X Scale or itself for chaining call.
 */
anychart.polar.series.Base.prototype.xScale = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @ignoreDoc
 * @param {anychart.scales.Base=} opt_value Value to set.
 * @return {(anychart.scales.Base|anychart.polar.series.Base)} Series Y Scale or itself for chaining call.
 */
anychart.polar.series.Base.prototype.yScale = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @private
 */
anychart.polar.series.Base.prototype.scaleInvalidated_ = function(event) {
  var signal = 0;
 ...
 * @ignoreDoc
 * @param {(null|string|Object|anychart.elements.Tooltip)=} opt_value Tooltip settings.
 * @return {!(anychart.polar.series.Base|anychart.elements.Tooltip)} Tooltip instance or itself for chaining call.
 */
anychart.polar.series.Base.prototype.tooltip = function(opt_value) {
  if (!this.tooltip_) {
 ...
 * @private
 */
anychart.polar.series.Base.prototype.onTooltipSignal_ = function(event) {
  var tooltip = /** @type {anychart.elements.Tooltip} */(this.tooltip());
  tooltip.redraw();
};
 ...
 * @ignoreDoc
 * @param {(anychart.elements.LabelsFactory|Object|string|null)=} opt_value Series data labels settings.
 * @return {!(anychart.elements.LabelsFactory|anychart.polar.series.Base)} Labels instance or itself for chaining call.
 */
anychart.polar.series.Base.prototype.labels = function(opt_value) {
  if (!this.labels_) {
 ...
 * @return {!(anychart.elements.LabelsFactory|anychart.polar.series.Base)} Labels instance or itself for chaining call.
 */
anychart.polar.series.Base.prototype.hoverLabels = function(opt_value) {
  if (!this.hoverLabels_) {
 ...
 * @private
 */
anychart.polar.series.Base.prototype.labelsInvalidated_ = function(event) {
 ...
 */
anychart.polar.series.Base.prototype.calculateStatistics = function() {
 ...
 * @param {number=} opt_fx .
 * @param {number=} opt_fy .
 * @return {!(acgraph.vector.Fill|anychart.polar.series.Base)} .
 */
anychart.polar.series.Base.prototype.color = function(opt_fillOrColorOrKeys, opt_opacityOrAngleOrCx, opt_modeOrCy, opt_opacityOrMode, opt_opacity, opt_fx, opt_fy) {
 ...
 */
anychart.polar.series.Base.prototype.setAutoColor = function(value) {
 ...
 */
anychart.polar.series.Base.prototype.setAutoMarkerType = function(value) {
 ...
 */
anychart.polar.series.Base.prototype.setAutoHatchFill = function(value) {
 ...
 * @param {number=} opt_thickness Thickness.
 * @param {number=} opt_size Pattern size.
 * @return {acgraph.vector.PatternFill|acgraph.vector.HatchFill|anychart.polar.series.Base|Function|boolean} Hatch fill.
 */
anychart.polar.series.Base.prototype.hatchFill = function(opt_patternFillOrTypeOrState, opt_color, opt_thickness, opt_size) {
 ...
 * @return {acgraph.vector.PatternFill|acgraph.vector.HatchFill|anychart.polar.series.Base|Function|boolean} Hatch fill.
 */
anychart.polar.series.Base.prototype.hoverHatchFill = function(opt_patternFillOrTypeOrState, opt_color, opt_thickness, opt_size) {
  if (goog.isDef(opt_patternFillOrTypeOrState)) {
    var hatchFill = goog.isFunction(opt_patternFillOrTypeOrState) || goog.isBoolean(opt_patternFillOrTypeOrState) ?
        opt_patternFillOrTypeOrState :
        acgraph.vector.normalizeHatchFill.apply(null, arguments);
 ...
 */
anychart.polar.series.Base.prototype.getFinalHatchFill = function(usePointSettings, hover) {
  var iterator = this.getIterator();
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.normalizeHatchFill = function(hatchFill) {
  var fill;
  var index = this.getIterator().getIndex();
  if (goog.isFunction(hatchFill)) {
    var sourceHatchFill = this.autoHatchFill_ ||
        acgraph.vector.normalizeHatchFill(anychart.polar.series.Base.DEFAULT_HATCH_FILL_TYPE);
    var scope = {
      'index': index,
 ...
 * @param {number=} opt_fx .
 * @param {number=} opt_fy .
 * @return {acgraph.vector.Fill|anychart.polar.series.Base|Function} .
 */
anychart.polar.series.Base.prototype.fill = function(opt_fillOrColorOrKeys, opt_opacityOrAngleOrCx, opt_modeOrCy, opt_opacityOrMode, opt_opacity, opt_fx, opt_fy) {
  if (goog.isDef(opt_fillOrColorOrKeys)) {
 ...
 * @return {acgraph.vector.Fill|anychart.polar.series.Base|Function} .
 */
anychart.polar.series.Base.prototype.hoverFill = function(opt_fillOrColorOrKeys, opt_opacityOrAngleOrCx, opt_modeOrCy, opt_opacityOrMode, opt_opacity, opt_fx, opt_fy) {
  if (goog.isDef(opt_fillOrColorOrKeys)) {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.getFinalFill = function(usePointSettings, hover) {
  var iterator = this.getIterator();
 ...
 * @param {acgraph.vector.StrokeLineCap=} opt_lineCap Line cap style.
 * @return {anychart.polar.series.Base|acgraph.vector.Stroke|Function} .
 */
anychart.polar.series.Base.prototype.stroke = function(opt_strokeOrFill, opt_thickness, opt_dashpattern, opt_lineJoin, opt_lineCap) {
 ...
 * @return {anychart.polar.series.Base|acgraph.vector.Stroke|Function} .
 */
anychart.polar.series.Base.prototype.hoverStroke = function(opt_strokeOrFill, opt_thickness, opt_dashpattern, opt_lineJoin, opt_lineCap) {
  if (goog.isDef(opt_strokeOrFill)) {
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.getFinalStroke = function(usePointSettings, hover) {
  var iterator = this.getIterator();
 ...
 * @protected
 */
anychart.polar.series.Base.prototype.normalizeColor = function(color, var_args) {
  var fill;
 ...
 */
anychart.polar.series.Base.prototype.getLegendItemData = function() {
 ...
 * @return {anychart.polar.series.Base} Return itself for chaining call.
 */
anychart.polar.series.Base.prototype.restoreDefaults = function() {
  return this;
};
 ...
 */
anychart.polar.series.Base.prototype.getType = goog.abstractMethod;
 ...
 */
anychart.polar.series.Base.prototype.getLegendIconType = function() {
 ...
 * @inheritDoc
 */
anychart.polar.series.Base.prototype.serialize = function() {
 ...
 * @inheritDoc
 */
anychart.polar.series.Base.prototype.deserialize = function(config) {
  this.suspendSignalsDispatching();
 ...
 * @param {anychart.polar.series.Base} target EventTarget to be set as a target of the event.
 * @param {goog.events.BrowserEvent=} opt_e Normalized browser event to initialize this event.
 * @constructor
 * @extends {goog.events.BrowserEvent}
 */
anychart.polar.series.Base.BrowserEvent = function(target, opt_e) {
  goog.base(this);
  if (opt_e)
...
goog.inherits(anychart.polar.series.Base.BrowserEvent, goog.events.BrowserEvent);
 ...
 */
anychart.polar.series.Base.BrowserEvent.prototype.event_;
 ...
 */
anychart.polar.series.Base.BrowserEvent.prototype.copyFrom = function(e, opt_target) {
  var type = e.type;
  switch (type) {
...
//exports
anychart.polar.series.Base.prototype['color'] = anychart.polar.series.Base.prototype.color;
anychart.polar.series.Base.prototype['name'] = anychart.polar.series.Base.prototype.name;
anychart.polar.series.Base.prototype['meta'] = anychart.polar.series.Base.prototype.meta;
anychart.polar.series.Base.prototype['data'] = anychart.polar.series.Base.prototype.data;
anychart.polar.series.Base.prototype['drawPoint'] = anychart.polar.series.Base.prototype.drawPoint;
anychart.polar.series.Base.prototype['startDrawing'] = anychart.polar.series.Base.prototype.startDrawing;
anychart.polar.series.Base.prototype['finalizeDrawing'] = anychart.polar.series.Base.prototype.finalizeDrawing;
anychart.polar.series.Base.prototype['labels'] = anychart.polar.series.Base.prototype.labels;
anychart.polar.series.Base.prototype['tooltip'] = anychart.polar.series.Base.prototype.tooltip;
anychart.polar.series.Base.prototype['getIterator'] = anychart.polar.series.Base.prototype.getIterator;
anychart.polar.series.Base.prototype['getResetIterator'] = anychart.polar.series.Base.prototype.getResetIterator;
anychart.polar.series.Base.prototype['xScale'] = anychart.polar.series.Base.prototype.xScale;
anychart.polar.series.Base.prototype['yScale'] = anychart.polar.series.Base.prototype.yScale;
