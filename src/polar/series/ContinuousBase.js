goog.provide('anychart.polar.series.ContinuousBase');
 ...
 *    here as a hash map.
 * @constructor
 * @extends {anychart.polar.series.Base}
 */
anychart.polar.series.ContinuousBase = function(data, opt_csvSettings) {
  ...
  this.path.zIndex(anychart.polar.series.Base.ZINDEX_SERIES);
...
goog.inherits(anychart.polar.series.ContinuousBase, anychart.polar.series.Base);
 ...
 * @type {number}
 */
anychart.polar.series.ContinuousBase.prototype.SUPPORTED_CONSISTENCY_STATES =
 ...
 * @private
 */
anychart.polar.series.ContinuousBase.prototype.markers_ = null;
 ...
 * @private
 */
anychart.polar.series.ContinuousBase.prototype.hoverMarkers_ = null;


/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.hasMarkers = function() {
  return true;
};
 ...
 * @return {!anychart.polar.series.ContinuousBase} {@link anychart.polar.series.ContinuousBase} instance for method chaining.
 *//**
 * @ignoreDoc
 * @param {(anychart.elements.MarkersFactory|Object|string|null)=} opt_value Series data markers settings.
 * @return {!(anychart.elements.MarkersFactory|anychart.polar.series.ContinuousBase)} Markers instance or itself for chaining call.
 */
anychart.polar.series.ContinuousBase.prototype.markers = function(opt_value) {
  if (!this.markers_) {
 ...
 * @return {!(anychart.elements.MarkersFactory|anychart.polar.series.ContinuousBase)} Markers instance or itself for chaining call.
 */
anychart.polar.series.ContinuousBase.prototype.hoverMarkers = function(opt_value) {
 ...
 * @private
 */
anychart.polar.series.ContinuousBase.prototype.markersInvalidated_ = function(event) {
 ...
 * @return {!anychart.polar.series.ContinuousBase|boolean} .
 */
anychart.polar.series.ContinuousBase.prototype.closed = function(opt_value) {
  if (goog.isDef(opt_value)) {
    opt_value = !!opt_value;
 ...
 */
anychart.polar.series.ContinuousBase.prototype.drawPoint = function() {
  if (this.enabled()) {
    var pointDrawn;
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.startDrawing = function() {
  ...
  if (this.hasInvalidationState(anychart.ConsistencyState.HATCH_FILL)) {
    if (!this.hatchFillPath) {
      ...
      this.hatchFillPath.parent(/** @type {acgraph.vector.ILayer} */(this.rootLayer));
      this.hatchFillPath.zIndex(anychart.polar.series.Base.ZINDEX_HATCH_FILL);
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.finalizeDrawing = function() {
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.remove = function() {
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.createPositionProvider = function(position) {
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.finalizeSegment = goog.nullFunction;
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.finalizeHatchFill = goog.nullFunction;
 ...
 * @return {!anychart.polar.series.Base|boolean} The setting, or itself for method chaining.
 */
anychart.polar.series.ContinuousBase.prototype.connectMissingPoints = function(opt_value) {
  if (goog.isDef(opt_value)) {
    opt_value = !!opt_value;
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.colorizeShape = function(hover) {
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.applyHatchFill = function(hover) {
  if (this.hatchFillPath) {
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.hoverSeries = function() {
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.hoverPoint = function(index, event) {
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.unhover = function() {
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.handleMarkerMouseOver = function(event) {
  if (this.dispatchEvent(new anychart.polar.series.Base.BrowserEvent(this, event))) {
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.handleMarkerMouseOut = function(event) {
  if (this.dispatchEvent(new anychart.polar.series.Base.BrowserEvent(this, event))) {
    var markerElement = this.markers().getMarker(event['markerIndex']).getDomElement();
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.handleMarkerMouseMove = function(event) {
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.handleMarkerBrowserEvents = function(event) {
 ...
 * @protected
 */
anychart.polar.series.ContinuousBase.prototype.drawMarker = function(hovered) {
 ...
 */
anychart.polar.series.ContinuousBase.prototype.getMarkerFill = function() {
 ...
 */
anychart.polar.series.ContinuousBase.prototype.getMarkerStroke = function() {
 ...
 * @inheritDoc
 */
anychart.polar.series.ContinuousBase.prototype.getLegendItemData = function() {
 ...
 * @inheritDoc
 */
anychart.polar.series.ContinuousBase.prototype.serialize = function() {
 ...
 * @inheritDoc
 */
anychart.polar.series.ContinuousBase.prototype.deserialize = function(config) {
...
/** @inheritDoc */
anychart.polar.series.ContinuousBase.prototype.restoreDefaults = function() {
...
//exports
anychart.polar.series.ContinuousBase.prototype['startDrawing'] = anychart.polar.series.ContinuousBase.prototype.startDrawing;
anychart.polar.series.ContinuousBase.prototype['drawPoint'] = anychart.polar.series.ContinuousBase.prototype.drawPoint;
anychart.polar.series.ContinuousBase.prototype['finalizeDrawing'] = anychart.polar.series.ContinuousBase.prototype.finalizeDrawing;
anychart.polar.series.ContinuousBase.prototype['markers'] = anychart.polar.series.ContinuousBase.prototype.markers;
anychart.polar.series.ContinuousBase.prototype['hoverMarkers'] = anychart.polar.series.ContinuousBase.prototype.hoverMarkers;
anychart.polar.series.ContinuousBase.prototype['startDrawing'] = anychart.polar.series.ContinuousBase.prototype.startDrawing;
anychart.polar.series.ContinuousBase.prototype['hoverSeries'] = anychart.polar.series.ContinuousBase.prototype.hoverSeries;
anychart.polar.series.ContinuousBase.prototype['hoverPoint'] = anychart.polar.series.ContinuousBase.prototype.hoverPoint;
anychart.polar.series.ContinuousBase.prototype['unhover'] = anychart.polar.series.ContinuousBase.prototype.unhover;
anychart.polar.series.ContinuousBase.prototype['connectMissingPoints'] = anychart.polar.series.ContinuousBase.prototype.connectMissingPoints;
anychart.polar.series.ContinuousBase.prototype['closed'] = anychart.polar.series.ContinuousBase.prototype.closed;
