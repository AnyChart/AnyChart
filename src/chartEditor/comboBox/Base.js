...
anychart.chartEditorModule.comboBox.Base = function(opt_domHelper, opt_menu, opt_labelInput) {
  anychart.chartEditorModule.comboBox.Base.base(this, 'constructor', opt_domHelper, opt_menu, opt_labelInput);
 ...
 * @private
 */
anychart.chartEditorModule.comboBox.Base.prototype.key_ = '';
 ...
 */
anychart.chartEditorModule.comboBox.Base.prototype.update = function(model) {
  ...
  var value = String(anychart.chartEditorModule.Controller.getset(model, goog.isArray(this.key_) ? this.key_[0] : this.key_));
  this.setValue(value);
