 ...
 * @constructor
 * @extends {anychart.chartEditorModule.select.Renderer}
 */
...
goog.inherits(anychart.chartEditorModule.colorPicker.Renderer, anychart.chartEditorModule.select.Renderer);
