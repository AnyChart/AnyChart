 ...
 * @private
 */
anychart.chartEditorModule.colorPicker.Base.prototype.key_ = '';
...
anychart.chartEditorModule.colorPicker.Base.prototype.update = function(model) {
  var color = anychart.chartEditorModule.Controller.getset(model, goog.isArray(this.key_) ? this.key_[0] : this.key_);
