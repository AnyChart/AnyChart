...
goog.require('anychart.chartEditorModule.select.Align');
goog.require('anychart.chartEditorModule.select.Base');
goog.require('anychart.chartEditorModule.select.FontFamily');
 ...
 */
anychart.chartEditorModule.settings.Title = function() {
  anychart.chartEditorModule.settings.Title.base(this, 'constructor');

  this.enabled_ = true;
};
goog.inherits(anychart.chartEditorModule.settings.Title, goog.ui.Component);
 ...
 * @type {string}
 */
anychart.chartEditorModule.settings.Title.CSS_CLASS = goog.getCssName('anychart-chart-editor-settings-title');
 ...
 * @private
 */
anychart.chartEditorModule.settings.Title.prototype.enabledButtonContainer_ = null;
 ...
 */
anychart.chartEditorModule.settings.Title.prototype.setEnabledButtonContainer = function(enabledButtonContainer) {
 ...
 * @private
 */
anychart.chartEditorModule.settings.Title.prototype.headerText_ = 'Title';


/** @param {string} value */
anychart.chartEditorModule.settings.Title.prototype.setHeaderText = function(value) {
 ...
 * @private
 */
anychart.chartEditorModule.settings.Title.prototype.allowEnabled_ = true;


/** @param {boolean} value */
anychart.chartEditorModule.settings.Title.prototype.allowEnabled = function(value) {
...
/** @param {boolean} value */
anychart.chartEditorModule.settings.Title.prototype.allowEditPosition = function(value) {
 ...
 * @private
 */
anychart.chartEditorModule.settings.Title.prototype.key_ = '';


/** @param {string|Array.<string>} value */
anychart.chartEditorModule.settings.Title.prototype.setKey = function(value) {
  if (this.key_ != value) {
    this.key_ = value;
    this.updateKeys();
  }
 ...
 * @return {Array.<string>}
 */
anychart.chartEditorModule.settings.Title.prototype.genKey = function(value) {
 ...
 *     title settings.
 */
anychart.chartEditorModule.settings.Title.prototype.setEnabled = function(enabled) {
  this.enabled_ = true;
 ...
 */
anychart.chartEditorModule.settings.Title.prototype.isEnabled = function() {
...
anychart.chartEditorModule.settings.Title.prototype.createDom = function() {
  ...
  if (this.allowEditTitle_) {
    textInput = new anychart.chartEditorModule.settings.Input(/*'Chart title'*/);
  ...
  var fontFamily = new anychart.chartEditorModule.select.FontFamily();
 ...
 */
anychart.chartEditorModule.settings.Title.prototype.update = function(model) {
