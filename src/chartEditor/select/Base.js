goog.provide('anychart.chartEditorModule.select.Base');
 ...
 */
anychart.chartEditorModule.select.Base = function(opt_caption, opt_menu, opt_renderer, opt_domHelper, opt_menuRenderer) {
  anychart.chartEditorModule.select.Base.base(this, 'constructor', opt_caption, opt_menu,
      opt_renderer || anychart.chartEditorModule.select.Renderer.getInstance(),
...
goog.inherits(anychart.chartEditorModule.select.Base, goog.ui.Select);
 ...
 * @private
 */
anychart.chartEditorModule.select.Base.prototype.options_;
 ...
 * @private
 */
anychart.chartEditorModule.select.Base.prototype.captions_;
 ...
 * @private
 */
anychart.chartEditorModule.select.Base.prototype.icons_;
 ...
 */
anychart.chartEditorModule.select.Base.prototype.setOptions = function(value) {
  this.options_ = value;
};
 ...
 * @param {Array.<?string>} value
 */
anychart.chartEditorModule.select.Base.prototype.setCaptions = function(value) {
 ...
 * @param {Array.<string>} value
 */
anychart.chartEditorModule.select.Base.prototype.setIcons = function(value) {
  this.icons_ = value;
};
 ...
 * @private
 */
anychart.chartEditorModule.select.Base.prototype.key_ = '';


/** @param {string|Array.<string>} value */
anychart.chartEditorModule.select.Base.prototype.setKey = function(value) {
  this.key_ = value;
};
 ...
 */
anychart.chartEditorModule.select.Base.prototype.getKey = function() {
  return this.key_;
};


/** @override */
anychart.chartEditorModule.select.Base.prototype.createDom = function() {
  anychart.chartEditorModule.select.Base.base(this, 'createDom');
 ...
 * Update options.
 */
anychart.chartEditorModule.select.Base.prototype.updateOptions = function() {
 ...
 * @return {Array|string}
 */
anychart.chartEditorModule.select.Base.prototype.createContentElements = function(option, caption, icon) {
...
anychart.chartEditorModule.select.Base.prototype.update = function(model) {
...
/** @override */
anychart.chartEditorModule.select.Base.prototype.enterDocument = function() {
  anychart.chartEditorModule.select.Base.base(this, 'enterDocument');
...
/** @override */
anychart.chartEditorModule.select.Base.prototype.exitDocument = function() {
  goog.events.unlisten(this, goog.ui.Component.EventType.CHANGE, this.onChange, false, this);

  anychart.chartEditorModule.select.Base.base(this, 'exitDocument');
};
 ...
 * @protected
 */
anychart.chartEditorModule.select.Base.prototype.onChange = function(evt) {
  evt.preventDefault();
  evt.stopPropagation();
 ...
 * @suppress {visibility}
 */
anychart.chartEditorModule.select.Base.prototype.updateCaption = function() {
