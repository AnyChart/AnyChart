goog.provide('anychart.mapModule.ChoroplethPoint');
 ...
 * @param {anychart.mapModule.Series} series Series.
 * @param {number} index Point index in series.
 * @constructor
 * @extends {anychart.core.SeriesPoint}
 */
anychart.mapModule.ChoroplethPoint = function(series, index) {
  anychart.mapModule.ChoroplethPoint.base(this, 'constructor', series, index);
};
goog.inherits(anychart.mapModule.ChoroplethPoint, anychart.core.SeriesPoint);
 ...
 */
anychart.mapModule.ChoroplethPoint.prototype.getFeatureProp = function() {
 ...
 */
anychart.mapModule.ChoroplethPoint.prototype.getFeatureBounds = function() {
  var iterator = this.series.getIterator();
  iterator.select(this.index);
  var features = iterator.meta('features');
 ...
 * @return {number|anychart.mapModule.ChoroplethPoint} middleX value in ratio relative feature bounds.
 */
anychart.mapModule.ChoroplethPoint.prototype.middleX = function(opt_value) {
 ...
 * @return {number|anychart.mapModule.ChoroplethPoint} middleY value in ratio relative feature bounds.
 */
anychart.mapModule.ChoroplethPoint.prototype.middleY = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {Array.<number>|anychart.mapModule.ChoroplethPoint} Itself for chaining or feature translation.
 */
 ...
 * @return {anychart.mapModule.ChoroplethPoint} Itself for chaining or feature translation.
 */
anychart.mapModule.ChoroplethPoint.prototype.translate = function(dx, dy) {
  var map = /** @type {anychart.mapModule.Chart} */(this.getChart());
 ...
 * @return {string|anychart.mapModule.ChoroplethPoint} Radius in pixels.
 */
anychart.mapModule.ChoroplethPoint.prototype.crs = function(opt_crs) {
  var map = /** @type {anychart.mapModule.Chart} */(this.getChart());
 ...
 * @return {number|anychart.mapModule.ChoroplethPoint} Radius in pixels.
 */
anychart.mapModule.ChoroplethPoint.prototype.scaleFactor = function(opt_scale) {
  var map = /** @type {anychart.mapModule.Chart} */(this.getChart());
...
//exports
(function() {
  var proto = anychart.mapModule.ChoroplethPoint.prototype;
