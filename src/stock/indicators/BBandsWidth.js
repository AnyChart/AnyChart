 ...
 */
anychart.stockModule.indicators.BBandsWidth = function(plot, mapping, opt_period, opt_deviation, opt_seriesType) {
  anychart.stockModule.indicators.BBandsWidth.base(this, 'constructor', plot, mapping);
