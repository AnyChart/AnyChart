 ...
 */
anychart.stockModule.indicators.CCI = function(plot, mapping, opt_period, opt_seriesType) {
  anychart.stockModule.indicators.CCI.base(this, 'constructor', plot, mapping);
