 ...
 */
anychart.stockModule.indicators.BBandsB = function(plot, mapping, opt_period, opt_deviation, opt_seriesType) {
  anychart.stockModule.indicators.BBandsB.base(this, 'constructor', plot, mapping);
