 ...
 */
anychart.stockModule.indicators.RoC = function(plot, mapping, opt_period, opt_seriesType) {
  anychart.stockModule.indicators.RoC.base(this, 'constructor', plot, mapping);
