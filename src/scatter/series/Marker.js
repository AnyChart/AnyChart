goog.provide('anychart.scatter.series.Marker');
 ...
 * <b>Note:</b> Better for use methods {@link anychart.scatter.Chart#marker}.
 * @example
 * anychart.scatter.series.marker([1, 4, 7, 1]).container(stage).draw();
 ...
 */
anychart.scatter.series.Marker = function(data, opt_csvSettings) {
  ...
  this.marker_.zIndex(anychart.scatter.series.Base.ZINDEX_SERIES);
...
goog.inherits(anychart.scatter.series.Marker, anychart.scatter.series.Base);
anychart.scatter.series.Base.SeriesTypesMap[anychart.enums.ScatterSeriesTypes.MARKER] = anychart.scatter.series.Marker;
 ...
 * @protected
 */
anychart.scatter.series.Marker.prototype.autoMarkerType_;


/** @inheritDoc */
anychart.scatter.series.Marker.prototype.setAutoMarkerType = function(opt_value) {
 ...
 *    return path;
 *  }</code>.
 * @return {!anychart.scatter.series.Marker} {@link anychart.scatter.series.Marker} instance for method chaining.
 *//**
 * @ignoreDoc
 * @param {(string|anychart.enums.MarkerType|
 *          function(acgraph.vector.Path, number, number, number):acgraph.vector.Path)=} opt_value .
 * @return {!anychart.scatter.series.Marker|anychart.enums.MarkerType|string|
 *          function(acgraph.vector.Path, number, number, number):acgraph.vector.Path} .
 */
anychart.scatter.series.Marker.prototype.type = function(opt_value) {
 ...
 * @example <c>By Enum value.</c>
 * anychart.scatter.series.marker([10, 11, 17, 7, 21])
 *    .type('star4')
 *    .hoverType('star6')
 ...
 *          function(acgraph.vector.Path, number, number, number):acgraph.vector.Path} .
 */
anychart.scatter.series.Marker.prototype.hoverType = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {anychart.scatter.series.Marker} {@link anychart.scatter.series.Marker} class for method chaining.
 *//**
 * @ignoreDoc
 * @param {number=} opt_value .
 * @return {anychart.scatter.series.Marker|number} .
 */
anychart.scatter.series.Marker.prototype.size = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {anychart.scatter.series.Marker|number} .
 */
anychart.scatter.series.Marker.prototype.hoverSize = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.fill_ = (function() {
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.hoverFill_ = (function() {
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.hatchFill_ = (function() {
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.hoverHatchFill_;
 ...
 */
anychart.scatter.series.Marker.prototype.fill = function(opt_fillOrColorOrKeys, opt_opacityOrAngleOrCx, opt_modeOrCy, opt_opacityOrMode, opt_opacity, opt_fx, opt_fy) {
 ...
 * @return {acgraph.vector.Fill|anychart.scatter.series.Base|Function} .
 */
anychart.scatter.series.Marker.prototype.hoverFill = function(opt_fillOrColorOrKeys, opt_opacityOrAngleOrCx, opt_modeOrCy, opt_opacityOrMode, opt_opacity, opt_fx, opt_fy) {
  if (goog.isDef(opt_fillOrColorOrKeys)) {
 ...
 */
anychart.scatter.series.Marker.prototype.hatchFill = function(opt_patternFillOrTypeOrState, opt_color, opt_thickness, opt_size) {
 ...
 * @return {acgraph.vector.PatternFill|acgraph.vector.HatchFill|anychart.scatter.series.Base|Function|boolean} Hatch fill.
 */
anychart.scatter.series.Marker.prototype.hoverHatchFill = function(opt_patternFillOrTypeOrState, opt_color, opt_thickness, opt_size) {
  if (goog.isDef(opt_patternFillOrTypeOrState)) {
    var hatchFill = goog.isFunction(opt_patternFillOrTypeOrState) || goog.isBoolean(opt_patternFillOrTypeOrState) ?
        opt_patternFillOrTypeOrState :
        acgraph.vector.normalizeHatchFill.apply(null, arguments);
...
/** @inheritDoc */
anychart.scatter.series.Marker.prototype.getLegendIconType = function() {
...
/** @inheritDoc */
anychart.scatter.series.Marker.prototype.startDrawing = function() {
  ...
  if (this.hasInvalidationState(anychart.ConsistencyState.HATCH_FILL)) {
    ...
    if (!this.hatchFillElement_ && !anychart.utils.isNone(fill)) {
      ...
      this.hatchFillElement_.container(/** @type {acgraph.vector.ILayer} */(this.rootLayer));
      this.hatchFillElement_.zIndex(anychart.scatter.series.Base.ZINDEX_HATCH_FILL);
...
/** @inheritDoc */
anychart.scatter.series.Marker.prototype.drawSeriesPoint = function() {
...
/** @inheritDoc */
anychart.scatter.series.Marker.prototype.finalizeDrawing = function() {
...
/** @inheritDoc */
anychart.scatter.series.Marker.prototype.createPositionProvider = function() {
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.drawMarker_ = function(hovered, opt_updateMarker) {
  var iterator = this.getIterator();
 ...
 * @protected
 */
anychart.scatter.series.Marker.prototype.applyHatchFill = function(hovered) {
  if (this.hatchFillElement_) {
    var iterator = this.getIterator();
    var index = iterator.getIndex();
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.handleMouseOver_ = function(event) {
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.handleMouseOut_ = function(event) {
  var markerElement = this.marker_.getMarker(event['markerIndex']).getDomElement();
 ...
 * @private
 */
anychart.scatter.series.Marker.prototype.handleMouseMove_ = function(event) {
 ...
 * @return {!anychart.scatter.series.Marker} {@link anychart.scatter.series.Marker} instance for method chaining.
 */
anychart.scatter.series.Marker.prototype.hoverSeries = function() {
  this.unhover();
  return this;
};
 ...
 * @return {!anychart.scatter.series.Marker} {@link anychart.scatter.series.Marker} instance for method chaining.
 */
anychart.scatter.series.Marker.prototype.hoverPoint = function(index, event) {
 ...
 * @return {!anychart.scatter.series.Marker} {@link anychart.scatter.series.Marker} instance for method chaining.
 */
anychart.scatter.series.Marker.prototype.unhover = function() {
 ...
 * @inheritDoc
 */
anychart.scatter.series.Marker.prototype.getType = function() {
 ...
 * @inheritDoc
 */
anychart.scatter.series.Marker.prototype.serialize = function() {
...
/** @inheritDoc */
anychart.scatter.series.Marker.prototype.restoreDefaults = function() {
 ...
 * @inheritDoc
 */
anychart.scatter.series.Marker.prototype.deserialize = function(config) {
 ...
 * @param {Object.<string, (string|boolean)>=} opt_csvSettings If CSV string is passed, you can pass CSV parser settings
 *    here as a hash map.
 * @return {!anychart.scatter.series.Marker}
 */
anychart.scatter.series.marker = function(data, opt_csvSettings) {
  return new anychart.scatter.series.Marker(data, opt_csvSettings);
};


//exports
goog.exportSymbol('anychart.scatter.series.marker', anychart.scatter.series.marker);
anychart.scatter.series.Marker.prototype['stroke'] = anychart.scatter.series.Marker.prototype.stroke;//inherited
anychart.scatter.series.Marker.prototype['hoverStroke'] = anychart.scatter.series.Marker.prototype.hoverStroke;//inherited
anychart.scatter.series.Marker.prototype['fill'] = anychart.scatter.series.Marker.prototype.fill;//inherited
anychart.scatter.series.Marker.prototype['hoverFill'] = anychart.scatter.series.Marker.prototype.hoverFill;//inherited
anychart.scatter.series.Marker.prototype['size'] = anychart.scatter.series.Marker.prototype.size;
anychart.scatter.series.Marker.prototype['hoverSize'] = anychart.scatter.series.Marker.prototype.hoverSize;
anychart.scatter.series.Marker.prototype['type'] = anychart.scatter.series.Marker.prototype.type;
anychart.scatter.series.Marker.prototype['hoverType'] = anychart.scatter.series.Marker.prototype.hoverType;
anychart.scatter.series.Marker.prototype['startDrawing'] = anychart.scatter.series.Marker.prototype.startDrawing;//inherited
anychart.scatter.series.Marker.prototype['finalizeDrawing'] = anychart.scatter.series.Marker.prototype.finalizeDrawing;//inherited
anychart.scatter.series.Marker.prototype['hoverSeries'] = anychart.scatter.series.Marker.prototype.hoverSeries;//inherited
anychart.scatter.series.Marker.prototype['hoverPoint'] = anychart.scatter.series.Marker.prototype.hoverPoint;//inherited
anychart.scatter.series.Marker.prototype['unhover'] = anychart.scatter.series.Marker.prototype.unhover;//inherited
anychart.scatter.series.Marker.prototype['hatchFill'] = anychart.scatter.series.Marker.prototype.hatchFill;//inherited
anychart.scatter.series.Marker.prototype['hoverHatchFill'] = anychart.scatter.series.Marker.prototype.hoverHatchFill;//inherited
