 ...
 * @type {number}
 */
anychart.core.ui.Label.prototype.SUPPORTED_SIGNALS = anychart.core.Text.prototype.SUPPORTED_SIGNALS;
 ...
 * @return {anychart.core.ui.Label|anychart.core.utils.Padding} .
 */
anychart.core.ui.Label.prototype.padding = function(opt_spaceOrTopOrTopAndBottom, opt_rightOrRightAndLeft, opt_bottom, opt_left) {
  if (!this.padding_) {
 ...
 * @private
 */
anychart.core.ui.Label.prototype.boundsInvalidated_ = function(event) {
 ...
 * @return {!anychart.core.ui.Label|number|string|null} .
 */
anychart.core.ui.Label.prototype.width = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {!anychart.core.ui.Label|number|string|null} .
 */
anychart.core.ui.Label.prototype.height = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 */
anychart.core.ui.Label.prototype.rotation = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {!anychart.core.ui.Label|anychart.enums.Anchor} .
 */
anychart.core.ui.Label.prototype.anchor = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {number|string|anychart.core.ui.Label} .
 */
anychart.core.ui.Label.prototype.offsetX = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {number|string|anychart.core.ui.Label} .
 */
anychart.core.ui.Label.prototype.offsetY = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {!anychart.core.ui.Label|anychart.enums.Position} .
 */
anychart.core.ui.Label.prototype.position = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 */
anychart.core.ui.Label.prototype.adjustEnabled_ = function() {
 ...
 * @ignoreDoc
 * @param {(number|string)=} opt_value
 * @return {number|anychart.core.ui.Label}
 */
anychart.core.ui.Label.prototype.minFontSize = function(opt_value) {
 ...
 * @return {number|anychart.core.ui.Label}
 */
anychart.core.ui.Label.prototype.maxFontSize = function(opt_value) {
  if (goog.isDef(opt_value) && !isNaN(+opt_value)) {
 ...
 * @private
 */
anychart.core.ui.Label.prototype.check_ = function(width, height, originWidth, originHeight) {
 ...
 * @private
 */
anychart.core.ui.Label.prototype.calculateFontSize_ = function(originWidth, originHeight) {
  /** @type {number} */
 ...
 * @private
 */
anychart.core.ui.Label.prototype.calculateLabelBounds_ = function() {
...
/** @inheritDoc */
anychart.core.ui.Label.prototype.applyTextSettings = function(textElement, isInitial) {
 ...
 * @inheritDoc
 */
anychart.core.ui.Label.prototype.deserialize = function(config) {
  this.suspendSignalsDispatching();
 ...
 */
anychart.core.ui.Label.prototype.restoreDefaults = function() {
  this.width(null);
  this.height(null);
  this.padding(0);
...
//exports
anychart.core.ui.Label.prototype['background'] = anychart.core.ui.Label.prototype.background;//in docs/
anychart.core.ui.Label.prototype['padding'] = anychart.core.ui.Label.prototype.padding;//in docs/
anychart.core.ui.Label.prototype['width'] = anychart.core.ui.Label.prototype.width;//in docs/
anychart.core.ui.Label.prototype['height'] = anychart.core.ui.Label.prototype.height;//in docs/
anychart.core.ui.Label.prototype['anchor'] = anychart.core.ui.Label.prototype.anchor;//in docs/
anychart.core.ui.Label.prototype['offsetX'] = anychart.core.ui.Label.prototype.offsetX;//in docs/
anychart.core.ui.Label.prototype['offsetY'] = anychart.core.ui.Label.prototype.offsetY;//in docs/
anychart.core.ui.Label.prototype['position'] = anychart.core.ui.Label.prototype.position;//in docs/
anychart.core.ui.Label.prototype['text'] = anychart.core.ui.Label.prototype.text;//in docs/
anychart.core.ui.Label.prototype['draw'] = anychart.core.ui.Label.prototype.draw;//in docs/
anychart.core.ui.Label.prototype['minFontSize'] = anychart.core.ui.Label.prototype.minFontSize;//in docs/
anychart.core.ui.Label.prototype['maxFontSize'] = anychart.core.ui.Label.prototype.maxFontSize;//in docs/
anychart.core.ui.Label.prototype['adjustFontSize'] = anychart.core.ui.Label.prototype.adjustFontSize;//in docs/
