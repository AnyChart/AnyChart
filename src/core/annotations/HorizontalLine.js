goog.provide('anychart.core.annotations.HorizontalLine');
 ...
 */
anychart.core.annotations.HorizontalLine = function(chartController) {
  anychart.core.annotations.HorizontalLine.base(this, 'constructor', chartController);
...
anychart.core.settings.populate(anychart.core.annotations.HorizontalLine, anychart.core.annotations.STROKE_DESCRIPTORS);
anychart.core.annotations.AnnotationTypes[anychart.enums.AnnotationTypes.HORIZONTAL_LINE] = anychart.core.annotations.HorizontalLine;
...
//----------------------------------------------------------------------------------------------------------------------
/** @inheritDoc */
anychart.core.annotations.HorizontalLine.prototype.type = anychart.enums.AnnotationTypes.HORIZONTAL_LINE;
 ...
 */
anychart.core.annotations.HorizontalLine.prototype.SUPPORTED_ANCHORS = anychart.core.annotations.AnchorSupport.VALUE;
//endregion
...
//----------------------------------------------------------------------------------------------------------------------
/** @inheritDoc */
anychart.core.annotations.HorizontalLine.prototype.ensureCreated = function() {
  anychart.core.annotations.HorizontalLine.base(this, 'ensureCreated');
...
/** @inheritDoc */
anychart.core.annotations.HorizontalLine.prototype.drawOnePointShape = function(x, y) {
...
/** @inheritDoc */
anychart.core.annotations.HorizontalLine.prototype.colorize = function(state) {
  anychart.core.annotations.HorizontalLine.base(this, 'colorize', state);
  this.paths_[0]
      .fill(null)
...
//----------------------------------------------------------------------------------------------------------------------
/** @inheritDoc */
anychart.core.annotations.HorizontalLine.prototype.serialize = function() {
  var json = anychart.core.annotations.HorizontalLine.base(this, 'serialize');
...
/** @inheritDoc */
anychart.core.annotations.HorizontalLine.prototype.setupByJSON = function(config, opt_default) {
  ...
  anychart.core.annotations.HorizontalLine.base(this, 'setupByJSON', config, opt_default);
};


/** @inheritDoc */
anychart.core.annotations.HorizontalLine.prototype.disposeInternal = function() {
  anychart.core.annotations.HorizontalLine.base(this, 'disposeInternal');
