goog.provide('anychart.core.drawers.PolarArea');
 ...
 */
anychart.core.drawers.PolarArea = function(series) {
  anychart.core.drawers.PolarArea.base(this, 'constructor', series);
};
goog.inherits(anychart.core.drawers.PolarArea, anychart.core.drawers.Base);
anychart.core.drawers.AvailableDrawers[anychart.enums.SeriesDrawerTypes.POLAR_AREA] = anychart.core.drawers.PolarArea;


/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.type = anychart.enums.SeriesDrawerTypes.POLAR_AREA;


/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.flags = (
...
/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.requiredShapes = (function() {
  var res = {};
 ...
 * @private
 */
anychart.core.drawers.PolarArea.prototype.drawSegmentStart_ = function(shapes, x, y) {
 ...
 * @private
 */
anychart.core.drawers.PolarArea.prototype.drawSegmentContinuation_ = function(x, y, xRatio, yRatio) {
 ...
 * @private
 */
anychart.core.drawers.PolarArea.prototype.drawSegmentFinish_ = function(shapes) {
  var fill = /** @type {acgraph.vector.Path} */(shapes['fill']);
  var hatch = /** @type {acgraph.vector.Path} */(shapes['hatchFill']);
...
/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.startDrawing = function(shapeManager) {
  anychart.core.drawers.PolarArea.base(this, 'startDrawing', shapeManager);
...
/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.drawMissingPoint = function(point, state) {
  if (isNaN(this.firstPointX))
    this.firstPointMissing = true;
  anychart.core.drawers.PolarArea.base(this, 'drawMissingPoint', point, state);
};


/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.drawFirstPoint = function(point, state) {
  var shapes = this.shapesManager.getShapesGroup(this.seriesState);
...
/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.drawSubsequentPoint = function(point, state) {
  var x = /** @type {number} */(point.meta('x'));
  var y = /** @type {number} */(point.meta('value'));
  var xRatio = /** @type {number} */(point.meta('xRatio'));
  var yRatio = /** @type {number} */(point.meta('valueRatio'));
...
/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.finalizeSegment = function() {
...
/** @inheritDoc */
anychart.core.drawers.PolarArea.prototype.finalizeDrawing = function() {
  ...
  anychart.core.drawers.PolarArea.base(this, 'finalizeDrawing');
};
