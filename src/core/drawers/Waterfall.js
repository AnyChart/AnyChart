goog.provide('anychart.core.drawers.Waterfall');
 ...
 */
anychart.core.drawers.Waterfall = function(series) {
  anychart.core.drawers.Waterfall.base(this, 'constructor', series);
};
goog.inherits(anychart.core.drawers.Waterfall, anychart.core.drawers.Column);
anychart.core.drawers.AvailableDrawers[anychart.enums.SeriesDrawerTypes.WATERFALL] = anychart.core.drawers.Waterfall;


/** @inheritDoc */
anychart.core.drawers.Waterfall.prototype.type = anychart.enums.SeriesDrawerTypes.WATERFALL;


/** @inheritDoc */
anychart.core.drawers.Waterfall.prototype.flags = (
...
/** @inheritDoc */
anychart.core.drawers.Waterfall.prototype.requiredShapes = (function() {
  var res = {};
...
/** @inheritDoc */
anychart.core.drawers.Waterfall.prototype.updatePointOnAnimate = function(point) {
...
/** @inheritDoc */
anychart.core.drawers.Waterfall.prototype.drawSubsequentPoint = function(point, state) {
  var rising = /** @type {number} */(point.meta('diff')) >= 0;
  var isTotal = /** @type {boolean} */(point.meta('isTotal'));
  var name, hatchName;
  if (isTotal) {
