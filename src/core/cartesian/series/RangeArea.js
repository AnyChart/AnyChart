 ...
 * <b>Note:</b> Better for use methods {@link anychart.charts.Cartesian#rangeArea}.
 * @example
 * anychart.core.cartesian.series.rangeArea([['A1', 1, 4],['A2', 7, 1]]).container(stage).draw();
 ...
 */
anychart.core.cartesian.series.RangeArea = function(data, opt_csvSettings) {
 ...
 * @inheritDoc
 */
anychart.core.cartesian.series.RangeArea.prototype.deserialize = function(config) {
