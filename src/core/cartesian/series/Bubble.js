 ...
 * <b>Note:</b> Better for use method {@link anychart.charts.Cartesian#bubble}.
 * @example
 * anychart.core.cartesian.series.bubble([[1, 1, 3], [2, 1, 1]]).container(stage).draw();
 ...
 */
anychart.core.cartesian.series.Bubble = function(data, opt_csvSettings) {
 ...
 * @inheritDoc
 */
anychart.core.cartesian.series.Bubble.prototype.deserialize = function(config) {
...
/** @inheritDoc */
anychart.core.cartesian.series.Bubble.prototype.restoreDefaults = function() {
