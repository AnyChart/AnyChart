 ...
 */
anychart.core.cartesian.series.ContinuousBase = function(data, opt_csvSettings) {
...
/** @inheritDoc */
anychart.core.cartesian.series.ContinuousBase.prototype.hoverPoint = function(index, event) {
