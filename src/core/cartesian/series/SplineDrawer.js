goog.provide('anychart.core.cartesian.series.SplineDrawer');
 ...
 * @constructor
 */
anychart.core.cartesian.series.SplineDrawer = function(mainPath, opt_rtl) {
  /**
 ...
 * @return {!anychart.core.cartesian.series.SplineDrawer|boolean} .
 */
anychart.core.cartesian.series.SplineDrawer.prototype.rtl = function(opt_rtl) {
 ...
 * @param {number} y .
 */
anychart.core.cartesian.series.SplineDrawer.prototype.processPoint = function(x, y) {
  switch (this.state_) {
    case 3:
 ...
 */
anychart.core.cartesian.series.SplineDrawer.prototype.finalizeProcessing = function() {
  switch (this.state_) {
    case 3:
 ...
 * @private
 */
anychart.core.cartesian.series.SplineDrawer.prototype.strokePath_ = null;


/**
 * Sets additional stroke path.
 * @param {acgraph.vector.Path} path Path to set.
 */
anychart.core.cartesian.series.SplineDrawer.prototype.setStrokePath = function(path) {
  this.strokePath_ = path;
};
 ...
 */
anychart.core.cartesian.series.SplineDrawer.prototype.resetDrawer = function(backward) {
 ...
 * @private
 */
anychart.core.cartesian.series.SplineDrawer.prototype.startSplineDrawing_ = function(p1x, p1y, p2x, p2y, p3x, p3y) {
  this.v1_[0] = p2x - p1x;
  this.v1_[1] = p2y - p1y;
  ...
  this.path_.quadraticCurveTo(p2x + this.tanLeft_[0], p2y + this.tanLeft_[1], p2x, p2y);
  if (this.strokePath_)
    this.strokePath_.quadraticCurveTo(p2x + this.tanLeft_[0], p2y + this.tanLeft_[1], p2x, p2y);
 ...
 * @private
 */
anychart.core.cartesian.series.SplineDrawer.prototype.drawNextSplinePoint_ = function(p1x, p1y, p2x, p2y, p3x, p3y) {
  ...
  this.path_.quadraticCurveTo(cp1[0], cp1[1], mp[0], mp[1]);
  this.path_.quadraticCurveTo(cp2[0], cp2[1], p2x, p2y);
  if (this.strokePath_) {
    this.strokePath_.quadraticCurveTo(cp1[0], cp1[1], mp[0], mp[1]);
    this.strokePath_.quadraticCurveTo(cp2[0], cp2[1], p2x, p2y);
  }
 ...
 * @private
 */
anychart.core.cartesian.series.SplineDrawer.prototype.finalizeSplineDrawing_ = function(p1x, p1y, p2x, p2y) {
  this.path_.quadraticCurveTo(p1x + this.tanRight_[0], p1y + this.tanRight_[1], p2x, p2y);
  if (this.strokePath_)
    this.strokePath_.quadraticCurveTo(p1x + this.tanRight_[0], p1y + this.tanRight_[1], p2x, p2y);
};
 ...
 * @private
 */
anychart.core.cartesian.series.SplineDrawer.prototype.drawSingleSplinePoint_ = function(x, y) {
};
 ...
 * @private
 */
anychart.core.cartesian.series.SplineDrawer.prototype.drawDummySpline_ = function(p1x, p1y, p2x, p2y) {
  this.path_.lineTo(p2x, p2y);
  if (this.strokePath_)
    this.strokePath_.lineTo(p2x, p2y);
};
