...
goog.require('anychart.core.calculations.sma');
...
anychart.core.stock.indicators.SMA.prototype.createComputer = function(mapping) {
  return anychart.core.calculations.sma.createComputer(mapping, this.period_);
};
 ...
 * @return {anychart.core.stock.indicators.SMA|anychart.core.stock.series.Base|anychart.core.stock.scrollerSeries.Base}
 */
anychart.core.stock.indicators.SMA.prototype.series = function(opt_type) {
  return /** @type {anychart.core.stock.indicators.SMA|anychart.core.stock.series.Base|anychart.core.stock.scrollerSeries.Base} */(
...
//exports
anychart.core.stock.indicators.SMA.prototype['series'] = anychart.core.stock.indicators.SMA.prototype.series;
anychart.core.stock.indicators.SMA.prototype['period'] = anychart.core.stock.indicators.SMA.prototype.period;
