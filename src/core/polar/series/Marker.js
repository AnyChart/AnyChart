 ...
 * <b>Note:</b> Better for use methods {@link anychart.charts.Polar#marker}.
 * @example
 * anychart.core.polar.series.marker([1, 4, 7, 1]).container(stage).draw();
 ...
 */
anychart.core.polar.series.Marker = function(data, opt_csvSettings) {
