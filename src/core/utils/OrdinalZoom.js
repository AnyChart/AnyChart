...
anychart.core.utils.OrdinalZoom.prototype.ensureSetupApplied = function() {
  ...
  if (this.setup_) {
    ...
    if (this.setup_.count && (acgraph.utils.instanceOf(scale, anychart.scales.Ordinal))) {
    ...
    if (!isNaN(+arg0)) { // also accepts null, bool
      ...
      if (goog.isDef(json['startValue']) && goog.isDef(json['endValue'])) {
        this.setToValues(
            json['startValue'],
            json['endValue'],
            acgraph.utils.instanceOf(json['scale'], anychart.scales.Base) ? json['scale'] : undefined);
