...
anychart.core.utils.Bounds.prototype.toRect = function(opt_parentLeftOrRect, opt_parentTop, opt_parentWidth, opt_parentHeight) {
  var parentBounds;
  if (acgraph.utils.instanceOf(opt_parentLeftOrRect, anychart.math.Rect)) {
...
anychart.core.utils.Bounds.prototype.setupSpecial = function(isDefault, var_args) {
  ...
  if (acgraph.utils.instanceOf(arg0, anychart.core.utils.Bounds)) {
    left = arg0.left_;
    top = arg0.top_;
    width = arg0.width_;
    height = arg0.height_;
    ...
    bottom = arg0.bottom_;
    operable = true;
  } else if (acgraph.utils.instanceOf(arg0, anychart.math.Rect)) {
    left = arg0.left;
    top = arg0.top;
    width = arg0.width;
    height = arg0.height;
