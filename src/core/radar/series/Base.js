 ...
 * @private
 */
anychart.core.radar.series.Base.prototype.rawData_;
...
//----------------------------------------------------------------------------------------------------------------------
/** @inheritDoc */
anychart.core.radar.series.Base.prototype.makeBrowserEvent = function(e) {
 ...
 * @protected
 */
anychart.core.radar.series.Base.prototype.handleMouseOverAndMove = function(event) {
 ...
 * @protected
 */
anychart.core.radar.series.Base.prototype.handleMouseEvent = function(event) {
  var evt = this.makePointEvent(event);
  if (evt)
    this.dispatchEvent(evt);
};
 ...
 * @protected
 */
anychart.core.radar.series.Base.prototype.makePointEvent = function(event) {
  var type = event['type'];
  switch (type) {
