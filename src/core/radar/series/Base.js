 ...
 */
anychart.core.radar.series.Base = function(data, opt_csvSettings) {
 ...
 */
anychart.core.radar.series.Base.prototype.getLegendItemData = function() {
 ...
 * @inheritDoc
 */
anychart.core.radar.series.Base.prototype.deserialize = function(config) {
  this.suspendSignalsDispatching();
