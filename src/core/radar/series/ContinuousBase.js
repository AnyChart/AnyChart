 ...
 */
anychart.core.radar.series.ContinuousBase = function(data, opt_csvSettings) {
 ...
 * @inheritDoc
 */
anychart.core.radar.series.ContinuousBase.prototype.deserialize = function(config) {
