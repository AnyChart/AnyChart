goog.provide('anychart.elements.RadarAxis');
 ...
 */
anychart.elements.RadarAxis = function() {
...
goog.inherits(anychart.elements.RadarAxis, anychart.VisualBase);
 ...
 * @type {number}
 */
anychart.elements.RadarAxis.prototype.SUPPORTED_CONSISTENCY_STATES =
 ...
 * @type {number}
 */
anychart.elements.RadarAxis.prototype.SUPPORTED_SIGNALS = anychart.VisualBase.prototype.SUPPORTED_SIGNALS;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.line_ = null;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.name_ = 'axis';
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.labels_ = null;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.ticks_ = null;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.stroke_ = 'none';
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.scale_ = null;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.pixelBounds_ = null;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.radius_ = NaN;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.criticalTickLength_ = NaN;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.cx_ = NaN;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.cy_ = NaN;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.startAngle_ = NaN;
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.labelsBounds_ = null;


/**
 * @param {string=} opt_value Name.
 * @return {string|anychart.elements.RadarAxis} Axis name or itself for method chaining.
 */
anychart.elements.RadarAxis.prototype.name = function(opt_value) {
 ...
 * @return {anychart.elements.LabelsFactory|anychart.elements.RadarAxis} Axis labels of itself for method chaining.
 */
anychart.elements.RadarAxis.prototype.labels = function(opt_value) {
  if (!this.labels_) {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.labelsInvalidated_ = function(event) {
  var state = 0;
  var signal = 0;
 ...
 * @return {anychart.elements.RadialTicks|anychart.elements.RadarAxis} Axis ticks or itself for method chaining.
 */
anychart.elements.RadarAxis.prototype.ticks = function(opt_value) {
  if (!this.ticks_) {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.ticksInvalidated_ = function(event) {
  var state = 0;
  var signal = 0;
  if (event.hasSignal(anychart.Signal.BOUNDS_CHANGED)) {
    state = this.ALL_VISUAL_STATES_;
 ...
 * @return {string|acgraph.vector.Stroke|anychart.elements.RadarAxis} Axis line stroke or itself for method chaining.
 */
anychart.elements.RadarAxis.prototype.stroke = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {anychart.scales.Base|anychart.elements.RadarAxis} Axis scale or itself for method chaining.
 */
anychart.elements.RadarAxis.prototype.scale = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.scaleInvalidated_ = function(event) {
 ...
 * @return {(string|number|anychart.elements.RadarAxis)} .
 */
anychart.elements.RadarAxis.prototype.startAngle = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.dropBoundsCache_ = function() {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.getLabelPositionOffsetForAngle_ = function(angle, bounds) {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.getLabelBounds_ = function(index) {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.drawLine_ = function(index, x, y) {
  if (index == 0)
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.getLabelsFormatProvider_ = function(index, value) {
 ...
 * @private
 */
anychart.elements.RadarAxis.prototype.drawLabel_ = function(index, x, y) {
...
/** @inheritDoc */
anychart.elements.RadarAxis.prototype.checkDrawingNeeded = function() {
...
/**
 * Axis drawing.
 * @return {anychart.elements.RadarAxis} An instance of {@link anychart.elements.RadarAxis} class for method chaining.
 */
anychart.elements.RadarAxis.prototype.draw = function() {
  var scale = /** @type {anychart.scales.Linear|anychart.scales.Ordinal} */(this.scale());
...
/** @inheritDoc */
anychart.elements.RadarAxis.prototype.remove = function() {
 ...
 */
anychart.elements.RadarAxis.prototype.serialize = function() {
...
/** @inheritDoc */
anychart.elements.RadarAxis.prototype.deserialize = function(value) {
  this.suspendSignalsDispatching();
...
/** @inheritDoc */
anychart.elements.RadarAxis.prototype.disposeInternal = function() {
 ...
 * @return {!anychart.elements.RadarAxis}
 */
anychart.elements.radarAxis = function() {
  return new anychart.elements.RadarAxis();
};


//exports
goog.exportSymbol('anychart.elements.radarAxis', anychart.elements.radarAxis);
anychart.elements.RadarAxis.prototype['name'] = anychart.elements.RadarAxis.prototype.name;
anychart.elements.RadarAxis.prototype['startAngle'] = anychart.elements.RadarAxis.prototype.startAngle;
anychart.elements.RadarAxis.prototype['labels'] = anychart.elements.RadarAxis.prototype.labels;
