goog.provide('anychart.ganttModule.header.FormatSelector');
 ...
 */
anychart.ganttModule.header.FormatSelector = function(opt_formats) {
  anychart.ganttModule.header.FormatSelector.base(this, 'constructor');
   ...
   * @type {Object.<string, anychart.ganttModule.header.FormatSelector.FormatMetrics>}
   */
  this.formatsMap = {};
   ...
   * @type {Array.<anychart.ganttModule.header.FormatSelector.FormatMetrics>}
   * @private
   */
...
goog.inherits(anychart.ganttModule.header.FormatSelector, anychart.core.Base);
 ...
 * @type {number}
 */
anychart.ganttModule.header.FormatSelector.prototype.SUPPORTED_CONSISTENCY_STATES =
 ...
 * @type {number}
 */
anychart.ganttModule.header.FormatSelector.prototype.SUPPORTED_SIGNALS =
 ...
 * @const
 */
anychart.ganttModule.header.FormatSelector.DEFAULT_FORMAT = 'yyyy/MM/dd\'T\'HH:mm:ss.SSS';
 ...
 * @type {number}
 */
anychart.ganttModule.header.FormatSelector.DEFAULT_TIME = Date.UTC(2000, 10, 29, 23, 59, 59, 999);
 ...
 * }}
 */
anychart.ganttModule.header.FormatSelector.FormatMetrics;
 ...
 * }}
 */
anychart.ganttModule.header.FormatSelector.SortedMetrics;
 ...
 * @inheritDoc
 */
anychart.ganttModule.header.FormatSelector.prototype.provideMeasurements = function() {
  return this.texts_;
};
 ...
 */
anychart.ganttModule.header.FormatSelector.prototype.selectFormats = function() {
  ...
  if (userDefinedFormats) {
    ...
    if (!(anychart.ganttModule.header.FormatSelector.DEFAULT_FORMAT in this.formatsMap)) {
      this.prepareTextData_(anychart.ganttModule.header.FormatSelector.DEFAULT_FORMAT);
    }
  }
 ...
 */
anychart.ganttModule.header.FormatSelector.prototype.syncBoundsAfterMeasurement = function() {
  if (!this.isInSync_) {
 ...
 * @private
 */
anychart.ganttModule.header.FormatSelector.prototype.prepareTextData_ = function(format) {
  /**
   * @type {anychart.ganttModule.header.FormatSelector.FormatMetrics}
   */
  var formatData = {
  ...
  text.text(anychart.format.dateTime(anychart.ganttModule.header.FormatSelector.DEFAULT_TIME, format, 0));
 ...
 * @return {Array.<string>|string|anychart.ganttModule.header.FormatSelector}
 */
anychart.ganttModule.header.FormatSelector.prototype.formats = function(opt_value) {
 ...
 * @return {null|anychart.core.ui.LabelsSettings|anychart.ganttModule.header.FormatSelector}
 */
anychart.ganttModule.header.FormatSelector.prototype.labels = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 */
anychart.ganttModule.header.FormatSelector.prototype.labelsInvalidated = function(e) {
 ...
 * Reset.
 */
anychart.ganttModule.header.FormatSelector.prototype.reset = function() {
  for (var i = 0; i < this.texts_.length; i++) {
 ...
 * @inheritDoc
 */
anychart.ganttModule.header.FormatSelector.prototype.disposeInternal = function() {
  this.reset();
  this.texts_.length = 0;
  anychart.measuriator.unregister(this);
  if (this.labels_)
    this.labels_.unlistenSignals(this.labelsInvalidated, this);
  anychart.ganttModule.header.FormatSelector.base(this, 'disposeInternal');
};
