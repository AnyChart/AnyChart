goog.provide('anychart.ganttModule.TimelineHeader');
 ...
 */
anychart.ganttModule.TimelineHeader = function() {
  anychart.ganttModule.TimelineHeader.base(this, 'constructor');
   ...
   * @type {Array.<anychart.ganttModule.TimelineHeader.Level>}
   * @private
   */
  this.levels_ = new Array(3);

  var topLevel = new anychart.ganttModule.TimelineHeader.Level(this);
  ...
  var midLevel = new anychart.ganttModule.TimelineHeader.Level(this);
  ...
  var lowLevel = new anychart.ganttModule.TimelineHeader.Level(this);
...
goog.inherits(anychart.ganttModule.TimelineHeader, anychart.core.VisualBaseWithBounds);
 ...
 * @type {number}
 */
anychart.ganttModule.TimelineHeader.SUPPORTED_SIGNALS = anychart.core.VisualBaseWithBounds.prototype.SUPPORTED_SIGNALS;
 ...
 * @type {number}
 */
anychart.ganttModule.TimelineHeader.prototype.SUPPORTED_CONSISTENCY_STATES =
 ...
 */
anychart.ganttModule.TimelineHeader.prototype.getBase_ = function() {
  if (!this.base_) {
 ...
 * @return {anychart.ganttModule.TimelineHeader.Level|anychart.ganttModule.TimelineHeader} - Top level or itself for chaining..
 */
anychart.ganttModule.TimelineHeader.prototype.topLevel = function(opt_value) {
 ...
 * @param {(Object|boolean)=} opt_value - Value to set.
 * TODO (A.Kudryavtsev): Remove on advanced leveling implementation.
 * @return {anychart.ganttModule.TimelineHeader.Level|anychart.ganttModule.TimelineHeader} - Mid level or itself for chaining..
 */
anychart.ganttModule.TimelineHeader.prototype.midLevel = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @param {(Object|boolean)=} opt_value - Value to set.
 * TODO (A.Kudryavtsev): Remove on advanced leveling implementation.
 * @return {anychart.ganttModule.TimelineHeader.Level|anychart.ganttModule.TimelineHeader} - Low level or itself for chaining..
 */
anychart.ganttModule.TimelineHeader.prototype.lowLevel = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @private
 */
anychart.ganttModule.TimelineHeader.prototype.levelInvalidated_ = function(event) {
  var state = 0;
 ...
 * @private
 */
anychart.ganttModule.TimelineHeader.prototype.scaleInvalidated_ = function(event) {
...
/**
 * Gets/sets new scale.
 * @param {anychart.ganttModule.Scale=} opt_value - Value to be set.
 * @return {(anychart.ganttModule.Scale|anychart.ganttModule.TimelineHeader)} - Current value or itself for method chaining.
 */
anychart.ganttModule.TimelineHeader.prototype.scale = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @param {number=} opt_fx .
 * @param {number=} opt_fy .
 * @return {acgraph.vector.Fill|anychart.ganttModule.TimelineHeader|string} - Current value or itself for method chaining.
 */
anychart.ganttModule.TimelineHeader.prototype.backgroundFill = function(opt_fillOrColorOrKeys, opt_opacityOrAngleOrCx, opt_modeOrCy, opt_opacityOrMode, opt_opacity, opt_fx, opt_fy) {
 ...
 * @return {(string|acgraph.vector.Stroke|anychart.ganttModule.TimelineHeader)} - Current value or itself for chaining.
 */
anychart.ganttModule.TimelineHeader.prototype.levelsSeparationStroke = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {anychart.ganttModule.TimelineHeader} - Itself for method chaining.
 */
anychart.ganttModule.TimelineHeader.prototype.draw = function() {
...
/** @inheritDoc */
anychart.ganttModule.TimelineHeader.prototype.serialize = function() {
  var json = anychart.ganttModule.TimelineHeader.base(this, 'serialize');
...
/** @inheritDoc */
anychart.ganttModule.TimelineHeader.prototype.setupByJSON = function(config) {
  anychart.ganttModule.TimelineHeader.base(this, 'setupByJSON', config);
 ...
 * @param {anychart.ganttModule.TimelineHeader} header - Parent header.
 * @constructor
 * @extends {anychart.core.VisualBaseWithBounds}
 */
anychart.ganttModule.TimelineHeader.Level = function(header) {
  anychart.ganttModule.TimelineHeader.Level.base(this, 'constructor');

  /**
   * Related scale.
   * @type {anychart.ganttModule.TimelineHeader}
   * @private
   */
...
goog.inherits(anychart.ganttModule.TimelineHeader.Level, anychart.core.VisualBaseWithBounds);
 ...
 * @type {number}
 */
anychart.ganttModule.TimelineHeader.Level.SUPPORTED_SIGNALS = anychart.core.VisualBaseWithBounds.prototype.SUPPORTED_SIGNALS;
 ...
 * @type {number}
 */
anychart.ganttModule.TimelineHeader.Level.prototype.SUPPORTED_CONSISTENCY_STATES =
    anychart.core.VisualBaseWithBounds.prototype.SUPPORTED_CONSISTENCY_STATES |
    anychart.ConsistencyState.APPEARANCE |
 ...
 */
anychart.ganttModule.TimelineHeader.Level.prototype.defaultFormat_ = function(startDate, endDate, index) {
 ...
 * @return {(function(number, number, number):string|anychart.ganttModule.TimelineHeader.Level)} - Current function or itself
 *  for method chaining.
 */
anychart.ganttModule.TimelineHeader.Level.prototype.format = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {acgraph.vector.Layer}
 */
anychart.ganttModule.TimelineHeader.Level.prototype.getBase_ = function() {
  if (!this.base_) {
    this.base_ = /** @type {acgraph.vector.Layer} */ (acgraph.layer());
    this.registerDisposable(this.base_);
  }
 ...
 * @return {(goog.date.Interval|anychart.ganttModule.TimelineHeader.Level)} - Current value or itself for method chaining.
 */
anychart.ganttModule.TimelineHeader.Level.prototype.interval = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 * @return {(Date|anychart.ganttModule.TimelineHeader.Level)} - Current value or itself for method chaining.
 */
anychart.ganttModule.TimelineHeader.Level.prototype.anchor = function(opt_value) {
  if (goog.isDef(opt_value)) {
 ...
 */
anychart.ganttModule.TimelineHeader.Level.prototype.getTicks = function() {
  return this.ticks_;
};
 ...
 * @return {anychart.core.ui.LabelsFactory|anychart.ganttModule.TimelineHeader.Level}
 */
anychart.ganttModule.TimelineHeader.Level.prototype.labels = function(opt_value) {
 ...
 * @private
 */
anychart.ganttModule.TimelineHeader.Level.prototype.labelsInvalidated_ = function(event) {
  if (event.hasSignal(anychart.Signal.NEEDS_REDRAW)) {
    this.invalidate(anychart.ConsistencyState.TIMELINE_HEADER_LEVEL_LABELS, anychart.Signal.NEEDS_REDRAW);
  }
};
 ...
 * @param {number=} opt_fx .
 * @param {number=} opt_fy .
 * @return {acgraph.vector.Fill|anychart.ganttModule.TimelineHeader.Level|string} - Current value or itself for method chaining.
 */
anychart.ganttModule.TimelineHeader.Level.prototype.tileFill = function(opt_fillOrColorOrKeys, opt_opacityOrAngleOrCx, opt_modeOrCy, opt_opacityOrMode, opt_opacity, opt_fx, opt_fy) {
  if (goog.isDef(opt_fillOrColorOrKeys)) {
    var val = acgraph.vector.normalizeFill.apply(null, arguments);
 ...
 * @return {acgraph.vector.Stroke|anychart.ganttModule.TimelineHeader.Level|string} - Current value or itself for chaining.
 */
anychart.ganttModule.TimelineHeader.Level.prototype.tilesSeparationStroke = function(opt_strokeOrFill, opt_thickness, opt_dashpattern, opt_lineJoin, opt_lineCap) {
...
/**
 * Draws level.
 * @return {anychart.ganttModule.TimelineHeader.Level} - Itself for method chaining.
 */
anychart.ganttModule.TimelineHeader.Level.prototype.draw = function() {
  if (this.checkDrawingNeeded()) {
 ...
 * @private
 */
anychart.ganttModule.TimelineHeader.Level.prototype.calculateTileTextLeft_ = function(tileLeft, tileWidth, textWidth) {
...
/** @inheritDoc */
anychart.ganttModule.TimelineHeader.Level.prototype.remove = function() {
  this.getBase_().parent(null);
};


/** @inheritDoc */
anychart.ganttModule.TimelineHeader.Level.prototype.serialize = function() {
  var json = anychart.ganttModule.TimelineHeader.Level.base(this, 'serialize');
...
/** @inheritDoc */
anychart.ganttModule.TimelineHeader.Level.prototype.setupByJSON = function(config, opt_default) {
  anychart.ganttModule.TimelineHeader.Level.base(this, 'setupByJSON', config);
...
//exports
(function() {
  var proto = anychart.ganttModule.TimelineHeader.prototype;
  ...
  proto = anychart.ganttModule.TimelineHeader.Level.prototype;
