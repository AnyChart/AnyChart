...
anychart.charts.Pie.prototype.drawLabel_ = function(hovered, opt_updateConnector) {
  ...
  //todo now in 3d pie labels are always displayed, even if they intersect the slice. To speak with Roma at the expense of a new behavior labels.
  if (!hovered && !this.insideLabelsOverlap_ && !singlePoint && !this.mode3d_) {
    var start = /** @type {number} */ (iterator.meta('start'));
    var sweep = /** @type {number} */ (iterator.meta('sweep'));
