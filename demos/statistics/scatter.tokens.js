...
anychart.onDocumentReady(function() {
  ...
  var tooltipTemplate = 'Series Name: {%SeriesName}\nX: {%x}\nValue: {%Value}\nX % Of Series: {%XPercentOfSeries}\n' +
      'Y % Of Series: {%YPercentOfSeries}\nX % Of Total: {%XPercentOfTotal}\nY % Of Total: {%YPercentOfTotal}';

  line.tooltip().textFormatter(tooltipTemplate);
  marker.tooltip().textFormatter(tooltipTemplate);
