...
anychart.onDocumentReady(function() {
  timeline = anychart.ui.projectTimeline();
...
function getData() {
  return [
...

    {
      ...
      'parent': 'final-testing',
      'actualStart': Date.UTC(2010, 11, 5, 8),
      'actualEnd': Date.UTC(2010, 11, 27, 18),
      'progressValue': '35%',
      'baselineStart': Date.UTC(2010, 11, 20, 10),
      'baselineEnd': Date.UTC(2010, 11, 2, 16),
      'rowHeight': 35
    },
    ...
    {
      'id': 'perf-testing3',
      'name': 'Phase 3: Performance testing 2',
      'parent': 'final-testing',
      'actualStart': Date.UTC(2011, 10, 5, 8),
      'actualEnd': Date.UTC(2011, 10, 27, 18),
      'progressValue': '35%',
      'rowHeight': 35
    }
  ];
