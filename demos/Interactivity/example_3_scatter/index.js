var chart, stage, series1, voronoi;
...
anychart.onDocumentReady(function () {
  ...
  var sportsmen3 = map_training_data;
  ...
  //chart.bubble(sportsmen1).name('Christopher Sanchez').hoverFill('red');
  // create second series with mapped data
  //chart.marker(sportsmen2).name('Judy Evans');
  // create third series with mapped data
  series1 = chart.line(sportsmen3).name('Walter Burke');
  var stroke = series1.stroke();
  series1
      .stroke(anychart.color.setOpacity(stroke, 0.1))
      .selectStroke('10 yellow');
  series1.markers()
      .enabled(true)
      .type('star5')
      .fill('blue')
      .size(7);
  series1.hoverMarkers()
      .fill('red')
      .size(15);
  series1.selectMarkers()
      .fill('black')
      .size(15);
