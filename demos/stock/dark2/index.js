var table, table2, mapping, mapping2, scrollerMapping, scrollerMapping2, xScale, yScale, stage, controller, chart, res1, res2;
...
anychart.onDocumentReady(function() {
  ...
  chart.title({
    ...
    fontColor: '#888888',
    padding: [0, 0, 10, 0],
    text: 'Stock Demo: click on the title to toggle stream'
  });
  //chart.title().listen('click', function() {stream()});
  ...
  chart.plot(0).ohlc(mapping2)
      .fallingStroke('rgb(154,70,0)')
      .risingStroke('rgb(115,144,42)');
  ...
  chart.plot(0).yScale().stickToZero(true);
  chart.plot(1).yScale().stickToZero(true);
  ...
  chart.plot(0).minorGrid(1)
      ...
      .stroke('#373B3E')
      .layout(anychart.enums.Layout.VERTICAL);
  chart.plot(0).valueHighlighter('#999');
  chart.plot(1).valueHighlighter('#999');
  ...
  chart.scroller()
      ...
      .selectedFill('#42484D')
  //.height('50%');
  chart.scroller().line(scrollerMapping).stroke('#999 .6').selectedStroke('#999 .9');
  chart.scroller().line(scrollerMapping2).stroke('#666 .6').selectedStroke('#666 .9');
  ...
  //chart.selectRange('09-04-1969', '05-27-1970');
