...
var map, series, scale, colorRange;
anychart.onDocumentReady(function() {
  ...
  var title = map.title();
  title.text('Women First Granted Suffrage at National Level (by Year)');
  ...
  series = map.choropleth(map_data);
  series.select(87);
  ...
  series.tooltip().content().textWrap('byLetter').useHtml(true);
  ...
  colorRange.labels().fontSize(11).padding(0, 0, 0, 5);
  //colorRange.labels().textFormatter(function() {
