...
anychart.onDocumentReady(function () {
  ...
  //colorScale.colors(anychart.color.blendedHueProgression('yellow', 'green', colorScale.ranges().length));
  ...
  //chart.interactivity().hoverMode('bySpot').spotRadius(60);
