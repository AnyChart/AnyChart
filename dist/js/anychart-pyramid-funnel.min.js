...
$.g.ie=function(a){if(this.enabled()){var b;$.p(a)?b=a:b=this.state.Gc==$.nm?window.NaN:void 0;this.state.Vh($.Do,b);a=this.$();for(a.reset();a.advance();)this.ke($.vx(this.state,a.ma()));GX(this)}};$.g.qk=function(a,b){yX(this,a);zX(this,a);this.gq(a);return b};$.g.pq=$.ia;$.g.vm=$.ia;$.g.nl=function(a){this.ke(a);yX(this,a);zX(this,a);this.gq(a)};var JX={};$.Bq(JX,0,"baseWidth",$.Pq);$.Bq(JX,0,"neckHeight",$.Pq);$.Bq(JX,0,"neckWidth",$.Pq);$.Bq(JX,0,"pointsPadding",$.Pq);$.Bq(JX,0,"reversed",$.Pq);
