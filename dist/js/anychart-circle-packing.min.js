...
if(!_.circle_packing_part){_.circle_packing_part=1;(function($){var Eua=function(a,b){return a&&b&&0<b.value-a.value?1:-1},Fua=function(a){var b={left:0,right:0,top:0,bottom:0,Eb:0};if(a&&a.length){var c,d=a[0];d.Kp=0;d.Rq=0;b.left=-d.weight;b.right=d.weight;b.top=-d.weight;b.bottom=d.weight;b.Eb=d.weight;var e=a[1];e&&(e.Kp=d.Kp+d.weight+e.weight,e.Rq=d.Rq,b.right=e.Kp+e.weight,b.Eb=b.right);d=[{bS:d,cS:e,SI:1}];e=2;for(c=a[e];c;){var f=d[0],h=f.bS,k=f.cS,l=f.SI,m=c.weight,p=h.weight+k.weight;var q=m+h.weight;m+=k.weight;m=(q*q+p*p-m*m)/(2*q*p);m=$.Za(m,-1,1);
m=Math.acos(m);p=(k.Kp-h.Kp)/p;p=$.Za(p,-1,1);p=m+l*(0<=(k.Rq-h.Rq)/(h.weight+k.weight)?1:-1)*Math.acos(p);c.Kp=h.Kp+q*Math.cos(p);c.Rq=h.Rq+l*q*Math.sin(p);p=!1;for(q=0;q<a.length;q++){m=a[q];var r;if(r=m!==c){r=Math.abs(m.Kp-c.Kp);var t=Math.abs(m.Rq-c.Rq);r=-1E-6>Math.sqrt(r*r+t*t)-Math.abs(m.weight+c.weight)}if(r){p=!0;break}}p?1===l?f.SI=-1:(f.SI=1,c=d.shift(),d.push(c)):(f={bS:h,cS:c,SI:1},k={bS:c,cS:k,SI:1},b.top=Math.min(b.top,c.Rq-c.weight),b.bottom=Math.max(b.bottom,c.Rq+c.weight),b.left=
Math.min(b.left,c.Kp-c.weight),b.right=Math.max(b.right,c.Kp+c.weight),b.Eb=Math.max(b.Eb,Math.sqrt(c.Kp*c.Kp+c.Rq*c.Rq)+c.weight),d.push(f,k),e+=1);c=a[e]}for(q=0;q<a.length;q++)c=a[q],c.c7=Fua(c.children)}return b},Gua=function(a,b){var c=[],d=window.NaN,e=window.NaN,f;for(f=0;f<a.length;f++){var h=a[f],k=b;var l=Number(h.get("value"));var m=(0,window.isNaN)(l)||0>l;k={index:0,rN:!1,MA:!1,weight:0,name:String(h.get("name")),value:l,item:h,parent:k,depth:k.depth+1};h.bc()?(h=h.Sv(),Gua(h,k),m||(k.value=
l)):k.MA=!0;if(l=k.MA&&!m||!k.MA&&k.children&&k.children.length&&!(0,window.isNaN)(Number(k.value))?k:null)$.Ua(c,l,Eua),d=(0,window.isNaN)(d)?0:d,e=(0,window.isNaN)(e)?0:e,d+=l.value,e+=Math.sqrt(l.value/Math.PI)}for(f=0;f<c.length;f++)l=c[f],l.weight=1===c.length?.9:Math.sqrt(l.value/Math.PI)/e,l.index=f;b.value=d;b.children=c},Hua=function(a,b,c){if(a&&a.length){var d=b&&b.rN;var e=c;if(e.width!==e.height){c=e.left+e.width/2;var f=e.top+e.height/2,h=Math.min(e.width,e.height);e=e.clone();e.width=
h;e.height=h;e.left=c-h/2;e.top=f-h/2;c=e}else c=e;b.Ua=c;b=b.c7;h=b.right+Math.abs(b.left);e=b.bottom+Math.abs(b.top);f=Math.abs(h-e)/2;h>e?(b.top-=f,b.bottom+=f):(b.left-=f,b.right+=f);f=Math.max(h,e);d=Math.min(h/f,e/f)*(d?0:Math.min(b.Eb,f/2))*(2-Math.sqrt(2))/2;f+=2*d;b.top-=d;b.bottom+=d;b.left-=d;b.right+=d;d=c.width/f;for(h=0;h<a.length;h++){e=a[h];e.Dc=c.left+c.width/f*(e.Kp+Math.abs(b.left));e.uc=c.top+c.height/f*(e.Rq+Math.abs(b.top));e.Eb=e.weight*d;var k=new $.I(e.Dc-e.Eb,e.uc-e.Eb,2*
e.Eb,2*e.Eb);e.Ua=k;Hua(e.children,e,k)}}},W$=function(a,b){function c(a){a.enabled(null)}$.Cx.call(this);$.tu(this,this,this.Hf,this.hg,this.Cs,this.Hf,this.maa,null);this.Ga("circlePacking");this.f=this.Fa=null;this.j=[];this.b=[];this.data(a,b);var d={};$.T(d,[["fill",16,65],["stroke",16,65],["labels",0,0]]);this.ca=new $.my(this,d,$.hm);this.ca.ta("labelsAfterInitCallback",$.sy);d={};$.T(d,[["fill",16,65],["stroke",16,65],["labels",256,65]]);this.Ea=new $.my(this,d,$.Bo);this.Ea.ta("labelsFactoryConstructor",
$.oy);this.Ea.ta("labelsAfterInitCallback",c);this.za=new $.my(this,d,$.Ao);this.za.ta("labelsFactoryConstructor",$.oy);this.za.ta("labelsAfterInitCallback",c)},Y$=function(a,b,c){if(b){var d=X$(a,b,"fill",c);a=X$(a,b,"stroke",c);b=b.Z0;b.fill(d);b.stroke(a)}},Z$=function(a){var b=a.O();if(b){b.suspend();for(var c=0;c<a.b.length;c++)Y$(a,a.b[c],$.hm);a.b.length=0;b.resume()}},Iua=function(a,b){if(b&&b.length)for(var c=0;c<b.length;c++){var d=b[c],e=$.iC(a.ue);d.Z0=e;e.So(d.Dc);e.To(d.uc);e.Eb(d.Eb);
e.zIndex(31);e.tag={PN:d};Iua(a,d.children)}},Jua=function(a,b){if(b&&b.length)for(var c=0;c<b.length;c++){var d=b[c],e=X$(a,d,"fill",$.hm),f=X$(a,d,"stroke",$.hm),h=d.Z0;h.fill(e);h.stroke(f);Jua(a,d.children)}},Kua=function(a,b){return b.parent.rN?a.cc().nc(b.index):$.Ql(Kua(a,b.parent))},X$=function(a,b,c,d){c=a[d===$.hm?"normal":d===$.Ao?"hovered":"selected"]().g(c);return $.E(c)?(a={sourceColor:Kua(a,b),item:b.item,value:b.value,name:b.name,depth:b.depth,index:b.index,weight:b.weight,isLeaf:b.MA},
c.call(a,a)):c},Lua=function(a){a.ue||(a.ue=new $.hC(function(){return $.ok()},$.ia),a.ue.zIndex(30),a.ue.parent(a.Oa),a.Kf=a.Oa.Bd(),a.Kf.zIndex(32),a.Qa().labels().O(a.Kf))},Mua=function(a,b){var c=new W$(a,b);c.$c();return c};$.H(W$,$.Cx);$.Jq(W$,["fill","stroke","labels"],"normal");$.g=W$.prototype;$.g.ra=$.Cx.prototype.ra|16;$.g.sa=$.Cx.prototype.sa|4368;$.g.data=function(a,b){return $.n(a)?($.J(a,$.bu)||$.J(a,$.Zt)?a!=this.la&&(this.la&&$.nr(this.la,this.dd,this),this.la=a,$.L(this.la,this.dd,this)):(this.la&&$.nr(this.la,this.dd,this),this.la=new $.bu(a,b),$.L(this.la,this.dd,this)),Z$(this),this.B(4352,1),this):this.la};$.g.dd=function(a){$.X(a,16)&&this.B(4352,1)};
$.g.$c=function(){this.ca.Ga(this.oa);$.W(this,"normal",this.ca);this.ca.fa(!0,{});$.W(this,"hovered",this.za);this.za.fa(!0,{});$.W(this,"selected",this.Ea);this.Ea.fa(!0,{})};$.g.cc=function(a){if($.J(a,$.Os))return this.Hc($.Os,a),this;if($.J(a,$.Ls))return this.Hc($.Ls,a),this;$.C(a)&&"range"==a.type?this.Hc($.Os):($.C(a)||null==this.Fa)&&this.Hc($.Ls);return $.n(a)?(this.Fa.N(a),this):this.Fa};
$.g.Hc=function(a,b){if($.J(this.Fa,a))b&&this.Fa.N(b);else{var c=!!this.Fa;$.pd(this.Fa);this.Fa=new a;$.W(this,"palette",this.Fa);this.Fa.Gp();b&&this.Fa.N(b);$.L(this.Fa,this.Of,this);c&&this.B(16,1)}};$.g.Of=function(a){$.X(a,2)&&this.B(16,1)};$.g.Qa=function(a){return $.n(a)?(this.ca.N(a),this):this.ca};$.g.lb=function(a){return $.n(a)?(this.za.N(a),this):this.za};$.g.selected=function(a){return $.n(a)?(this.Ea.N(a),this):this.Ea};
$.g.labels=function(a){return $.n(a)?(this.ca.labels(a),this):this.ca.labels()};$.g.ce=function(a){$.X(a,1)&&this.B(256,1)};$.g.Ue=function(){return[]};
$.g.ql=function(a){var b=a.domTarget;b=b&&b.tag&&b.tag.PN;var c=a.type;if(b){switch(c){case "mouseout":c="pointmouseout";break;case "mouseover":c="pointmouseover";break;case "mousemove":case "touchmove":c="pointmousemove";break;case "mousedown":case "touchstart":c="pointmousedown";break;case "mouseup":case "touchend":c="pointmouseup";break;case "click":c="pointclick";break;case "dblclick":c="pointdblclick"}a={type:c,actualTarget:a.target,target:this,originalEvent:a};a.index=b.index;a.isLeaf=b.MA;
a.weight=b.weight;a.name=b.name;a.value=b.value;a.point=b.item;a.cx=b.Dc;a.cy=b.uc;a.radius=b.Eb;a.bounds=b.Ua;a.depth=b.depth;return a}return null};$.g.Hf=function(a){var b=this.ql(a);if(b&&this.dispatchEvent(b)){var c=(b=a.domTarget)&&b.tag&&b.tag.PN;c&&($.Aa(this.b,c)||Y$(this,c,$.Ao),b=this.Ta(),c=this.Ic(c),$.Pw(b,a.originalEvent.clientX,a.originalEvent.clientY,c))}};
$.g.hg=function(a){var b=this.ql(a);b&&this.dispatchEvent(b)&&((a=(a=a.domTarget)&&a.tag&&a.tag.PN)&&!$.Aa(this.b,a)&&Y$(this,a,$.hm),this.Ta().Kc())};$.g.maa=function(a){(a=this.ql(a))&&this.dispatchEvent(a)};
$.g.Cs=function(a){var b=this.ql(a);b&&this.dispatchEvent(b)?(b=(b=a.domTarget)&&b.tag&&b.tag.PN)?!$.zd&&a.ctrlKey||$.zd&&a.metaKey?$.Aa(this.b,b)?($.Fa(this.b,b),Y$(this,b,$.hm)):(this.b.push(b),Y$(this,b,$.Bo)):(Z$(this),this.b.push(b),Y$(this,b,$.Bo)):Z$(this):Z$(this);a={type:"pointsselect",points:[]};for(b=0;b<this.b.length;b++)a.points.push(this.b[b].item);this.dispatchEvent(a)};
$.g.ob=function(){if(this.J(4096)){var a=this.data(),b={index:0,MA:!1,rN:!0,parent:null,depth:-1};Gua(a.Sv(),b);b.c7=Fua(b.children);this.f=b;this.B(4)}};$.g.Ic=function(a){this.i||(this.i=new $.Gw);var b={item:{value:a.item,type:""},value:{value:a.value,type:"number"},name:{value:a.name,type:"string"},depth:{value:a.depth,type:"number"},index:{value:a.index,type:"number"},weight:{value:a.weight,type:"number"},isLeaf:{value:a.MA,type:"string"}};this.i.lg(a.item);return $.qv(this.i,b)};
$.g.Jt=function(a){var b=this.labels();b.clear();b.ka();if(b.enabled()&&a){var c=a.children||[];c=a.rN?c:$.Ga(a,c);for(a=0;a<c.length;a++){var d=c[a],e=this.Ic(d);e=b.add(e,null);var f=$.Ek(e.ic("position"));d={value:$.Jo(d.Ua,f)};e.jc(d);e.W()}}b.da(!0);b.W()};
$.g.Qh=function(a){if(!this.pf()){Lua(this);this.ob();var b=this.f;for(var c=0;c<this.j.length;c++)b=b.children[this.j[c]];this.J(4)&&(Hua(b.children,b,a),this.ue.clear(),Iua(this,this.f.children));this.J(16)&&(Jua(this,this.f.children),this.I(16));this.J(256)&&(this.Jt(b),this.I(256))}};$.g.F=function(){var a=W$.u.F.call(this);a.data=this.data().F();a.tooltip=this.Ta().F();a.palette=this.cc().F();a.normal=this.Qa().F();a.hovered=this.lb().F();a.selected=this.selected().F();return a};
$.g.U=function(a,b){W$.u.U.call(this,a,b);"data"in a&&this.data(a.data);"tooltip"in a&&this.Ta().fa(!!b,a.tooltip);"normal"in a&&this.Qa().fa(!!b,a.normal);"hovered"in a&&this.lb().fa(!!b,a.hovered);"selected"in a&&this.selected().fa(!!b,a.selected);"palette"in a&&this.cc(a.palette)};$.g.Zj=function(a,b){return $.ru(this.data(),b)};var $$=W$.prototype;$$.data=$$.data;$$.labels=$$.labels;$$.palette=$$.cc;$$.tooltip=$$.Ta;$$.getType=$$.Ma;$$.toCsv=$$.Zj;$$.normal=$$.Qa;$$.hovered=$$.lb;
$$.selected=$$.selected;$.Wp["circle-packing"]=Mua;$.F("anychart.circlePacking",Mua);}).call(this,$)}
if(!_.theme_circle_packing){_.theme_circle_packing=1;(function($){$.ra($.fa.anychart.themes.defaultTheme,{circlePacking:{normal:{fill:$.CN,stroke:$.HN,labels:{format:"{%name}",enabled:!0,anchor:"center-top",position:"center-top",fontSize:14,fontColor:"#fff",textShadow:"2px 2px 0px black",disablePointerEvents:!0}},hovered:{fill:$.IN,stroke:$.KN},selected:{fill:"#333 0.85",stroke:"#fff"},tooltip:{titleFormat:"{%name}",format:"Value: {%value}"}}});}).call(this,$)}
