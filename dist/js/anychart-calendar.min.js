...
[["format",0,1],["inverted",0,8],["monthsPerRow",0,1],["underSpace",0,8]])},jU=function(a,b){$.Cx.call(this);this.Ga("calendar");$.tu(this,this,this.Hf,this.hg,null,this.Hf,this.haa,null);this.ba=[];this.data(a||null,b);this.aa=[];this.ea=[];this.i={};this.f=0;this.B(4294967295)},Vga=function(a,b){var c=a.ba[b];c||(c=new cU(a),c.kb(a),a.ba[b]=c);return c},Wga=function(a,b,c){var d=a.Fg();if(c!==$.hm){var e=c===$.Ao?d.lb():d.selected();e=e.g(b);if(null!=e&&!$.E(e))return e}b=d.Qa().g(b);$.E(b)&&(d=
a.He(),b=b.call(d,d));return e?(d=a.He(b),e.call(d,d)):b},Xga=function(a,b,c){var d=b.tag.Ah;a.$().select(d);d=Wga(a,"fill",c);a=Wga(a,"stroke",c);b.fill(d);b.stroke(a)},kU=function(a,b){for(var c=a.$h().g("inverted"),d=0;d<a.ba.length;d++)Vga(a,c?a.aa.length-d-1:d).B(b)},Yga=function(a,b){var c=new jU(a,b);c.bP(c.vf("colorScale"));return c},Zga=[31,28,31,30,31,30,31,31,30,31,30,31],$ga=[31,29,31,30,31,30,31,31,30,31,30,31];$.H(bU,$.Fr);
bU.prototype.CC=function(){for(var a=[],b,c,d=this.de.$();d.advance();)b=d.get("x"),c=Number(d.get("value")),b=$.ss(b),null==b||(0,window.isNaN)(c)||(c=d.ma(),a.push({value:+b,index:c}));a.sort(function(a,b){return a.value-b.value});for(d=a.length;d--;)a[d]=a[d].index;return a};$.H(cU,$.xu);$.g=cU.prototype;$.g.sa=$.xu.prototype.sa|2080374800;$.g.fB=function(a){var b=536870912,c=0;$.X(a,1)&&(c|=1);$.X(a,8)&&(b|=4,c|=8);this.B(b,c)};$.g.title=function(a){this.jb||(this.jb=new $.bw,$.W(this,"title",this.jb),this.jb.Wj(!0),$.L(this.jb,this.fB,this));return $.n(a)?(this.jb.N(a),this):this.jb};$.g.iaa=function(){this.B(268435456,1)};
$.g.background=function(a){this.Ha||(this.Ha=new $.zu,$.W(this,"background",this.Ha),this.Ha.Wj(!0),$.L(this.Ha,this.iaa,this));return $.n(a)?(this.Ha.N(a),this):this.Ha};
$.g.Jv=function(){this.Na||(this.Na=$.pk(),$.su(this,this.Na));this.Za||(this.Za=$.ng().Vo(),this.Kf=$.vk(this.Za),this.Kf.zIndex(1),this.Kf.parent(this.Na));this.D||(this.D=this.Na.path(),this.D.zIndex(1));this.j||(this.j=this.Na.path(),this.j.zIndex(2));this.G||(this.G=this.Na.path(),this.G.zIndex(3));this.ue?this.ue.clear():(this.ue=new $.hC(function(){return $.rk()},function(a){a.clear()}),this.ue.zIndex(4),this.ue.parent(this.Na));this.P||(this.P=this.Na.path(),this.P.zIndex(5));this.K||(this.K=
this.Na.path(),this.K.zIndex(6))};$.g.remove=function(){this.Na&&this.Na.parent(null)};
$.g.Mm=function(){var a=this.title(),b=this.pb(),c=b.left,d=b.top;b=b.width;a=a.g("fontSize");a=24>a?a+3:Math.round(1.2*a);var e=$.M("2%",b),f=this.pa.pg().labels().g("fontSize");f=5+(24>f?f+3:Math.round(1.2*f))+this.Pd;var h=b-a-e-1;this.Ia=(h-55*this.Ja)/54;var k=this.ba?7:7-this.b.length;k=this.Ia*k+(k-1+2)*this.Ja;this.$a=f+k;this.Gd=$.nn(c,d,b,this.$a);this.ag=$.nn(c,d,a,this.$a);this.xg=$.nn(c+a,d+f,e,k);this.pe=$.nn(c+a+e,d,h,f);this.sb=$.nn(c+a+e,d+f,h,k)};
$.g.W=function(){if(!this.zc())return this;this.Jv();this.Ja=this.pa.Fg().g("spacing");this.Pd=this.pa.pg().g("underSpace");this.ba=this.pa.QJ().g("showWeekends");this.b=this.f?$.Ha(this.f.weekendRange):[];this.fh=[];this.na={};var a,b=0;for(a=this.b[0];a<=this.b[1];a++){var c=(a+1)%7;this.fh[b++]=c;this.na[String(c)]=!0}this.aa={};this.Ub={};for(a=b=0;7>a;a++)c=(a+this.Ca)%7,!this.ba&&c in this.na||(this.aa[c]=b++),this.Ub[c]=a;this.J(2)&&(this.Na.parent(this.O()),this.I(2));this.J(8)&&(this.Na.zIndex(this.zIndex()),
...
d=dU(this,this.aa[a],0,this.xg),d=$.nn(d.left,d.top,d.right-d.left,d.bottom-d.top),h=this.pa.QJ().labels().flatten(),e.text(b),e.style(h),e.Hj(),$.Qx(e,this.Za),$.Xx(e,d,this.O().Ka()));this.I(67108864)}if(this.J(134217728)){for(a=0;12>a;a++)e=this.Uc[a]||(this.Uc[a]=new $.Jx),b=c[a],d=Uga(this,a),f=d.i6,0!==this.aa[d.h6%7]&&(f+=1),d=dU(this,0,f,this.pe),d=$.nn(d.left+5,d.top,d.right-d.left,d.bottom-d.top),f=this.pa.pg().labels().flatten(),e.text(b),e.style(f),e.Hj(),$.Qx(e,this.Za),$.Xx(e,d,this.O().Ka());
this.I(134217728)}if(this.J(16)){a=this.sd=this.pa.data().$();b=this.i.Q0;for(c=0;c<b.length;c++){d=b[c];a.select(d);e=$.ss(a.Eh());f=0;h=e.getUTCMonth();for(k=0;k<h;k++)f+=this.fb[k];f+=this.ea+e.getUTCDate()-1;k=(f-this.Ca)%7;h=Math.floor((f-k)/7);f<k&&(h+=1);f%=7;k=$.iC(this.ue);k.tag={Ah:d,x:e,value:a.get("value"),timestamp:e.getTime(),Y6:h,day:f,month:e.getUTCMonth(),year:e.getUTCFullYear()};Xga(this.pa,k,$.hm);!this.ba&&f in this.na||Tga(this,dU(this,this.aa[f],h,this.sb),k)}this.I(16)}return this};
...
$.g.ob=function(){if(this.J(4096)){this.aa=[];this.ea=[];this.i={};var a=this.data().$();for(a.reset();a.advance();){var b=Number(a.get("value")),c=a.get("x"),d=$.ss(c);c=a.ma();var e=d.getUTCFullYear();d=d.getUTCMonth();e in this.i||(this.i[e]={X3:[],Q0:[]});var f=this.i[e];f.Q0.push(c);$.Ua(f.X3,d);$.Ua(this.aa,e);$.Ua(this.ea,b)}this.B(16388);this.I(4096)}this.J(16384)&&(a=this.ea,this.vb&&(this.vb.Nf()?(this.vb.Ag(),this.vb.Xc(a[0],a[a.length-1]),this.vb.Hg()):(this.vb.Ao(),this.vb.Xc(a[0],a[a.length-
1])),$.J(this.vb,$.iz)&&$.Qt(this.vb.Xa())),kU(this,16),this.B(8192),this.I(16384))};$.g.yj=function(){return!this.$().Gb()};$.g.Ue=function(){return[]};$.g.hja=function(a){var b=0;$.X(a,8)&&(b|=4);$.X(a,1)&&(b|=1879048192);kU(this,b);this.B(8192,1)};$.g.$h=function(a){this.j||(this.j=new iU,$.L(this.j,this.hja,this),$.W(this,"years",this.j));return $.n(a)?(this.j.N(a),this):this.j};$.g.Oia=function(a){var b=0;$.X(a,8)&&(b|=4);$.X(a,1)&&(b|=1207959552);kU(this,b);this.B(8192,1)};
$.g.pg=function(a){this.G||(this.G=new gU,$.L(this.G,this.Oia,this),$.W(this,"months",this.G));return $.n(a)?(this.G.N(a),this):this.G};$.g.gja=function(a){var b=0;$.X(a,8)&&(b|=4);$.X(a,1)&&(b|=67108864);kU(this,b);this.B(8192,1)};$.g.QJ=function(a){this.K||(this.K=new hU,$.L(this.K,this.gja,this),$.W(this,"weeks",this.K));return $.n(a)?(this.K.N(a),this):this.K};$.g.Gia=function(a){var b=0;$.X(a,8)&&(b|=4);$.X(a,1)&&(b|=16);$.X(a,8192)&&(b|=1073741824);kU(this,b);this.B(8192,1)};
$.g.Fg=function(a){this.b||(this.b=new fU,$.W(this,"days",this.b),this.b.$c(),$.L(this.b,this.Gia,this));return $.n(a)?(this.b.N(a),this):this.b};$.g.Aia=function(a){var b=0,c=0;$.X(a,1)&&(b|=32768,c|=1);$.X(a,8)&&(b|=4,c|=8);this.B(b,c)};$.g.Qi=function(a){this.Mb||(this.Mb=new $.ZN,$.W(this,"colorRange",this.Mb),this.Mb.kb(this),$.L(this.Mb,this.Aia,this),this.B(32772,1));return $.n(a)?(this.Mb.N(a),this):this.Mb};
...
$.g.He=function(a){var b=a||"blue 0.5";a=this.$().get("value");var c=this.kd();b={value:a,sourceColor:b};c&&(b.scaledColor=c.Qq(a));return b};$.g.$q=function(a){return $.J(a,$.ZN)};
...
var d=this.$h().background(),e=b.F(),f=d.F();b.I(4294967295);b.background().I(4294967295);d.I(4294967295);b={title:e,background:f};this.f=0;c=c.clone();d=this.j.g("underSpace");f=this.aa.length;for(e=0;e<f;e++){var h=a?f-e-1:e;var k=this.aa[h];h=Vga(this,h);h.U(b,!1);h.O(this.Aa);var l=h;if(l.gc!==k){l.gc=k;var m=l.gc;l.sc=0==m%400||0==m%4&&0!=m%100;l.nf=l.sc?366:365;l.fb=l.sc?$ga:Zga;l.Ca=l.f?l.f.firstDayOfWeek:0;l.ea=(new Date(Date.UTC(l.gc,0,1))).getUTCDay();l.ea<l.Ca&&(l.ea+=7)}h.i=this.i[k];
