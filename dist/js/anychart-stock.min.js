 ...
 */
(function(global,factory){if(typeof module==='object'&&typeof module.exports==='object'){var wrapper=function(w){if(!w.document){throw Error('AnyChart requires a window with a document');}factory.call(w,w,w.document);try{w.acgraph.isNodeJS=Object.prototype.toString.call(global.process)=="[object process]";}catch(e){};return w.anychart;};module.exports=global.document?wrapper(global):wrapper;}else{factory.call(global,window,document)}})(typeof window!=='undefined'?window:this,function(window,document,opt_noGlobal){var $,_,$_=this.anychart;if($_&&(_=$_._)){$=$_.$}else{throw Error('anychart-base.min.js module should be included first. See modules explanation at https://docs.anychart.com/Quick_Start/Modules for details');$={};_={}}if(!_.stock){_.stock=1;(function($){var fT=function(a){$.T(a,this.KJ,this);a.ib(this)},gT=function(a,b){switch(a){case "log":return $.Oq();case "linear":return $.Nq();case "date-time":return $.Pq();default:return b?null:$.Nq()}},Ufa=function(a,b){switch(a){case "year":return 315576E5*b;case "semester":return 315576E5*b/2;case "quarter":return 315576E5*b/4;case "month":return 315576E5*b/12;case "third-of-month":return 315576E5*b/36;case "week":return 6048E5*b;case "day":return 864E5*b;case "hour":return 36E5*b;case "minute":return 6E4*
b;case "second":return 1E3*b;default:return b}},Vfa=function(a){a=String(a).toLowerCase();switch(a){case "first":case "open":return"first";case "last":case "close":return"last";case "max":case "high":case "maximum":case "highest":return"max";case "min":case "low":case "minimum":case "lowest":return"min";case "average":case "avg":return"average";case "weightedaverage":case "weightedavg":case "wavg":case "weights":case "weighted":return"weighted-average";case "firstvalue":case "firstval":case "openvalue":case "openval":return"first-value";
...
c=Math.round(b+c)):c=window.NaN;return c},vT=function(a,b){var c;c=a.b.length;if(2<=c&&!(0,window.isNaN)(b)){for(var d=0;d<a.B.length;d++){var e=a.B[(a.j-d-1+2)%2];if(e.key==b)return e.index}d=$.ib(a.b,rT,b);0>d?(d=~d-1,0>d?d=0:d>=c-1&&(d=c-2),c=a.b[d].key,c=(b-c)/(a.b[d+1].key-c)+d):c=d;a.B[a.j]={key:b,index:c};a.j=(a.j+1)%2}else 1==c?(c=a.b[0].key,c=b-c):c=window.NaN;return c},aga=function(a,b){return a.b.length?1<a.b.length?uT(a,$.tb(Math.round(vT(a,b)),0,a.b.length-1)):a.b[0].key:window.NaN},
...
w[m]==Number.NEGATIVE_INFINITY&&(w[m]=window.NaN);else for(m in t)v[m]==Number.POSITIVE_INFINITY&&(v[m]=window.NaN),w[m]==Number.NEGATIVE_INFINITY&&(w[m]=window.NaN);for(m=0;m<=a.F;m++)x[m]==Number.POSITIVE_INFINITY&&(x[m]=window.NaN),z[m]==Number.NEGATIVE_INFINITY&&(z[m]=window.NaN);N&&(a.K={},a.ga={},$.ua(a.K,v),$.ua(a.ga,w),a.ca=$.db(x,0),a.ia=$.db(z,0))}}else{if(u)for(m=0;m<t;m++)v[m]=w[m]=window.NaN;else for(m in t)v[m]=w[m]=window.NaN;for(m=0;m<=a.F;m++)x[m]=z[m]=window.NaN}f={Cf:b,rg:c,Do:d,
Ig:p,lastIndex:q,Fr:e,qV:k,wK:f,tU:h,cM:l,LU:v,HU:w,tR:z,uR:x};r&&(a.ba[a.U]=f,a.U=(a.U+1)%4);return f},AT=function(a){var b=a.b.length;return b?YT(a,a.b[0].key,a.b[b-1].key,window.NaN,window.NaN):YT(a,window.NaN,window.NaN,window.NaN,window.NaN)},MT=function(a,b,c){c=c||"exact";for(var d=0;d<a.$.length;d++){var e=a.$[(a.R-d-1+2)%2];if(e.key==b&&e.mode==c)return e.index}d=$.ib(a.b,rT,b);if(0>d)if(d=~d,"exact-or-next"==c)d=d<a.b.length?d:window.NaN;else if("exact-or-prev"==c)d=0<d?d-1:window.NaN;else{if("nearest"==
c)return c=a.b.length,d?d<c?(a=a.b[d],b-a.b.key<a.key-b?d-1:d):c?c-1:window.NaN:c?0:window.NaN;d=window.NaN}a.$[a.R]={key:b,mode:c,index:d};a.R=(a.R+1)%2;return d},uU=function(a,b){rU.call(this,a);this.B=b||null;this.g=tU;this.j=0},vU=function(a,b,c,d,e,f){e=e?a.j:c.length;var h,k;$.n(f)?(f=$.ib(b,rT,f),b=b[0<=f?f:~f]):b=b[0];if(b)if(f=a.b[a.b.length-1]||null,d){d.g.setTime(b.key);d.I();var l=d.next();do{for(var m=d.next(),p=!1;b&&((0,window.isNaN)(m)||b.key<m);){p=!0;for(h=0;h<e;h++)k=c[h],k.b(b.values[k.j],
...
("zero"==e?(r="zero",v=0):(r=a.Sd("fieldName",0,f,$.Ao,!1,void 0,!0),v=Number(u.get(r))),"series-positive"==e&&0>v||"series-negative"==e&&0<v?(v=0,m=Number(u.G("zero")),(0,window.isNaN)(m)&&(m=t.Qf(t.Ya().transform(0),!1)),m=$.tb(m,a.ma.top,a.ma.top+a.ma.height),e=m==a.ma.top+a.ma.height?"axis":"zero"):(m=Number(u.G(r)),(0,window.isNaN)(m)&&!(0,window.isNaN)(v)&&(m=t.Qf(t.Ya().transform(v),!1)),m=$.tb(m,a.ma.top,a.ma.top+a.ma.height)),"auto"==p&&(p=0>v||!v&&"series-negative"==e?"down":"up"))}(0,window.isNaN)(m)&&
...
a.b;if(c){var p=nV(k,c,!0,e),k=nV(k,c,!1,e);c=1==c?a.j:a.B;c=e?c.Df():c;h=$.ab([b],c.oa,k,[d],m.oa,e?null:a.oa,l,c.La,p,m.La,e?null:a.La,h)}else h=$.ab([d],m.oa,e?null:a.oa,l,m.La,e?null:a.La,h);a.I[f]=h}return h},kV=function(a,b,c){for(var d=0;d<a.length;d++){var e=a[d];if($.A(e)&&(e=e[b],null!=e))return c(e)}},lV=function(a,b){var c=a.Ie.Ub().$o().pm();return{date:{value:b.b<b.Fa.length?b.Fa[b.b].items[b.j].key:window.NaN,type:"date-time"},groupedDate:{value:b.Pn(),type:"date-time"},group:{value:a,
...
a,b);this.B=$.Xm(c,14,!1);this.K=hT(f,"sma");this.F=$.Xm(d,1,!1);this.I=hT(e,"sma");this.j=$.Xm(e,3,!1);rV(this,"kSeries",k);rV(this,"dSeries",l);sV(this)},BX=function(a){$.X.call(this);this.Oa=a;this.$=this.B=null;this.b=[];this.K=[];this.Dc=null;this.I=[];this.ga=[];this.o=null;this.za=[];this.Ja=[];this.ta=[];this.Ca=[];this.ba=this.ia=this.R=null;this.Ta=!1;this.Da=void 0;this.Pb=(0,$.sa)(function(){this.Da=void 0;if((0,window.isNaN)(this.Ka)){var a=this.Oa;a.U=window.NaN;a.ia=window.NaN;a.ta=
window.NaN;a.Ka=null;zX(a)}else{var a=this.Oa,c=this.Ka,d=this.Sa,e=this.rc;a.U=c;a.ia=d;a.ta=e;a.Ka=this;AX(a,c,d,e,this)}},this);this.mv("line");$.vo(this.F,[["pointWidth",128,1,0,this.tr],["maxPointWidth",128,1,0,this.tr],["minPointLength",128,1,0,this.zQ]])},CX=function(a,b){return $.Ra(a.b,function(a){return a.id()==b})},DX=function(a,b,c){var d,e=1024;b&&(e|=4);for(d=0;d<a.b.length;d++)a.b[d]&&a.b[d].D(e);a.ba&&a.ba.D(64);a.Oa.o&&a.jy().Bt();for(d=0;d<a.I.length;d++)if(e=a.I[d])$.U(e),e.Tk(),
e.ja(!1);var f=$.ab(a.za,a.Ja,a.ta,a.Ca);for(d=0;d<f.length;d++)(e=f[d])&&e.D(64);e=16;b&&(e|=4);a.o&&a.o.D(e);!c&&a.Wa&&a.Wa.enabled()&&a.Wa.D(e);for(d=0;d<a.ga.length;d++)(b=a.ga[d])&&b.D(20);a.D(126848)},EX=function(a,b){return(b?a.me:a.ye).zIndex+.001*$.ab(a.za,a.Ja,a.ta,a.Ca).length},FX=function(a){a.g||(a.g=$.kj(),$.ir(a,a.g),a.R=a.g.rect(),a.R.zIndex(199),a.R.fill($.Uk),a.R.stroke(null),a.wa.Rd(a.R,"mousedown",a.xQ),a.wa.Rd(a.R,"touchstart",a.xQ),a.wa.pa(a.R,"mouseover",a.TT),a.wa.pa(a.R,"mousemove",
...
k.orientation()?(k.qa(c.left-l-f,c.top,0,c.height),f+=l):"right"==k.orientation()&&(h+=l,k.qa(c.left,c.top,c.width+h,c.height));k.ja(!1)}}a.o&&a.o.enabled()&&($.U(a.o),a.o.qa(c.left,c.top,c.width,c.height+a.o.height()),a.o.ja(!1),c=a.o.Xc());"inside"==e.Er()&&(GX(a,c,d),a.ya(64,!0));a.P=c;a.R.Ue(a.P);a.jm().qa(c);DX(a,!0,!0);a.W(2052)}},GX=function(a,b,c,d){var e=a.ee();$.U(e);e.aa(a.g);b&&e.qa(b);b=a.qT(e.Lx(),c,d);null===b||$.ss(e.title(),b);e.bw()||e.bw(a);e.D(1040);e.ea();e.ja(!1)},fga=function(a,
b){return(0,$.qb)(a.b,function(a){return{series:a,point:a&&a.enabled()&&a.Fa.search(b,"exact")||null}})},gga=function(a,b,c,d,e){if(a.g&&a.P){var f="sticky"==a.jm().N("displayMode")?b:c,h=a.Oa.Ra().transform(f),k=$.lc(a.jm().N("yStroke")),l=a.P.left+h*a.P.width,l=$.pn(l,k),k=a.jm(),m=a.Ta;$.n(m)&&(k.ba=m);k=a.jm();m=a.Ta;d=d!=a;k.enabled()&&(d?$.lw(k):$.n(e)&&(d=$.Ti(k.aa().Ea()),e-=d.y,$.nw(k,k.b,l,e),$.qw(k,k.b,l,e)),m||k.j.Af("enabled")&&k.j.oa.enabled?$.qw(k,k.o,l,e||0,h):k.j.aa(null).remove(),
$.nw(k,k.o,l,e||0));for(h=0;h<a.b.length;h++)if(e=a.b[h])e.ca=e.Fa.search(f,"exact"),e.Sa=!0;a.Wa&&a.Wa.enabled()&&GX(a,null,b,c);a.ya(64)}},IX=function(a,b,c){if($.J(a.j,b))c&&a.j.Y(c);else{var d=!!a.j;$.K(a.j);a.j=new b;c&&a.j.Y(c);$.T(a.j,a.dJ,a);d&&a.D(4608,1)}},JX=function(a,b,c,d,e,f){var h,k,l,m,p,q=[];for(h=0;h<b.length;h++)if(p=b[h]){m=p.O();if(k=p.scale())l=$.qa(k),e[l]?m.scale=(0,$.Ta)(d,e[l]):(e[l]=k.O(),d.push(e[l]),m.scale=d.length-1);if(l=p.Sg())k=$.qa(l),k=(0,$.Ta)(f,k),0>k?(k=l.scale(),
"layout"in m||(p=!1,$.J(l,$.Gu)&&(l=l.orientation(),p="left"==l||"right"==l),m.layout=p?"horizontal":"vertical"),"scale"in m||(l=$.qa(k),e[l]?m.scale=(0,$.Ta)(d,e[l]):(e[l]=k.O(),d.push(e[l]),m.scale=d.length-1))):m.axis=k;q.push(m)}q.length&&(c[a]=q)},LX=function(a,b){$.Bf.call(this,b.ka());this.b=a;this.j=void 0;this.U=(0,$.sa)(function(){this.j=void 0;KX(this.b.Oa,this.ga,this.ca)},this);$.Cf(this);this.pa("start",this.B4,!1,this);this.pa("end",this.A4,!1,this)},MX=function(a,b,c){this.b=this.Ta=
this.Ka=this.we=null;VU.call(this,a,a,b,c)},NX=function(){},OX=function(a){$.hp.call(this);this.R=1E3;this.I=6;this.j=a;this.xr=this.yo=this.Bm=this.$k=this.wa=this.o=this.K=this.P=window.NaN;this.b=!1;this.B=null;this.g=[];this.Ia(hga)},PX=function(a,b){return a.j.iy(Math.ceil(a.j.Gk(b)))},bU=function(a,b,c,d,e){b=$.tb(b,a.P,a.K);c=$.tb(c,a.P,a.K);var f=a.j.Gk(b),h=a.j.Gk(c);(0,window.isNaN)(f)||(0,window.isNaN)(h)?(a.$k=window.NaN,a.Bm=window.NaN):(a.$k=b,a.Bm=c);a.yo=f;a.xr=h;a.Le=d;a.count=e;
a.b=!1;a.ya(512)},iga=function(a){var b=[];if($.y(a)){for(var c=0;c<a.length;c++){var d=a[c];if($.A(d)){var e=QX(d.minor),d=QX(d.major);e&&d&&b.push({Ld:Ufa(e[0],e[1]),jA:e[0],iA:e[1],Zz:d[0],YE:d[1]})}}b.sort(function(a,b){return a.Ld-b.Ld})}return b},QX=function(a){var b=null,c;$.B(a)?(b=$.Tj(a,null),c=1):$.A(a)&&(b=$.Tj(a.unit,null),c=$.Xm(a.count));return b?[b,c]:null},RX=function(a){this.va=a;this.P=!0},SX=function(a,b,c){var d=PX(a.va,b.getTime()),e,f=b.getTime();do e=f,b.add(c),f=b.getTime();
while(f<a.end&&PX(a.va,f)==d);return e},TX=function(a){OX.call(this,a)},UX=function(a){$.vx.call(this);this.Oa=a;this.b=[];this.P=[];this.U=this.j=this.Ca=this.ga=this.o=this.Dc=null;this.nv("line")},VX=function(a,b){return $.Ra(a.b,function(a){return a.id()==b})},WX=function(a){for(var b=0;b<a.b.length;b++)a.b[b].D(2116)},XX=function(a){for(var b=0;b<a.b.length;b++){var c=a.b[b];c&&c.D(1024)}a.o&&a.o.D(16);a.D(1536)},YX=function(a,b,c){WX(a);if($.J(a.j,b))c&&a.j.Y(c);else{var d=!!a.j;$.K(a.j);a.j=
...
status:(0,$.qb)(d,function(a){return a.group.sm(a.index)}),eventMarker:e.sm(f),actualTarget:e,target:a,originalEvent:b}},aY=function(a){$.Jt.call(this);this.g=[];this.j=null;this.b=new ST;$.T(this.b,this.p8,this);this.Ta=!1;this.nb=null;this.ga=this.Ca=!1;this.R=this.ta=this.ia=this.U=window.NaN;this.I=this.K=null;this.o=$.fk.anychart.annotations;this.jj={};this.zo=null;this.Sa=(0,$.sa)(this.y8,this);this.lb=(0,$.sa)(this.z8,this);this.Da=-1;var b=!!a;a={};var c;c=4194304|(b&&1048576);b=b?2:1;a.area=
...
AX(a,a.U,a.ia,a.ta,a.Ka)},AX=function(a,b,c,d,e){if(!(a.ga||0>b||1<b)){b=a.Ra().Gc(b);var f=aga(a.b.g,b);if(!(0,window.isNaN)(f)){var h,k={type:"pointshover",infoByPlots:(0,$.qb)(a.g,function(a){return{plot:a,infoBySeries:a&&a.enabled()?fga(a,f):null}}),hoveredDate:f};for(h=0;h<a.g.length;h++)a.g[h]&&gga(a.g[h],f,b,e,d);a.Ca=!0;e=a.gb();if("union"==e.N("displayMode")&&"point"!=e.N("positionMode")){var l=[],k=k.infoByPlots;for(h=0;h<k.length;h++)if(k[h]){var m=k[h].infoBySeries;if(m)for(var p=0;p<
...
$.g.labels=function(a){this.Ha||(this.Ha=new $.Wt,this.Ha.ib(this),$.T(this.Ha,this.Bd,this));return $.n(a)?(!$.A(a)||"enabled"in a||(a.enabled=!0),this.Ha.Y(a),this):this.Ha};$.g.cb=function(a){this.Nb||(this.Nb=new $.Wt,this.Nb.ib(this),$.T(this.Nb,this.Bd,this));return $.n(a)?(!$.A(a)||"enabled"in a||(a.enabled=!0),this.Nb.Y(a),this):this.Nb};
...
$.g.ea=function(){if(!this.gc())return this;this.g||(this.g=$.kj(),this.I||this.g.cd(!0));this.B&&$.U(this.B);this.Ha&&$.U(this.Ha);this.Nb&&$.U(this.Nb);if(this.X(4)){if(this.B){var a=this.qa();a.top=a.top+a.height-this.pc;a.height=this.pc;this.B.qa(a)}this.D(80);this.W(4)}this.X(64)&&(this.B&&(this.B.aa(this.g),this.B.ea()),this.W(64));if(this.X(16)){if(this.va){this.B?a=this.B.Xc():(a=this.qa(),a.top=a.top+a.height-this.pc,a.height=this.pc);this.Ha&&(this.Ha.clear(),$.eu(this.Ha));this.Nb&&(this.Nb.clear(),
$.eu(this.Nb));this.hb&&(this.hb.length(a.height),this.hb.aa(this.g),this.hb.ea());this.uc&&(this.uc.length(a.height),this.uc.aa(this.g),this.uc.ea());var b=this.Ha&&this.Ha.enabled(),c=this.Nb&&this.Nb.enabled();if(b||c){var b=a,c=this.va.no(),d=this.va.Eaa,e=this.va.$aa,f=this.va.Zaa,h=null,k=[],l=null,m=[],p=[],q=[],r,t,u,v=[],w=[],x=[],z=[],E=this.hb&&this.hb.enabled()?this.hb.rz():null,N=this.uc&&this.uc.enabled()?this.uc.rz():null,Q=!(!this.Ha||!this.Ha.enabled()),O=!(!this.Nb||!this.Nb.enabled()),
...
p);l=u;h||(h=u)}m.length=p.length=q.length=0}else!O||l&&l.Sk(u)||"allow-minor-overlap"!=this.b&&p.length&&p[p.length-1].Sk(u)||(m.push(r),q.push(S),p.push(u));t?V++:S++}m.length&&(w.push.apply(w,m),z.push.apply(z,q),k.push.apply(k,p));r=c.F;if(this.j&&!(0,window.isNaN)(r)&&(u=mU(this,r,!0,b,d,e,f,0))&&(!h||!u.Sk(h))){if("allow-overlap"!=this.b){for(l=0;l<k.length&&u.Sk(k[l]);l++);l&&($.Xa(k,0,l),$.Xa(w,0,l),$.Xa(z,0,l))}lU(this,r,!0,b,d,e,f,0)}for(l=0;l<v.length;l++)lU(this,v[l],!0,b,d,e,f,x[l]);
for(l=0;l<w.length;l++)lU(this,w[l],!1,b,d,e,f,z[l])}this.bg||(this.bg=$.pj());this.bg.shape(a);this.Ha&&(this.Ha.aa(this.g),this.Ha.ea(),(a=this.Ha.vb)&&a.clip(this.bg));this.Nb&&(this.Nb.aa(this.g),this.Nb.ea(),(a=this.Nb.vb)&&a.clip(this.bg))}this.W(16)}this.X(8)&&(this.g.zIndex(this.zIndex()),this.W(8));this.X(2)&&(this.g.parent(this.aa()),this.W(2));this.B&&this.B.ja(!1);this.Ha&&this.Ha.ja(!1);this.Nb&&this.Nb.ja(!1);return this};
$.g.da=function(){$.K(this.Ha);this.Ha=null;$.K(this.Nb);this.Nb=null;$.K(this.B);this.B=null;$.K(this.g);this.va=this.g=null;jU.J.da.call(this)};$.g.O=function(){var a=jU.J.O.call(this);a.height=this.height();a.labels=this.labels().O();a.minorLabels=this.cb().O();a.ticks=this.Ia().O();a.minorTicks=this.mb().O();a.background=this.background().O();a.showHelperLabel=this.KM();a.overlapMode=this.$I();return a};
$.g.fa=function(a,b){jU.J.fa.call(this,a,b);this.height(a.height);this.labels().ra(!!b,a.labels);this.cb().ra(!!b,a.minorLabels);this.Ia(a.ticks);this.mb(a.minorTicks);this.background(a.background);this.KM(a.showHelperLabel);this.$I(a.overlapMode)};var HY=jU.prototype;HY.height=HY.height;HY.labels=HY.labels;HY.minorLabels=HY.cb;HY.ticks=HY.Ia;HY.minorTicks=HY.mb;HY.background=HY.background;HY.showHelperLabel=HY.KM;HY.overlapMode=HY.$I;$.G(nU,$.X);nU.prototype.xa=$.X.prototype.xa|208;nU.prototype.Aa=$.X.prototype.Aa;var mga=nU.prototype,IY={};$.R(IY,0,"value",$.Sj);$.R(IY,0,"valueField",$.Do);$.R(IY,1,"stroke",$.Po);$.R(IY,1,"risingStroke",$.Po);$.R(IY,1,"fallingStroke",$.Po);mga.qC=IY;$.Ho(nU,nU.prototype.qC);$.g=nU.prototype;$.g.label=function(a){return $.n(a)?(this.B.Y(a),this):this.B};$.g.k9=function(a){return $.n(a)?(this.I.Y(a),this):this.I};$.g.eda=function(a){return $.n(a)?(this.K.Y(a),this):this.K};
...
this.j.get("close")>p?(f=l?l:f,l=this.K):(f=m?m:f,l=this.I)}m=$.lc(f)||1;this.X(2)&&(p=this.aa(),this.g.parent(p),this.W(2));this.X(8)&&(p=this.zIndex(),this.g.zIndex(p),this.W(8));if(this.X(4)){p=k.Ma()-b*k.height;p=$.pn(p,m);e.clear();e.moveTo(k.left,p).lineTo(k.Qa(),p);e.clip(this.o.Se());e.parent(this.g);if(this.pd.wc("enabled")){var k=p,m=this.o.Se(),q=h.kb(),r=h.enabled(),p=r?q.jb():m.Qa(),q=r?q.Qa():m.jb();switch(h.orientation()){case "left":this.pd.N("anchor");a=q;break;case "right":this.pd.N("anchor"),
...
$.g.da=function(){var a=this.He(),b=this.sa();a.g.splice(b,1);var c;for(c=b;c<a.g.length;c++)a.g[c].Mr(c);a.I.splice(b,1);var b=[],d;for(d in this.g)b.push(this.g[d]);if(b.length){$.jb(a.B);d=[];var e=Number.POSITIVE_INFINITY;for(c=0;c<b.length;c++){var f=~b[c],e=Math.min(e,f);a.B.push(f);for(var h in a.j)if(a.j[h]==b[c]){d.push(h);break}}$.jb(a.B);for(c=0;c<d.length;c++)delete a.j[d[c]];e--;a.Xq.F=Math.min(a.Xq.F,e);for(var k in a.b)a.b[k].F=Math.min(a.b[k].F,e)}$.A(this.b)&&$.D(this.b.dispose)&&
...
m.scale())h=$.qa(e),b[h]?f.scale=(0,$.Ta)(c,b[h]):(b[h]=e.O(),c.push(b[h]),f.scale=c.length-1);d.push($.qa(m));l.push(f)}l.length&&(a.yAxes=l);f=[];for(k=0;k<this.ga.length;k++)(e=this.ga[k])&&(f[k]=e.O());f.length&&(a.priceIndicators=f);JX("xGrids",this.za,a,c,b,d);JX("yGrids",this.Ja,a,c,b,d);JX("xMinorGrids",this.ta,a,c,b,d);JX("yMinorGrids",this.Ca,a,c,b,d);d=[];for(k=0;k<this.b.length;k++){e=this.b[k];f=e.O();if(e=e.Ya())h=$.qa(e),b[h]?f.yScale=(0,$.Ta)(c,b[h]):(b[h]=e.O(),c.push(b[h]),f.yScale=
...
$.g.ie=function(a){return this.BQ(VX(this,a))};$.g.BQ=function(a){return this.b[a]||null};$.g.N5=function(){return this.b.length};$.g.sC=function(a){return this.DQ(VX(this,a))};$.g.DQ=function(a){var b=this.b[a];b&&($.Tn++,$.Xa(this.b,a,1),$.K(b),this.D(512,1),$.Wn());return this};$.g.Z5=function(){if(this.b.length){var a=this.b;$.Tn++;this.b=[];$.Uc(a);this.D(512,1);$.Wn()}return this};$.g.Ce=function(){return this.b};$.g.y5=function(a,b){var c=new CV(this,a,b);this.P.push(c);return c};
...
$.g.da=function(){$.Uc(this.b);delete this.b;$.Uc(this.P);delete this.P;$.K(this.ga);$.K(this.Ca);this.Ca=this.ga=null;$.K(this.o);this.Dc=this.o=null;$.K(this.nb);this.nb=null;delete this.Oa;UX.J.da.call(this)};$.g.O=function(){var a=UX.J.O.call(this);a.defaultSeriesType=this.nv();a.palette=this.py().O();a.hatchFillPalette=this.oy().O();return a};
...
var nga={stock:{"zoom-marquee-start":{index:8,text:"Start zoom marquee",eventType:"anychart.startZoomMarquee",action:function(a){a.chart.GW(!1)}},"stock-specific-separator":{index:9.4}}};$.g=aY.prototype;$.g.oG=function(a){$.Bc(a,$.Gk(nga.stock));return a};$.g.nda=function(a){(a=eY(this,"selectedrangechangestart",nY(a.source)))&&kY(this);return a};
...
$.g.da=function(){$.Uc(this.g,this.j,this.b,this.K,this.I,this.zo);this.zo=this.I=this.K=this.j=this.g=null;delete this.b;delete this.jj;aY.J.da.call(this)};$.g.O=function(){var a=aY.J.O.call(this);delete a.noDataLabel;a.grouping=this.$o().O();a.scrollerGrouping=this.pC().O();a.xScale=this.Ra().O();a.scroller=this.Dw().O();a.plots=(0,$.qb)(this.g,function(a){return a?a.O():null});a.crosshair=this.oC().O();a.eventMarkers=this.sg().O();$.To(this,zZ,a);a.interactivity=this.Hd().O();return a};
...
$.g.WD=function(a){a=aY.J.WD.call(this,a);a.headers.shift();a.data.sort(function(a,c){return a[0]-c[0]});(0,$.Pa)(a.data,function(a){a.shift()});return a};var AZ=aY.prototype;$.F("anychart.stock",function(a){a=new aY(a);a.ra(!0,$.dl("stock"));return a});AZ.plot=AZ.Ie;AZ.crosshair=AZ.oC;AZ.scroller=AZ.Dw;AZ.xScale=AZ.Ra;AZ.selectRange=AZ.cW;AZ.getSelectedRange=AZ.S9;AZ.getType=AZ.Xa;AZ.legend=AZ.ee;AZ.grouping=AZ.$o;AZ.scrollerGrouping=AZ.pC;AZ.annotations=AZ.aJ;AZ.eventMarkers=AZ.sg;
