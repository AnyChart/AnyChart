...
leftPadding:0,hAlign:"start",vAlign:"top",enabled:!0,wordWrap:"break-word",wordBreak:"normal"};this.D.fill="#fff"},ET=function(a){if(a.J(2048)){var b=[],c=a.o?a.b.length/a.o:0,d,e,f=Math.min(c,a.i),h=Math.min(a.o,a.f);for(d=0;d<f;d++){for(e=0;e<h;e++)b.push(a.b[d*a.o+e]);for(e=h;e<a.f;e++)b.push(Iga(a,d,e));for(e=h;e<a.o;e++){var k=a,l=a.b[d*a.o+e];l.content(null);k.P.push(l)}}for(d=f;d<a.i;d++)for(e=0;e<a.f;e++)b.push(Iga(a,d,e));for(d=f;d<c;d++)for(e=0;e<a.o;e++)f=a,h=a.b[d*a.o+e],h.content(null),
f.P.push(h);a.b=b;a.o=window.NaN;a.I(2048);a.B(1984)}},Kga=function(a){if(a.J(64)){var b=a.pb(),c=Jga(a.f,a.G,a.gs,a.fs,a.AL,a.zL,a.yL,b.width,a.aa);b=Jga(a.i,a.K,a.ct,a.bt,a.GK,a.FL,a.EL,b.height,a.ba);a.I(64);if(c||b)a.aa=c||a.aa,a.ba=b||a.ba,a.B(1792)}},GT=function(a,b,c,d,e,f,h){if(f&&"none"!=f){var k=(f.thickness?f.thickness:1)%2?.5:0;b=FT(a,b,c,d,e);c=$.Ul(f);c in a.qv?a=a.qv[c]:(d=a.Qn.length?a.Qn.pop():$.rk(),a.wb.hc(d),$.B(f)&&"keys"in f&&!$.B(f.mode)&&(f=$.Tl(f),f.mode=a.pb()),d.stroke(f),
d.fill(null),a=a.qv[c]=d);switch(h){case 0:a.moveTo(b.tb(),b.Vb()+k);a.lineTo(b.cb()+1,b.Vb()+k);break;case 1:a.moveTo(b.cb()+k,b.Vb());a.lineTo(b.cb()+k,b.Va()+1);break;case 2:a.moveTo(b.tb(),b.Va()+k);a.lineTo(b.cb()+1,b.Va()+k);break;case 3:a.moveTo(b.tb()+k,b.Vb()),a.lineTo(b.tb()+k,b.Va()+1)}}},Lga=function(a,b,c){if(b||c){var d;if((d=b&&b.nb("bottomBorder"))||(d=c&&c.nb("topBorder"))||(d=b&&b.nb("border"))||(d=c&&c.nb("border")))return d;if(a.Tn){var e=a.Tn[(b||window.NaN)&&b.f],f=a.Tn[(c||
...
a.nb("border"))||!c&&(a.nb("bottomBorder")||a.nb("border")))||(d=b&&a.nb("cellBottomBorder"))?d:(d=c&&a.nb("cellTopBorder"))?d:a.nb("cellBorder")||"none"}return"none"},Mga=function(a,b,c){if(b||c){var d;if((d=b&&b.nb("rightBorder"))||(d=c&&c.nb("leftBorder"))||(d=b&&b.nb("border"))||(d=c&&c.nb("border")))return d;var e=a.Tn&&a.Tn[(b||c).f];if(e&&((d=!b&&(e.nb("leftBorder")||e.nb("border"))||!c&&(e.nb("rightBorder")||e.nb("border")))||(d=e.nb("cellRightBorder"))||(d=e.nb("cellLeftBorder"))||(d=e.nb("cellBorder"))||
...
"none"}return"none"},Nga=function(a,b,c){if($.n(c)){var d=!1;null===c?a.ct&&b in a.ct&&(delete a.ct[b],d=!0):(a.ct||(a.ct=[]),a.ct[b]!=c&&(a.ct[b]=c,d=!0));d&&a.B(64,1);return a}return a.ct&&b in a.ct?a.ct[b]:null},Oga=function(a,b,c){if($.n(c)){var d=!1;null===c?a.bt&&b in a.bt&&(delete a.bt[b],d=!0):(a.bt||(a.bt=[]),a.bt[b]!=c&&(a.bt[b]=c,d=!0));d&&a.B(64,1);return a}return a.bt&&b in a.bt?a.bt[b]:null},Pga=function(a,b,c){return $.n(c)?(a.G[b]!=c&&(null===c?delete a.G[b]:a.G[b]=c,a.B(64,1)),a):
b in a.G?a.G[b]:null},Qga=function(a,b,c){if($.n(c)){var d=!1;null===c?a.gs&&b in a.gs&&(delete a.gs[b],d=!0):(a.gs||(a.gs=[]),a.gs[b]!=c&&(a.gs[b]=c,d=!0));d&&a.B(64,1);return a}return a.gs&&b in a.gs?a.gs[b]:null},Rga=function(a,b,c){if($.n(c)){var d=!1;null===c?a.fs&&b in a.fs&&(delete a.fs[b],d=!0):(a.fs||(a.fs=[]),a.fs[b]!=c&&(a.fs[b]=c,d=!0));d&&a.B(64,1);return a}return a.fs&&b in a.fs?a.fs[b]:null},FT=function(a,b,c,d,e,f){ET(a);Kga(a);var h=a.pb();f=$.J(f,$.I)?f:new $.I(0,0,0,0);var k=a.aa[c-
1]+1||0;c=a.aa[Math.min(c+e,a.f)-1];f.width=c-k;f.left=h.left+k;k=a.ba[b-1]+1||0;c=a.ba[Math.min(b+d,a.i)-1];f.height=c-k;f.top=h.top+k;return f},Jga=function(a,b,c,d,e,f,h,k,l){var m,p=!1,q=0,r=[],t=[],u=[],v=0;e=$.M(e,k);f=$.M(f,k);h=$.M(h,k);var w=!1;for(m=0;m<a;m++){var x=c?$.M(c[m],k):window.NaN;var y=d?$.M(d[m],k):window.NaN;var C=b[m];var G=x,F=y;C=$.M(C,k);G=$.M(G,k);F=$.M(F,k);(0,window.isNaN)(C)&&(C=e);(0,window.isNaN)(G)&&(G=f);(0,window.isNaN)(F)&&(F=h);(0,window.isNaN)(G)||(C=Math.max(C,
G));(0,window.isNaN)(F)||(C=Math.min(C,F));(0,window.isNaN)(C)?(v++,(0,window.isNaN)(x)?(0,window.isNaN)(f)||(t[m]=f,w=!0):(t[m]=x,w=!0),(0,window.isNaN)(y)?(0,window.isNaN)(h)||(u[m]=h,w=!0):(u[m]=y,w=!0)):(q+=C,r[m]=C)}if(w&&0<v){var L=[];c=v*v;do for(d=!1,b=Math.max(3*v,k-q)/v,m=0;m<a;m++)if(!(m in r))if(m in L){if(L[m]==t[m]&&t[m]<b){q-=t[m];v++;delete L[m];d=!0;break}if(L[m]==u[m]&&u[m]>b){q-=u[m];v++;delete L[m];d=!0;break}}else{if(m in t&&t[m]>b){q+=L[m]=t[m];v--;d=!0;break}if(m in u&&u[m]<
b){q+=L[m]=u[m];v--;d=!0;break}}while(d&&0<v&&c--)}t=0;u=[];b=Math.max(3*v,k-q)/v;for(m=0;m<a;m++)m in r?C=r[m]:L&&m in L?C=L[m]:C=b,t+=C,k=Math.round(t)-1,u[m]=k,k!=l[m]&&(p=!0);return p?u:null},Iga=function(a,b,c){return a.P.length?a.P.pop().reset(b,c):new AT(a,b,c)},HT=function(a,b,c,d,e,f){return c.o&&c.o[b]||d&&d.o&&d.o[b]||e&&e.o&&e.o[b]||a.D&&a.D[b]||f},IT=function(a,b){DT.call(this,a,b)};$.wx.prototype.lu=$.ca(15,function(){return!0});$.fB.prototype.lu=$.ca(14,function(){return!1});
...
MT.selectable=MT.Fm;MT.disablePointerEvents=MT.Dd;MT.useHtml=MT.Dca;MT.border=MT.yca;$.H(AT,zT);$.g=AT.prototype;$.g.reset=function(a,b){($.ea(this.Od)||$.z(this.Od))&&$.pd(this.hi);this.G=this.K=1;this.f=a;this.D=b;this.hi=this.Od=null;this.b=window.NaN;delete this.o;return this};
...
$.g.Fx=function(a){return $.n(a)?(a=$.P(a,this.K),a!=this.K&&(this.K=a,this.i.B(128,1)),this):this.K};$.g.Gca=function(){return this.f};$.g.Fca=function(){return this.D};$.g.En=function(){return this.i.En(this.f)};$.g.Eca=function(){return this.i.A_(this.D)};$.g.rb=function(){return FT(this.i,this.f,this.D,this.K,this.G)};$.g.fill=function(a,b,c,d,e,f,h){null!=a&&(a=$.Xb.apply(null,arguments));return this.nb("fill",a,512)};$.g.padding=function(a,b,c,d){return this.LW.apply(this,arguments)};
$.g.R=function(){($.ea(this.Od)||$.z(this.Od))&&$.pd(this.hi);AT.u.R.call(this)};var NT=AT.prototype;NT.content=NT.content;NT.rowSpan=NT.Fx;NT.colSpan=NT.Ex;NT.padding=NT.padding;NT.getBounds=NT.rb;NT.getRowNum=NT.Gca;NT.getColNum=NT.Fca;NT.getRow=NT.En;NT.getCol=NT.Eca;NT.fill=NT.fill;$.H(BT,zT);$.g=BT.prototype;$.g.Kca=function(){return this.Ad};$.g.Jca=function(a){return this.i.Jz(a,this.Ad)};$.g.width=function(a){return $.n(a)?(Pga(this.i,this.Ad,a),this):Pga(this.i,this.Ad)};$.g.minWidth=function(a){return $.n(a)?(Qga(this.i,this.Ad,a),this):Qga(this.i,this.Ad)};$.g.maxWidth=function(a){return $.n(a)?(Rga(this.i,this.Ad,a),this):Rga(this.i,this.Ad)};$.g.C_=function(a,b,c,d,e,f,h){null!=a&&(a=$.Xb.apply(null,arguments));return this.nb("fill",a,512)};
$.g.Hca=function(a,b,c,d,e){if($.n(a)){null===a||(a=$.Zb.apply(null,arguments));this.i.ka();this.nb("cellBorder",a,256);for(var f=0;4>f;f++)this.nb(vT[f],null,256);this.i.da(!0);return this}return this.b||(this.b=new xT(this,!0))};$.g.Ica=function(a,b,c,d){return this.LW.apply(this,arguments)};var OT=BT.prototype;OT.width=OT.width;OT.maxWidth=OT.maxWidth;OT.minWidth=OT.minWidth;OT.getCell=OT.Jca;OT.getColNum=OT.Kca;OT.cellFill=OT.C_;OT.cellBorder=OT.Hca;OT.cellPadding=OT.Ica;$.H(CT,zT);$.g=CT.prototype;$.g.Oca=function(){return this.Ad};$.g.Nca=function(a){return this.i.Jz(this.Ad,a)};$.g.height=function(a){return $.n(a)?(this.i.u5(this.Ad,a),this):this.i.u5(this.Ad)};$.g.minHeight=function(a){return $.n(a)?(Nga(this.i,this.Ad,a),this):Nga(this.i,this.Ad)};$.g.maxHeight=function(a){return $.n(a)?(Oga(this.i,this.Ad,a),this):Oga(this.i,this.Ad)};$.g.D_=function(a,b,c,d,e,f,h){null!=a&&(a=$.Xb.apply(null,arguments));return this.nb("fill",a,512)};
$.g.Lca=function(a,b,c,d,e){if($.n(a)){null===a||(a=$.Zb.apply(null,arguments));this.i.ka();this.nb("cellBorder",a,256);for(var f=0;4>f;f++)this.nb(vT[f],null,256);this.i.da(!0);return this}return this.b||(this.b=new xT(this,!0))};$.g.Mca=function(a,b,c,d){return this.LW.apply(this,arguments)};var PT=CT.prototype;PT.height=PT.height;PT.maxHeight=PT.maxHeight;PT.minHeight=PT.minHeight;PT.getCell=PT.Nca;PT.getRowNum=PT.Oca;PT.cellFill=PT.D_;PT.cellBorder=PT.Lca;PT.cellPadding=PT.Mca;$.H(DT,$.xu);$.g=DT.prototype;$.g.ra=$.xu.prototype.ra;$.g.sa=$.xu.prototype.sa|4032;$.g.rh=null;$.g.wb=null;$.g.KF=null;$.g.qv=null;$.g.Nv=null;$.g.Qn=null;$.g.NC=null;$.g.y_=null;$.g.z_=null;$.g.B_=null;$.g.Tn=null;$.g.sn=null;$.g.ct=null;$.g.bt=null;$.g.gs=null;$.g.fs=null;$.g.GK=null;$.g.FL=null;$.g.EL=null;$.g.AL=null;$.g.zL=null;$.g.yL=null;$.g.pX=function(a){return $.n(a)?(a=$.P(a,this.i),this.i!=a&&((0,window.isNaN)(this.o)&&(this.o=this.f),this.i=a,this.B(2176,1)),this):this.i};
$.g.iS=function(a){return $.n(a)?(a=$.P(a,this.f),this.f!=a&&((0,window.isNaN)(this.o)&&(this.o=this.f),this.f=a,this.B(2176,1)),this):this.f};$.g.Jz=function(a,b){ET(this);a=$.P(a,window.NaN,!0);b=$.P(b,window.NaN,!0);return this.b[a*this.f+b]||null};$.g.En=function(a){ET(this);a=$.P(a,window.NaN,!0);if((0,window.isNaN)(a)||a>=this.i)return null;this.Tn||(this.Tn=[]);a in this.Tn||(this.Tn[a]=new CT(this,a));return this.Tn[a]};
$.g.A_=function(a){ET(this);a=$.P(a,window.NaN,!0);if((0,window.isNaN)(a)||a>=this.f)return null;this.sn||(this.sn=[]);a in this.sn||(this.sn[a]=new BT(this,a));return this.sn[a]};$.g.Zja=function(a){return $.n(a)?(this.GK!=a&&(this.GK=a,this.B(64,1)),this):this.GK};$.g.aka=function(a){return $.n(a)?(this.FL!=a&&(this.FL=a,this.B(64,1)),this):this.FL};$.g.$ja=function(a){return $.n(a)?(this.EL!=a&&(this.EL=a,this.B(64,1)),this):this.EL};
$.g.Ida=function(a){return $.n(a)?(this.AL!=a&&(this.AL=a,this.B(64,1)),this):this.AL};$.g.Hda=function(a){return $.n(a)?(this.zL!=a&&(this.zL=a,this.B(64,1)),this):this.zL};$.g.Gda=function(a){return $.n(a)?(this.yL!=a&&(this.yL=a,this.B(64,1)),this):this.yL};$.g.pca=function(a,b,c,d,e){if($.n(a)){null===a||(a=$.Zb.apply(null,arguments));this.ka();this.nb("border",a,256);for(var f=0;4>f;f++)this.nb(wT[f],null,256);this.da(!0);return this}return this.y_||(this.y_=new xT(this,!1))};
...
$.g.W=function(){if(!this.zc())return this;this.wb||(this.wb=$.pk(),$.su(this,this.wb),this.KF=this.wb.Bd());var a=this.wb.Ja(),b=a&&!a.xf();b&&a.suspend();this.J(4)&&(this.B(64),($.zo(this.left())||$.zo(this.top()))&&this.B(1792),this.I(4));this.rh&&this.rh.ka();ET(this);Kga(this);if(this.J(128)){var c,d;for(c=0;c<this.b.length;c++)this.b[c].b=window.NaN;for(var e=0;e<this.i;e++)for(var f=0;f<this.f;f++){var h=e*this.f+f,k=this.b[h];if((0,window.isNaN)(k.b)&&(1<k.Ex()||1<k.Fx())){for(c=Math.min(this.i,
...
GT(this,0,m,1,l.Ex(),Lga(this,void 0,l),0);for(p=0;p<this.i;p++)l=this.b[p*this.f],(0,window.isNaN)(l.b)&&GT(this,p,0,l.Fx(),1,Mga(this,void 0,l),3);for(p=0;p<this.i;p++)for(m=0;m<this.f;m++)d=p*this.f+m,l=this.b[d],(c=this.b[d+this.f])?(0,window.isNaN)(l.b)?(0,window.isNaN)(c.b)||(c.b==d?l=c=void 0:c=this.b[c.b]):(0,window.isNaN)(c.b)?l=this.b[l.b]:l.b==c.b?l=c=void 0:(l=this.b[l.b],c=this.b[c.b]):(0,window.isNaN)(l.b)||(l=this.b[l.b]),GT(this,p,m,1,1,Lga(this,l,c),2),d=p*this.f+m,l=this.b[d],(c=
m+1==this.f?void 0:this.b[d+1])?(0,window.isNaN)(l.b)?(0,window.isNaN)(c.b)||(c.b==d?l=c=void 0:c=this.b[c.b]):(0,window.isNaN)(c.b)?l=this.b[l.b]:l.b==c.b?l=c=void 0:(l=this.b[l.b],c=this.b[c.b]):(0,window.isNaN)(l.b)||(l=this.b[l.b]),GT(this,p,m,1,1,Mga(this,l,c),1);this.I(256)}if(this.J(1024)){if(this.NC)for(;this.NC.length;){var q=this.NC.pop();$.J(q,$.kg)?q.remove():(q.ka(),$.J(q,$.Uu)?(f=q,$.$u(f)&&$.$u(f).clear(f.ma())):$.J(q,$.fy)?(d=q,$.gy(d)&&$.gy(d).clear(d.ma())):$.J(q,$.Y)&&(q.lu&&q.lu()&&
(d=q,d.Nz(d.x4)),q.O(null),q.remove()),$.nr(q,this.JU),q.da(!1))}p=this.i*this.f;for(m=0;m<p;m++)d=this.b[m],!(0,window.isNaN)(d.b)&&(q=d.hi)&&($.J(q,$.Jg)?(q.Fi(),$.pd(q)):(q.ka(),$.nr(q,this.JU),$.J(q,$.Uu)||$.J(q,$.fy)?q.enabled(!1):q.lu&&q.lu()&&(d=q,d.Nz(d.x4)),q.O(null),q.remove(),q.da(!1)));p=new $.Iu;p.ka();for(m=0;m<this.i;m++)for(l=0;l<this.f;l++)if(d=this.b[m*this.f+l],q=d.hi,c=$.J(q,$.kg),q){e=this.Tn&&this.Tn[m];h=this.sn&&this.sn[l];c||q.ka();if((0,window.isNaN)(d.b)){var r=FT(this,
m,l,d.Fx(),d.Ex(),r);p.top(this.EM("topPadding",d,e,h,this));p.right(this.EM("rightPadding",d,e,h,this));p.bottom(this.EM("bottomPadding",d,e,h,this));p.left(this.EM("leftPadding",d,e,h,this));r=p.Dj(r);if(c){q.parent(this.KF);f=q.xd(0);var t=HT(this,"hAlign",d,e,h,"start");k=HT(this,"vAlign",d,e,h,"top");"start"==t?t="rtl"==HT(this,"textDirection",d,e,h,"rtl")?"right":"left":"end"==t&&(t="rtl"==HT(this,"textDirection",d,e,h,"rtl")?"left":"right");switch(t){case "right":d=r.left+r.width-f.NT();break;
case "center":d=r.left+(r.width-f.NT())/2;break;default:d=r.left}switch(k){case "bottom":e=r.top+r.height-f.MT();break;case "middle":e=r.top+(r.height-f.MT())/2;break;default:e=r.top}f.setPosition(d,e);q.clip(r)}else{q.O(this.KF);if($.J(q,$.Uu))if(f=q,f.jc({value:{x:r.left,y:r.top}}),$.$u(f)==this.rh){f.anchor("left-top");f.width(r.width);f.height(r.height);(q=h&&h.o)&&f.N(q);(q=e&&e.o)&&f.N(q);(q=d.o)&&f.N(q);f.da(!1);continue}else e=f.g("position")||$.av(f)&&$.av(f).g("position")||$.$u(f)&&$.$u(f).g("position"),
e={value:$.Jo(r,e)},f.jc(e),f.W();else $.J(q,$.fy)?(d=q,e=d.g("position")||$.hy(d)&&$.hy(d).g("position")||$.gy(d)&&$.gy(d).g("position"),e={value:$.Jo(r,e)},d.jc(e),d.W()):$.J(q,$.Y)&&(q.lu&&q.lu()&&(d=q,d.x4=d.Nz(),d.Nz(!1)),d=q,d.ja(r),d.W&&d.W());$.K(q,this.JU)}}c||q.da(!1)}p.da(!1);this.rh&&(this.rh.ka(),this.rh.N(this.D),this.rh.O(this.KF),this.rh.ja(this.pb()),this.rh.W(),this.rh.da(!1));this.I(1024)}this.rh&&this.rh.da(!1);this.J(8)&&(this.wb.zIndex(this.zIndex()),this.I(8));this.J(2)&&(this.wb.parent(this.O()),
...
DT.prototype.contextMenu=function(a){!this.qk&&(this.qk=$.hq.ui.contextMenu(!0))&&(this.qk.itemsProvider(this.nS),this.qk.attach(this));return $.n(a)?(this.qk&&this.qk.setup(a),this):this.qk};DT.prototype.nS=function(a){var b={};$.hq.exports&&$.Uc(b,$.Tl(QT.exporting));$.Uj()&&a.menuParent&&$.Uc(b,$.Tl(QT[a.menuParent.fullScreen()?"full-screen-exit":"full-screen-enter"]));$.Uc(b,$.Tl(QT.main));return a.menuParent.ix(b,a)};DT.prototype.ix=function(a){return a};
...
iconClass:"ac ac-cog",text:"AnyChart "+$.ic.apply(null,["v%s.%s.%s.%s"].concat(["8","12","1","1937"])),href:"https://anychart.com"},"link-to-help":{index:110,iconClass:"ac ac-question",text:"Need help? Go to support center!",href:"https://anychart.com/support"},"version-history":{index:120,text:"Version History",href:""}},QT={exporting:{"save-table-as":RT["save-table-as"],"save-data-as":RT["save-data-as"],"share-with":RT["share-with"],"print-table":RT["print-table"],"exporting-separator":{index:51}},
"full-screen-enter":{"full-screen-enter":RT["full-screen-enter"],"full-screen-separator":{index:61}},"full-screen-exit":{"full-screen-exit":RT["full-screen-exit"],"full-screen-separator":{index:61}},main:{about:RT.about}};DT.prototype.oO=function(a){return a};DT.prototype.fullScreen=function(a){var b=this.O();b=b?b.Ja():null;return $.n(a)?(b&&b.fullScreen(a),this):b?b.fullScreen():!1};DT.prototype.Jy=function(){var a=this.O();return(a=a?a.Ja():null)?a.Jy():!1};var ST=DT.prototype;ST.rowsCount=ST.pX;
ST.colsCount=ST.iS;ST.getCell=ST.Jz;ST.getRow=ST.En;ST.getCol=ST.A_;ST.rowsHeight=ST.Zja;ST.rowsMinHeight=ST.aka;ST.rowsMaxHeight=ST.$ja;ST.colsWidth=ST.Ida;ST.colsMinWidth=ST.Hda;ST.colsMaxWidth=ST.Gda;ST.border=ST.pca;ST.contents=ST.Pda;ST.contextMenu=ST.contextMenu;ST.draw=ST.W;ST.fullScreen=ST.fullScreen;ST.isFullScreenAvailable=ST.Jy;ST.fontSize=ST.fontSize;ST.fontFamily=ST.fontFamily;ST.fontColor=ST.tca;ST.fontOpacity=ST.vca;ST.fontDecoration=ST.uca;ST.fontStyle=ST.fontStyle;
...
ST.draw=ST.W;$.E("anychart.standalones.table",function(a,b){return new IT(a,b)});}).call(this,$)}
