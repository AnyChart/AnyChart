...
if(!_.scatter){_.scatter=1;(function($){var X$=function(){$.Sx.call(this,!1);this.ib("scatter");this.ca.defaultSeriesType="marker";this.Kd="scatter"},Y$=function(a){var b=new X$;b.mi();b.sf();for(var c=0,d=arguments.length;c<d;c++)b.marker(arguments[c]);return b},qia=function(a){var b=new X$;b.ib("marker");b.mi();b.sf();for(var c=0,d=arguments.length;c<d;c++)b.marker(arguments[c]);return b},ria=function(a){var b=new X$;b.ib("bubble");b.mi();b.sf();for(var c=0,d=arguments.length;c<d;c++)b.bubble(arguments[c]);return b},sia=function(a){var b=
new X$;b.ib("quadrant");b.Kd="quadrant";b.mi();b.sf();for(var c=0,d=arguments.length;c<d;c++)b.marker(arguments[c]);return b},tia={qM:"bubble",Qr:"line",yt:"marker"};$.I(X$,$.Sx);var Z$={},uia=$.Jy|7864320;Z$.bubble={xb:4,Db:2,Ib:[$.OD,$.PD,$.SD,$.UD],Hb:null,zb:null,sb:uia,vb:"value",ub:"value"};Z$.line={xb:8,Db:1,Ib:[$.JD,$.bE,$.XD,$.RD],Hb:null,zb:null,sb:uia,vb:"value",ub:"value"};Z$.marker={xb:9,Db:2,Ib:[$.lE,$.LD,$.TD,$.eE,$.VD,$.ZD,$.$D,$.dE],Hb:null,zb:null,sb:$.Jy|3670016,vb:"value",ub:"value"};
X$.prototype.Ei=Z$;$.ax(X$,X$.prototype.Ei);X$.prototype.Bt=function(){return!1};X$.prototype.Ut=function(a,b){return new $.Iy(this,this,a,b,!1)};X$.prototype.ur=function(a){return $.cj(tia,a,"line")};X$.prototype.F=function(){return{chart:X$.B.F.call(this)}};var $$=X$.prototype;$$.crosshair=$$.kg;$$.xScale=$$.Ra;$$.yScale=$$.Xa;$$.xGrid=$$.An;$$.yGrid=$$.Cn;$$.xMinorGrid=$$.ro;$$.yMinorGrid=$$.uo;$$.xAxis=$$.Hh;$$.yAxis=$$.Ki;$$.getSeries=$$.Te;$$.lineMarker=$$.Gm;$$.rangeMarker=$$.Nm;
$$.textMarker=$$.Tm;$$.palette=$$.Yb;$$.markerPalette=$$.ef;$$.hatchFillPalette=$$.Sd;$$.getType=$$.Qa;$$.addSeries=$$.Gk;$$.getSeriesAt=$$.Sh;$$.getSeriesCount=$$.Sl;$$.removeSeries=$$.lo;$$.removeSeriesAt=$$.tn;$$.removeAllSeries=$$.lp;$$.getPlotBounds=$$.Ff;$$.annotations=$$.Ej;$$.getXScales=$$.ww;$$.getYScales=$$.xw;$$.quarters=$$.PK;$$.crossing=$$.VH;$.no.bubble=ria;$.no.marker=qia;$.no.quadrant=sia;$.no.scatter=Y$;$.H("anychart.bubble",ria);$.H("anychart.scatter",Y$);$.H("anychart.marker",qia);$.H("anychart.quadrant",sia);$.H("anychart.scatterChart",Y$);}).call(this,$)}
