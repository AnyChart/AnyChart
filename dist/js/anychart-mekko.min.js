...
$.g.Bc=function(){var a=this.X(196608);this.X(458752)&&this.D(268435456);uI.J.Bc.call(this);if(a){for(var b,c,d=[],e=[],f=this.Ca.length,h,a=0;a<this.Ca.length;a++)for(c=this.Ca[a].data,b=0;b<c.length;b++)$.n(e[b])||(e[b]=0),c[b].G.missing?(e[b]++,h=0):(h=$.P(c[b].data.value),h=this.ia?Math.abs(h):0>h?0:h),void 0==d[b]?d.push(h):d[b]+=h;for(a=0;a<this.Ca.length;a++)for(c=this.Ca[a].data,b=h=0;b<c.length;b++)c[b].G.category=e[b]<f?h++:h;d=(0,$.Ee)(d,function(a,b){return e[b]<f});sI(this.Ra(),d)}this.X(268435456)&&
(Sda(this),this.W(268435456))};var CI={};$.R(CI,0,"pointsPadding",$.Do);$.Ho(uI,CI);$.g=uI.prototype;$.g.tp=function(a,b){return new tI(this,this,a,b,!1,this.ia)};$.g.sn=function(){return"mekko"};$.g.rD=function(){return 3};$.g.O=function(){var a=uI.J.O.call(this);a.type=this.Xa();$.To(this,CI,a);return{chart:a}};$.g.An=function(a,b,c){$.Wv(a,"firstCategoriesScale",this.OD(),b,c);$.Wv(a,"lastCategoriesScale",this.VE(),b,c);uI.J.An.call(this,a,b,c)};
