...
u;l=h-v;r=k>l;q=p=q;m=Number.MAX_VALUE}else{for(m=p;m<=q;m++)w=a[m],w.width=1>w.SJ?1:$.Wm(w.SJ,4),w.height=1>w.BH?1:$.Wm(w.BH,4);m=t;q++}h=f=0;for(m=p;m<q;m++)w=a[m],w.x=d+u+f,w.y=e+v+h,r?h+=w.height:f+=w.width;for(m=0;m<c;m++)w=a[m],b[m].o("treemap_pointBounds",$.nn(w.x,w.y,w.width,w.height))},Psa=function(a,b,c,d,e,f){var h=0,k;for(k=d;k<=e;k++)h+=a[k].BY;f?(b=c/h,c=h/c):(c=b/h,b=h/b);for(k=d;k<=e;k++)d=a[k],f?(d.BH=b*d.BY,d.SJ=c):(d.SJ=c*d.BY,d.BH=b);d=a[e];return Math.max(d.BH/d.SJ,d.SJ/d.BH)},
T7=function(a){$.J(a,$.au)&&(a=a.Sk);return a==a.Pq().xd(0)},Rsa=function(a,b){var c=a.$().f,d=c.o("treemap_pointBounds"),e=c.o(U7);if(0==e||2==e){var f=!!(b&$.Bo);e=!f&&!!(b&$.Ao);var h=a.Qa().Db(),k=a.lb().Db(),l=a.selected().Db();var m=f?l:e?k:h;var p=c.get("normal");p=$.n(p)?p.marker:void 0;var q=c.get("hovered");q=$.n(q)?q.marker:void 0;var r=c.get("selected");r=$.n(r)?r.marker:void 0;p=$.cp(p,c.get("marker"));q=$.cp(q,c.get("hoverMarker"));r=$.cp(r,c.get("selectMarker"));var t=c.o("markerIndex");
...
h-f.left;p=$.R(f.width,r);l=p-f.width;q=$.R(f.top,r);var t=q-f.top;r=$.R(f.height,r);var u=r-f.height;f.left=h;f.width=p-m-l;f.top=q;f.height=r-t-u;c.Pf(f);if(a.ca.g("hatchFill")||a.za.g("hatchFill")||a.Ea.g("hatchFill"))f=$.iC(a.j),f.oe(c.F()),d.o("treemap_hatchShape",f),Usa(a,b);4!=e&&a.nC(c);4!=k&&(a.ke(b),Rsa(a,b))}}},Wsa=function(a,b,c){var d=a.g("maxDepth"),e=a.g("hintDepth");if(!(c>d+e)){var f;d=b.bc();e=a.g("maxDepth");var h=a.g("hintDepth");d?c<e?f=1:c==e?f=h?2:0:c>e&&(f=c==e+h?4:3):f=c<=
...
$.g.nk=function(a,b){var c=this.$().f;if($.n(c)&&!c.o(R7))if(1==c.o(U7))this.ke(a);else return c.o(V7)&&(Tsa(this,a),Usa(this,a)),this.ke(a),Rsa(this,a),b};
...
a&&(c=a.markerIndex,c=$.n(c)&&this.G?this.G[c]:null);c=$.N(c);a.pointIndex=c;return{type:b,actualTarget:a.target,series:this,pointIndex:c,target:this,originalEvent:a,point:this.be(c)}};$.g.ML=function(a,b){a=$.A(a)&&a.length?a[0]:a;if(this.Mb&&this.Mb.target()){var c=this.Mb.target();c==b&&(c=c.$(),c.select(a),c=c.o(S7),$.dO(this.Mb,c))}};$.g.gA=function(){this.Mb&&this.Mb.enabled()&&$.eO(this.Mb)};$.g.$q=function(a){return $.J(a,$.ZN)};
$.g.HK=function(a,b){b=b||{target:this};var c=$.gD(this,a);c={type:"drillchange",path:c,current:c[c.length-1]};this.ie();this.fm&&(this.dispatchEvent(this.al("selected",b,this.fm,!0)),this.fm=null);this.dispatchEvent(c)&&this.FE(a)};
$.g.Rj=function(a){if(a.button==$.Qi&&!$.J(a.target,$.Xw)&&!this.$q(a.target)){var b=$.xo(a.domTarget),c,d=$.J(a.target,$.Qu),e=$.J(a.target,$.dy);if(d||e){var f=a.target.Zi();f.aj&&f.aj()&&(c=f);if(d){var h=a.target===this.Qa().headers();h=this.D[(h?"h":"l")+b]}else e&&(h=this.G[b])}else c=b&&b.X,h=$.ea(b.index)?b.index:a.pointIndex;c&&!c.md&&c.enabled()&&$.E(c.Tg)&&(b=this.$(),b.select(h),b=b.f,b==this.b?T7(b)||this.HK(b.getParent()):b.bc()?this.HK(b):P7.u.Rj.call(this,a))}};
$.g.uA=function(){this.Rt();return this.b?$.gD(this,this.b):null};$.g.ie=function(a){if(this.enabled()){var b;$.n(a)?b=a:b=this.state.Gc==$.hm?window.NaN:void 0;this.state.Uh($.Bo,b)}};$.g.Tu=function(){return!0};$.g.$x=function(){this.Rt();this.b&&!T7(this.b)&&this.FE(this.b.getParent())};$.g.Ls=function(a){return"categories"==a};
$.g.wq=function(a,b){var c=a.o();if("categories"==this.eg().g("itemsSourceMode")){var d=c.X;var e=c.scale;if(e&&d){c=c.xe;for(var f=d.Ec(),h=[];f.advance();){var k=f.get(S7);c==e.Dn(k)&&h.push(f.ma())}if(e=$.xo(b.domTarget))"single"==this.gd().g("hoverMode")?e.fg={X:d,vd:h}:e.fg=[{X:d,vd:h,Ln:h[h.length-1],Ee:{index:h[h.length-1],Sf:0}}];this.Mb&&this.Mb.enabled()&&this.Mb.target()&&$.dO(this.Mb,(c.start+c.end)/2)}}};
$.g.vq=function(a,b){var c=a.o();if("categories"==this.eg().g("itemsSourceMode")){if("single"==this.gd().g("hoverMode")){var d=$.xo(b.domTarget);d&&(d.X=c.X)}this.Mb&&this.Mb.enabled()&&this.Mb.target()&&$.eO(this.Mb)}};
$.g.Ml=function(a){var b,c=[];this.ob();if("categories"==a){var d=this.kd();if(d&&$.J(d,$.iz)){var e=d.sr();a=0;for(b=e.length;a<b;a++){var f=e[a];"default"!==f.name&&c.push({text:f.name,iconEnabled:!0,iconType:"square",iconFill:f.color,disabled:!this.enabled(),sourceUid:$.oa(this),sourceKey:a,meta:{X:this,scale:d,xe:f}})}}}return c};$.g.xc=function(){return this};var Q7="treemap_size",S7="treemap_value",U7="treemap_type",R7="treemap_missing",V7="treemap_shape";$.g=P7.prototype;
...
$.g.Wp=function(a){$.X(a,6)&&this.B(8704,1)};$.g.Qi=function(a){this.Mb||(this.Mb=new $.ZN,this.Mb.ef(),this.Mb.kb(this),$.L(this.Mb,this.Sz,this),this.B(32772,1));return $.n(a)?(this.Mb.N(a),this):this.Mb};$.g.Sz=function(a){var b=0,c=0;$.X(a,1)&&(b|=32784,c|=1);$.X(a,8)&&(b|=4,c|=8);this.B(b,c)};
...
l.o("labelIndex",void 0)),k=null;if(k){l=$.Vu(k);(m=l.adjustByHeight||l.adjustByHeight)&&"same"==$.Pu(e)&&(h=$.kv(k,c.width,c.height,l.minFontSize,l.maxFontSize,l.adjustByWidth,l.adjustByHeight));m?$.VN(e,h):$.VN(e,null);l.width=null;l.height=null;if(l.adjustByWidth||l.adjustByHeight)l.fontSize=$.$u(k).Md.fontSize;h=e.measure(k.Gf(),k.jc(),l);h=!(c.left<=h.left&&c.cb()>=h.cb()&&c.top<=h.top&&c.Va()>=h.Va());d&&(k.width(c.width),k.height(c.height));h&&"drop"==f&&(e.clear(k.ma()),b.o("labelIndex",void 0),
...
$.g.ob=function(){this.Rt();this.b&&(this.J(16384)&&(this.P=[],this.i=[],this.Uc=[],Wsa(this,this.b,0),this.Ec(),this.I(16384),this.B(8192)),this.J(8192)&&(this.vb&&(this.vb.Nf()?(this.vb.Ag(),this.vb.Xc.apply(this.vb,this.P),this.vb.Hg()):(this.vb.Ao(),this.vb.Xc.apply(this.vb,this.P)),$.J(this.vb,$.iz)&&$.Qt(this.vb.Xa()),this.f.N(this.vb.F())),this.f&&(this.f.Nf()?(this.f.Ag(),this.f.Xc.apply(this.f,this.i),this.f.Hg()):(this.f.Ao(),this.f.Xc.apply(this.f,this.i))),this.B(16),this.I(8192)))};
...
new $.hC(function(){return $.nk()},$.ia),this.ue.clip(this.lf),this.ue.zIndex(30),this.ue.parent(this.Oa),b.headers().O(this.Oa).zIndex(41),b.headers().clip(this.lf),b.labels().O(this.Oa).zIndex(40),b.Db().O(this.Oa).zIndex(40)),this.j?this.j.clear():(this.j=new $.hC(function(){return $.nk()},$.ia),this.j.zIndex(31),this.j.parent(this.Oa),this.j.Dd(!0)),b.headers().clear(),b.labels().clear(),b.Db().clear(),Nsa(this),a=this.g("sort"),"desc"==a?this.sc=Lsa:"asc"==a&&(this.sc=Msa),Vsa(this,this.b,this.lf,
0),b.headers().W(),b.labels().W(),b.Db().W(),this.I(65552));if(this.J(65536)){b=this.$();for(b.reset();b.advance();)if(2==b.o(U7)&&(a=b.o(V7))){var c=$.dm("fill",1,!1)(this,$.hm,!1);c=$.Vl(c,this.g("hintOpacity"),!0);a.fill(c)}this.I(65536)}}};$.g.$y=function(){this.Ua().gr()&&this.B(4,9)};
$.g.ix=function(a,b){var c=$.xo(b.event.domTarget),d;$.J(b.target,$.Qu)||$.J(b.target,$.dy)?d=this.ba[c]:d=c.node;c={};var e=1==d.o(U7);!d.bc()||e&&d==this.b||(c["drill-down-to"]={index:7,text:"Drill down",eventType:"anychart.drillTo",action:(0,$.pa)(this.HK,this,d)});T7(this.b)||(c["drill-down-up"]={index:7,text:"Drill up",eventType:"anychart.drillUp",action:(0,$.pa)(this.HK,this,this.b.getParent())});$.Nc(c)||(c["drill-down-separator"]={index:7.1});$.Uc(c,$.Tl($.sG["select-marquee"]),a);return c};
...
X7.toCsv=X7.Zj;$.Wp["tree-map"]=Xsa;$.F("anychart.treeMap",Xsa);}).call(this,$)}
