...
$.g.GZ=function(a){var b=a.ia(),c=a.parent().path();if(c){var d=$.rk();d.oe($.Bg(c));a.i&&d.translate(a.lo,a.sm);a=c?$.th(this,d,!0):"m "+KS(a.x)+","+KS(a.y)+" l "+(KS(a.x)+1)+","+KS(a.y)+" e";b.setAttribute("path",a)}};
...
$.g.P_=function(a){var b=a.fill();$.J(b,$.Qb)&&(b="black");var c=a.stroke(),d;$.z(c)?d=c:d="keys"in c?0!=c.keys.length?c.keys[0].color:"#000":c.color;var e=!$.z(b)&&"keys"in b&&"cx"in b&&"cy"in b,f=!$.z(b)&&"keys"in b&&!e,h=!e&&!f,k="none"!=b&&"none"!=b.color,l="none"!=d&&0!=c.thickness,m=h&&k&&1!=b.opacity,p=!$.z(c)&&l&&(1!=c.opacity||"miter"!=c.lineJoin||"butt"!=c.lineCap||"none"!=c.dash);if(e||f||m||p){p=a.Ka();m=p.vn;var q=$.J(a,$.Cg)&&a.Tj()?new $.I(0,0,1,1):a.rb();if(f){var r=$.J(b.mode,$.I);
...
strokeweight:c.thickness?c.thickness+"px":"1px"})};$.g.Ji=function(a){var b=a.ia().style;this.lc(b,"visibility",a.visible()?"":"hidden")};$.g.zB=function(a){var b=a.ck(),c=a.Ig();if(c){var d;a.FB?d=a.FB:d=a.FB=this.f("skew");a.nJ||(a.ia().appendChild(d),a.nJ=!0);$.rh(this,d,{on:"true",origin:[-.5-b.left/b.width,-.5-b.top/b.height].join(),matrix:[CS(c.od),CS(c.hf),CS(c.We),CS(c.Me),0,0].join()});$.rh(this,a.ia().style,{left:JS(b.left+c.Nd),top:JS(b.top+c.Id)})}else a.nJ&&($.Ye(a.FB),a.nJ=!1)};
...
$.g.CX=function(a){var b=$.J(a,$.Jg),c=a.clip();if(c){c=c.shape();c=c.Wt(c.Sd);c=c.clone();var d=a.ia().style;if($.n(b)&&b)a=a.Ig(),c=$.zb(c,a);else if(!$.J(a,QS)||a.xr())c.left-=a.Eh()||0,c.top-=a.zs()||0;a=c.left;b=c.top;this.lc(d,"clip",["rect(",b+"px",a+c.width+"px",b+c.height+"px",a+"px",")"].join(" "))}else c=a.ia().style,LS(c,"clip")};$.g.vW=function(){return!0};$.H(NS,$.nd);$.g=NS.prototype;$.g.Tm=function(){return this.b};$.g.nA=null;$.g.AJ=null;$.g.zo=!1;$.g.Sm=function(){return"shape-type"};$.g.R=function(){delete this.b;delete this.i;$.Ye(this.nA);this.nA=null;$.Ye(this.AJ);this.AJ=null};$.H(OS,$.Lj);OS.prototype.clear=function(){$.Oc(this.f);$.Oc(this.G);OS.u.clear.call(this)};OS.prototype.f5=function(a){for(var b=$.Kj(a.keys,a.Dc,a.uc,a.b,a.f,a.opacity,a.Ua),c=$.Hc(this.f),d=0,e=c.length;d<e;d++){var f=c[d];f.Tm()==a&&Qfa(f)}$.Kc(this.G,b)&&$.Pc(this.G,b)};OS.prototype.lX=function(a){for(var b=$.Ij(a.keys,a.opacity,a.angle,a.mode),c=$.Hc(this.f),d=0,e=c.length;d<e;d++){var f=c[d];f.Tm()==a&&Qfa(f)}a=this.qu;$.Kc(a,b)&&$.Pc(a,b)};
...
$.g.Wt=function(a){this.Ia=this.xr();return QS.u.Wt.call(this,a)};$.g.Rd=function(){QS.u.Rd.call(this);if(RS(this)||this.textOverflow()){$.ng();var a=this.ia();HS&&this.ia()&&(a.innerHTML=a.innerHTML)}return this};$.g.mX=function(){$.lg(this,64)};$.g.HO=function(){this.Ia?QS.u.HO.call(this):($.ng().KX(this),$.lg(this,16384))};$.g.Ep=function(){this.Ia?QS.u.Ep.call(this):$.lg(this,32)};
...
$.g.pv=function(){var a=this.Ig();!a||this.Uf(256)||this.Uf(4)||(this.nf=a.clone())};$.g.Sy=function(){QS.u.Sy.call(this);Tfa(this)};$.g.Lr=function(){QS.u.Lr.call(this);Tfa(this);if(HS&&RS(this)){var a=!this.Ka()||this.Ka().xf();a||this.Ka().suspend();this.ba=!1;this.Pb(1024);this.Pb(32);this.Pb(16384);this.Pb(4);this.qx();a||this.Ka().resume()}};$.g.R=function(){delete this.nf;QS.u.R.call(this)};var SS=QS.prototype;SS.color=SS.color;SS.opacity=SS.opacity;SS.textOverflow=SS.textOverflow;
