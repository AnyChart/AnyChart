(function() {
    function y() {
        for (var a = this.chart, b = m.call(this), f = a.getSeriesCount(), d = {}, g = 0; g < f; g++) {
    ...
    window.anychart.themes.defaultTheme = {
                    ...
                    labels: {
                        ...
                        textFormatter: function() {
                            return this.getDataValue("name") ? this.getDataValue("name") :
                                this.name ? this.name : this.getDataValue("id") ? this.getDataValue("id") : "lat: " + this.lat + "\nlong: " + this["long"]
                        }
                    },
                    hoverLabels: {
                        enabled: null
        ...
        treeMap: {
            ...
            fill: function() {
                return this.colorScale ? this.colorScale.valueToColor(this.value) :
                    window.anychart.color.setOpacity(this.sourceColor, .85, !0)
            },
            stroke: "#e0e0e0",
            hoverFill: k,
            hoverStroke: c,
