            ...
            defaultSeriesSettings: {
                base: {
                    fill: function() {
                        var a;
                        this.colorScale ?
                            (a = this.iterator.get(this.referenceValueNames[1]), a = this.colorScale.valueToColor(a)) : a = this.sourceColor;
                        return a
                    },
                    hoverFill: function() {
                        return window.anychart.color.lighten(this.sourceColor)
                ...
                copyFormatter: function(a) {
                    ...
                    for (var b = "", c = 0, d = a.length; c < d; c++) {
                        ...
                        if (0 != g.points.length) {
                            for (var b = b + ("Series " + g.series.index() + ":\n"), h = 0, e = g.points.length; h < e; h++) {
                                var f = g.points[h],
                                    b = b + ("id: " + f.id + " index: " + f.index);
                                h != e - 1 && (b += "\n")
                            }
                            c != d - 1 && (b += "\n")
                        }
