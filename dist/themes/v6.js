(function() {
    function r() {
        for (var b = this.chart, c = h.call(this), e = b.getSeriesCount(), d = {}, f = 0; f < e; f++) {
            var g = b.getSeriesAt(f).getType();
            d.hasOwnProperty(g) ? d[g] += 1 : d[g] = 1
        }
        var c = c + ", with ",
            k;
        for (k in d) c += d[k] + " " + k + " series, ";
        c += ". ";
        d = b.yScale();
        b = b.xScale();
        e = b.getType();
        ...
        if ("ordinal" == f) {
            ...
            c += ". "
        } else c = "dateTime" == f ? c + ("Y-scale minimum value is " + a.anychart.format.dateTime(d.minimum()) + " , maximum value is " +
            a.anychart.format.dateTime(d.maximum()) + ". ") : c + ("Y-scale minimum value is " + d.minimum() + " , maximum value is " + d.maximum() + ". ");
        if ("ordinal" == e) {
            b = b.values();
            c += "X-scale with " + b.length + " categories: ";
            for (e = 0; e < b.length; e++) c += b[e] + ", ";
            c += ". "
        } else c = "dateTime" == e ? c + ("X-scale minimum value is " + a.anychart.format.dateTime(b.minimum()) + " , maximum value is " + a.anychart.format.dateTime(b.maximum()) + ". ") : c + ("X-scale minimum value is " + b.minimum() + " , maximum value is " + b.maximum() + ". ");
        return c
    }
    ...
    function h() {
        var a = this.chart,
            c = a.title(),
            c = c && c.enabled() && c.text() ? c.text() : "";
        return (a.getType() || "Anychart ") + " chart " + (c ? " entitled " + c : "")
    }
    ...
    function l() {
        return a.anychart.color.setOpacity(this.sourceColor, .85, !0)
    }
    ...
    a.anychart.themes.v6 = {
        ...
        defaultOrdinalColorScale: {
            autoColors: function(b) {
                return a.anychart.color.blendedHueProgression("#ffd54f", "#ef6c00", b)
            }
        },
        ...
        cartesianBase: {
            defaultSeriesSettings: {
                base: {
                    ...
                    selectStroke: function() {
                        return a.anychart.color.darken("red")
                    },
                    hatchFill: !1,
                    labels: {
                        enabled: !1,
                ...
                box: {
                    ...
                    fill: function() {
                        return a.anychart.color.lighten(a.anychart.color.lighten(this.sourceColor))
                    },
                ...
                bubble: {
                    ...
                    negativeFill: function() {
                        return a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(this.sourceColor)))
                    },
                    hoverNegativeFill: function() {
                        return a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(this.sourceColor))))
                    },
                    negativeStroke: function() {
                        return a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(this.sourceColor))))
                    },
                    hoverNegativeStroke: function() {
                        return a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(a.anychart.color.darken(this.sourceColor)))))
                    },
                ...
                candlestick: {
                    ...
                    selectRisingFill: function() {
                        return a.anychart.color.lighten(a.anychart.color.lighten("red"))
                    },
                    fallingFill: function() {
                        return a.anychart.color.darken(this.sourceColor)
                    },
                    hoverFallingFill: function() {
                        return a.anychart.color.darken(a.anychart.color.darken(this.sourceColor))
                    },
                    selectFallingFill: function() {
                        return a.anychart.color.darken(a.anychart.color.darken("blue"))
                    },
                    ...
                    selectRisingStroke: function() {
                        return a.anychart.color.lighten("red")
                    },
            ...
            a11y: {
                titleFormatter: function() {
                    for (var b = this.chart, c = h.call(this), e = b.getSeriesCount(), d = {}, f = 0; f < e; f++) {
                        var g = b.getSeriesAt(f).seriesType();
                        d.hasOwnProperty(g) ? d[g] += 1 : d[g] = 1
                    }
                    var c = c + ", with ",
                        k;
                ...
                labels: {
                    textFormatter: function() {
                        var a = new Date(this.tickValue),
                            c = [" ", a.getUTCDate(), ", ", a.getUTCFullYear()].join("");
        ...
        heatMap: {
            ...
            stroke: function() {
                var b;
                this.colorScale ? (b = this.iterator.get("heat"), b = this.colorScale.valueToColor(b)) : b = this.sourceColor;
        ...
        pie: {
            ...
            stroke: function() {
                return a.anychart.color.darken(this.sourceColor, .2)
            },
            hoverStroke: function() {
                return a.anychart.color.darken(this.sourceColor)
            },
            ...
            a11y: {
                titleFormatter: function() {
                    var a = this.chart,
                        c = h.apply(this),
                        c = c + (", with " + a.getStat("count") + " points. ");
                    return c += "Min value is " + a.getStat("min") + ", max value is " + a.getStat("max") + "."
                }
            }
        },
        cartesian3d: {
        ...
        linearGauge: {
            ...
            defaultPointerSettings: {
                ...
                thermometer: {
                    fill: function() {
                        var b = this.sourceColor,
                            c = a.anychart.color.darken(b);
                        return {
                ...
                led: {
                    dimmer: function(b) {
                        return a.anychart.color.darken(b)
                    },
                    gap: "1%",
                    size: "2%",
                    count: null,
        ...
        map: {
            ...
            defaultSeriesSettings: {
                ...
                bubble: {
                    ...
                    displayNegative: !1,
                    fill: function() {
                        return a.anychart.color.setOpacity(this.sourceColor,
                            .7, !0)
                    },
                    hoverFill: function() {
                        return a.anychart.color.setOpacity(this.sourceColor, .7, !0)
                    },
                    stroke: function() {
                        return a.anychart.color.setThickness(this.sourceColor, 1.5)
                    },
                    ...
                    tooltip: {
                        ...
                        textFormatter: function() {
                            return "Value: " +
                                this.valuePrefix + this.size + this.valuePostfix
                        }
                    }
                },
                marker: {
            ...
            interactivity: {
                copyFormatter: function(a) {
                    ...
                    for (var b = "", e = 0, d = a.length; e < d; e++) {
                        var f = a[e];
                        if (f.points.length) {
                            for (var b = b + ("Series " + f.series.index() + ":\n"), g = 0, k = f.points.length; g < k; g++) {
                                var h = f.points[g],
        ...
        ganttProject: {
            dataGrid: {
                tooltip: {
                    ...
                    textFormatter: function() {
                        var b = this.actualStart || this.autoStart,
                ...
                tooltip: {
                    ...
                    textFormatter: function() {
                        var b = this.actualStart || this.autoStart,
                            ...
                            e = this.progressValue;
                        void 0 === e && (e = (Math.round(1E4 * this.autoProgress) / 100 || 0) + "%");
                        return (b ? "Start Date: " + a.anychart.format.dateTime(b) : "") + (c ? "\nEnd Date: " + a.anychart.format.dateTime(c) : "") + (e ? "\nComplete: " + e : "")
                    }
                }
            }
        },
            ...
            defaultPlotSettings: {
                ...
                xAxis: {
                    ...
                    labels: {
                        ...
                        anchor: "centerTop",
                        textFormatter: function() {
                            var b = this.tickValue;
                            switch (this.majorIntervalUnit) {
                                case "year":
                                    return a.anychart.format.dateTime(b, "yyyy");
                                case "semester":
                                case "quarter":
                                case "month":
                                    return a.anychart.format.dateTime(b, "yyyy MMM");
                                case "thirdOfMonth":
                                case "week":
                                case "day":
                                    return a.anychart.format.dateTime(b, "MMM dd");
                                case "hour":
                                    return a.anychart.format.dateTime(b, "MMM-dd HH");
                                case "minute":
                                    return a.anychart.format.dateTime(b, "dd HH:mm");
                                case "second":
                                    return a.anychart.format.dateTime(b,
                                        "HH:mm:ss");
                                case "millisecond":
                                    return a.anychart.format.dateTime(b, "HH:mm:ss.SSS")
                            }
                            return a.anychart.format.dateTime(b, "yyyy MMM dd")
                        }
                    },
                    minorLabels: {
                        enabled: !0,
                        ...
                        textFormatter: function() {
                            ...
                            switch (this.majorIntervalUnit) {
                                ...
                                case "quarter":
                                case "month":
                                    return a.anychart.format.dateTime(b, "MMM");
                                case "thirdOfMonth":
                                case "week":
                                case "day":
                                    return a.anychart.format.dateTime(b,
                                        "dd");
                                case "hour":
                                    return a.anychart.format.dateTime(b, "HH");
                                case "minute":
                                    return a.anychart.format.dateTime(b, "HH:mm");
                                case "second":
                                    return a.anychart.format.dateTime(b, "HH:mm:ss");
                                case "millisecond":
                                    return a.anychart.format.dateTime(b, "SSS")
                            }
                            return a.anychart.format.dateTime(b, "HH:mm:ss.SSS")
                        }
                    }
                ...
                legend: {
                    ...
                    titleFormatter: function() {
                        ...
                        switch (this.dataIntervalUnit) {
                            ...
                            case "quarter":
                            case "month":
                                return a.anychart.format.dateTime(b, "MMM yyyy");
                            case "hour":
                            case "minute":
                                return a.anychart.format.dateTime(b, "HH:mm, dd MMM");
                            case "second":
                                return a.anychart.format.dateTime(b, "HH:mm:ss");
                            case "millisecond":
                                return a.anychart.format.dateTime(b,
                        ...
                        return a.anychart.format.dateTime(b, "dd MMM yyyy")
                    },
                    align: "center",
                    margin: {
                        top: 0,
                    ...
                    minorLabels: {
                        ...
                        textFormatter: function() {
                            ...
                            switch (this.majorIntervalUnit) {
                                ...
                                case "week":
                                case "day":
                                    return a.anychart.format.dateTime(b, "dd");
                                case "hour":
                                    return a.anychart.format.dateTime(b, "HH");
                                case "minute":
                                    return a.anychart.format.dateTime(b, "HH:mm");
                ...
                tooltip: {
                    ...
                    textFormatter: function() {
                        ...
                        if (this.successors && this.successors.length) {
                            a += "Successors:";
                            for (c = 0; c < this.successors.length; c++) a +=
                                "\n - " + this.successors[c].get("name");
                            this.predecessors && this.predecessors.length && (a += "\n\n")
                        }
                        if (this.predecessors && this.predecessors.length)
                            for (a += "Predecessors:", c = 0; c < this.predecessors.length; c++) a += "\n - " + this.predecessors[c].get("name");
                        return a
                    }
                }
            },
                ...
                tasks: {
                    ...
                    tooltip: {
                        ...
                        textFormatter: function() {
                            var a = "Earliest start: " + this.earliestStart + "\nEarliest finish: " + this.earliestFinish + "\nLatest start: " + this.latestStart + "\nLatest finish: " + this.latestFinish + "\nDuration: " + this.duration + "\nSlack: " + this.slack;
                            isNaN(this.variance) || (a += "\nStandard deviation: " +
                                Math.round(100 * this.variance) / 100);
                            return a
                        }
                    }
                }
