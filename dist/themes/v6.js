...
window.anychart.themes.v6 = {
  ...
  defaultMarkerFactory: {
    size: 10, position: "center", anchor: "center", offsetX: 0, offsetY: 0,
    rotation: 0, positionFormatter: function() {
      return this.value
    }
  },
  defaultTooltip: {
    ...
    separator: {
      enabled: !1, width: "100%", height: 1, margin: {top: 0, right: 5, bottom: 0, left: 5}, orientation: "top", fill: ["0 #333333 0", "0.5 #333333 1",
        "1 #333333 0"], stroke: "none", zIndex: 1
    },
    content: {
      enabled: !0,
      fontSize: 10,
    ...
    adjustFontSize: {width: !1, height: !1},
    rotation: 0,
    background: {enabled: !0, fill: ["0 #fff 1", "0.5 #f3f3f3 1", "1 #fff 1"], stroke: ["0 #ddd 1", "1 #d0d0d0 1"], cornerType: "none", corners: 10, zIndex: 0},
  ...
  defaultAxis: {
    ...
    title: {text: "Axis title", margin: {top: 10, right: 5, bottom: 10, left: 5}, background: {enabled: !1, stroke: {keys: ["#ddd", "#d0d0d0"], angle: "90"}, fill: {keys: ["#fff", "#f3f3f3", "#fff"], angle: "90"}}, zIndex: 35},
    labels: {
      enabled: !0,
      rotation: 0,
      offsetX: 0,
    ...
    minorLabels: {
      minFontSize: 8, maxFontSize: 72, enabled: !1, rotation: 0, offsetX: 0, offsetY: 0, anchor: "center", padding: {top: 1, right: 1, bottom: 0, left: 1}, fontFamily: "Tahoma",
      fontSize: 11, textWrap: "noWrap", background: {enabled: !1, stroke: {keys: ["#ddd", "#d0d0d0"], angle: "90"}, fill: {keys: ["#fff", "#f3f3f3", "#fff"], angle: "90"}}, textFormatter: function() {
        return this.value
      }, positionFormatter: function() {
        return this.value
      }, zIndex: 35
    },
    ticks: {enabled: !0, length: 5, position: "outside", stroke: {color: "#313131", lineJoin: "round", lineCap: "butt"}, zIndex: 35},
    minorTicks: {enabled: !1, length: 2, position: "outside", stroke: {color: "#313131", lineJoin: "round", lineCap: "butt"}, zIndex: 35},
    zIndex: 35
  },
  chart: {
    enabled: !0,
    title: {text: "Chart Title", margin: {bottom: 15}, zIndex: 80},
    background: {enabled: !0, fill: ["#fff", "#f3f3f3", "#fff"], stroke: "none", zIndex: 1},
    ...
    legend: {
      ...
      titleSeparator: {
        ...
        }, orientation: "top", fill: ["#000 0", "#000", "#000 0"], stroke: "none"
      },
      paginator: {
        enabled: !0,
        background: {enabled: !1, fill: {keys: ["#fff", "#f3f3f3", "#fff"], angle: "90"}, stroke: {keys: ["#ddd", "#d0d0d0"], angle: "90"}},
    ...
    credits: {
      enabled: !0, text: "AnyChart",
      url: "http://anychart.com", alt: "AnyChart.com", inChart: !1
    },
    ...
    bounds: {
      ...
      width: null, height: null, minWidth: null, minHeight: null, maxWidth: null, maxHeight: null
    },
  ...
  cartesianBase: {
    defaultSeriesSettings: {
      base: {
        ...
        hoverFill: function() {
          ...
          enabled: !1, fontFamily: "Arial", fontSize: 11, background: {enabled: !1}, padding: {top: 2, right: 4, bottom: 2, left: 4}, position: "centerTop",
          anchor: "center", offsetX: 0, offsetY: 0, rotation: 0, width: null, height: null, textFormatter: function() {
            return this.value
          }, positionFormatter: function() {
            return this.value
          }
        ...
        hoverWhiskerWidth: "20%", outlierMarkers: {
        ...
        selectSize: 12, hatchFill: !1, tooltip: {
          textFormatter: function() {
      ...
      rangeArea: {
        labels: {anchor: "bottom"}, highStroke: function() {
          ...
          content: {hAlign: "left"}, textFormatter: function() {
            return "High: " + this.valuePrefix + parseFloat(this.high).toFixed(2) + this.valuePostfix + "\nLow: " +
                this.valuePrefix + parseFloat(this.low).toFixed(2) + this.valuePostfix
          }
        }
      }, rangeBar: {
        ...
        tooltip: {
          content: {hAlign: "left"}, textFormatter: function() {
            return "High: " + this.valuePrefix + parseFloat(this.high).toFixed(2) +
                this.valuePostfix + "\nLow: " + this.valuePrefix + parseFloat(this.low).toFixed(2) + this.valuePostfix
          }
        }
      }, rangeSplineArea: {
    ...
    defaultYAxisSettings: {enabled: !0, orientation: "left", title: {enabled: !0, text: "Y-Axis"}, minorTicks: {enabled: !0}, width: null, scale: 1},
    ...
    defaultTextMarkerSettings: {
      enabled: !0, fontSize: 11, fontFamily: "Tahoma", fontColor: "#222222",
      fontWeight: "bold", value: 0, anchor: "center", align: "center", layout: "horizontal", offsetX: 0, offsetY: 0, text: "Text marker", width: null, height: null, zIndex: 25.3, scale: 1
    },
    ...
    crosshair: {
      enabled: !1, displayMode: "float", xStroke: "#000", yStroke: "#000", xLabel: {
        ...
        text: "Label text",
        background: {enabled: !0, fill: "#000 .85", stroke: "none"},
    ...
    xScroller: {
      enabled: !1, fill: "#fff", selectedFill: "#1976d2 0.2", outlineStroke: "none",
      height: 10, minHeight: null, maxHeight: null, autoHide: !1, orientation: "bottom", position: "afterAxes", allowRangeChange: !0, thumbs: {enabled: !0, autoHide: !1, fill: "#f7f7f7", stroke: "#7c868e", hoverFill: "#ffffff", hoverStroke: "#545f69"}, zIndex: 35
    }
  },
  area: {
    title: {enabled: !0}, background: {enabled: !0}, xAxes: [{scale: 0}], yAxes: [{scale: 1}], grids: [{layout: "horizontal"}, {layout: "vertical", evenFill: "none", oddFill: "none", scale: 0}], minorGrids: [{evenFill: "none", oddFill: "none", stroke: "#000 0.075", layout: "horizontal"}], padding: {
      top: 10,
  ...
  bar: {
    ...
    minorGrids: [{
      evenFill: "none", oddFill: "none",
      stroke: "#000 0.075", layout: "vertical"
    }],
  ...
  box: {
    title: {enabled: !0}, background: {enabled: !0}, xAxes: [{}], yAxes: [{}], grids: [{
      layout: "horizontal",
      evenFill: "#fff", oddFill: "#fff"
    }], minorGrids: [{evenFill: "none", oddFill: "none", stroke: "#000 0.075", layout: "horizontal"}], padding: {top: 10, right: 20, bottom: 10, left: 20}
  },
  column: {
    title: {enabled: !0},
    background: {enabled: !0},
  ...
  financial: {
    ...
    yAxes: [{}],
    grids: [{layout: "horizontal"},
      {layout: "vertical", evenFill: "none", oddFill: "none", scale: 0}],
    minorGrids: [{evenFill: "none", oddFill: "none", stroke: "#000 0.075", layout: "horizontal"}],
  ...
  heatMap: {
    scales: [{type: "ordinal", inverted: !1, names: [], ticks: {interval: 1}}, {
      type: "ordinal",
      inverted: !0, names: [], ticks: {interval: 1}
    }, {type: "ordinalColor"}],
    xScale: 0,
    yScale: 1,
    colorScale: 2,
    ...
    tooltip: {
      enabled: !0, title: {enabled: !0, fontSize: 13, fontWeight: "normal"}, content: {fontSize: 11}, separator: {enabled: !0}, titleFormatter: function() {
        ...
        if (void 0 !== this.heat) {
          ...
          isNaN(+this.heat) || (a += "\nPercent Value: " +
          (100 * this.heat / this.getStat("sum")).toFixed(1) + "%");
          return a
        }
    ...
    selectStroke: null,
    labels: {
      enabled: !1, fontSize: 11, adjustFontSize: {width: !0, height: !0}, minFontSize: 7, maxFontSize: 15, hAlign: "center", vAlign: "center", textWrap: "noWrap", fontWeight: "normal", fontColor: "#333", selectable: !1,
      background: {enabled: !1}, padding: {top: 2, right: 4, bottom: 2, left: 4}, position: "center", anchor: "center", offsetX: 0, offsetY: 0, rotation: 0, width: null, height: null, textFormatter: function() {
        return this.heat
      }, positionFormatter: function() {
        return this.value
      }
    ...
    selectLabels: {fontColor: "#f5f500", enabled: null},
    markers: {
    ...
    xScroller: {
      ...
      position: "afterAxes",
      allowRangeChange: !0,
      thumbs: {enabled: !0, autoHide: !1, fill: "#f7f7f7", stroke: "#7c868e", hoverFill: "#ffffff", hoverStroke: "#545f69"},
      zIndex: 35
    },
  ...
  scatter: {
    ...
    defaultMinorGridSettings: {
      ...
      drawFirstLine: !0, drawLastLine: !0, oddFill: "#ffffff", evenFill: "#f5f5f5", stroke: "#c1c1c1", zIndex: 10, scale: 1
    },
    defaultXAxisSettings: {enabled: !0, orientation: "bottom", title: {enabled: !0, text: "X-Axis"}, minorTicks: {enabled: !0}, scale: 0},
    ...
    scales: [{type: "linear", inverted: !1, maximum: null, minimum: null, minimumGap: .1, maximumGap: .1, softMinimum: null, softMaximum: null, ticks: {mode: "linear", base: 0, minCount: 4, maxCount: 6}, minorTicks: {mode: "linear", base: 0, count: 5}, stackMode: "none", stickToZero: !0}, {
      type: "linear",
      inverted: !1, maximum: null, minimum: null, minimumGap: .1, maximumGap: .1, softMinimum: null, softMaximum: null, ticks: {mode: "linear", base: 0, minCount: 4, maxCount: 6}, minorTicks: {mode: "linear", base: 0, count: 5}, stackMode: "none", stickToZero: !0
    }],
    xScale: 0,
    yScale: 1,
    maxBubbleSize: "20%",
    ...
    crosshair: {
      enabled: !1, displayMode: "float", xStroke: "#000", yStroke: "#000", xLabel: {
        ...
        axisIndex: 0, textFormatter: function() {
          return this.value
        }, enabled: !0, fontSize: 11, fontFamily: "Tahoma", fontColor: "#fff", fontWeight: 400, textWrap: "byLetter", disablePointerEvents: !0, text: "Label text", background: {
          enabled: !0,
          fill: "#000 .85", stroke: "none"
        }, padding: {top: 6, right: 10, bottom: 6, left: 10}, width: null, height: null, anchor: "leftTop", offsetX: 0, offsetY: 0, position: "leftTop", minFontSize: 8, maxFontSize: 72, adjustFontSize: {width: !1, height: !1}, rotation: 0
      }
    }
  },
  marker: {},
  ...
  bullet: {
    ...
    axis: {
      stroke: "none", title: {enabled: !1, zIndex: 3}, labels: {zIndex: 3}, minorLabels: {fontSize: 11, padding: {top: 1, right: 1, bottom: 0, left: 1}, zIndex: 3}, ticks: {zIndex: 3},
      minorTicks: {enabled: !0, zIndex: 3}, zIndex: 3
    },
    ranges: [],
  ...
  pie: {
    title: {text: "Pie Chart", margin: {bottom: 0}},
    group: !1,
    sort: "none",
    radius: "45%",
    innerRadius: 0,
  ...
  cartesian3d: {
    zDepth: 10, zAngle: 45, defaultSeriesType: "column", zPadding: !1, defaultSeriesSettings: {
      base: {
        stroke: "none", hoverStroke: f, selectStroke: f, fill: f, hoverFill: function() {
  ...
  area3d: {zDepth: 10, zAngle: 45, zPadding: !1},
  ...
  pieFunnelPyramidBase: {
    baseWidth: "90%", connectorLength: 20, connectorStroke: "#000", overlapMode: "noOverlap", pointsPadding: 5, fill: function() {
      ...
      enabled: !0, fontSize: 13, fontFamily: "Arial", fontColor: null,
      disablePointerEvents: !1, background: {enabled: !1}, padding: {top: 1, right: 1, bottom: 1, left: 1}, position: "outsideLeftInColumn", anchor: "center", rotation: 0, width: null, height: null, textFormatter: function() {
      ...
      enabled: !1, rotation: 0, anchor: "center", position: null, offsetX: 0, offsetY: 0,
      size: 8, positionFormatter: function() {
        return this.value
      }, zIndex: 33
  ...
  radar: {
    defaultSeriesSettings: {
      base: {
        ...
        markers: {enabled: !0, position: "center"}, stroke: function() {
          return this.sourceColor
        }, hoverStroke: function() {
          return window.anychart.color.lighten(this.sourceColor)
        }, selectStroke: function() {
    ...
    xAxis: {stroke: "#C0C0C0", ticks: {stroke: "#333333"}, scale: 0, zIndex: 25},
  ...
  polar: {
    defaultSeriesSettings: {
      base: {
        ...
        markers: {enabled: !0}, stroke: function() {
          return this.sourceColor
        }, hoverStroke: function() {
          return window.anychart.color.lighten(this.sourceColor)
        }, selectStroke: function() {
  ...
  sparkline: {
    ...
    defaultSeriesSettings: {
      ...
      column: {markers: {position: "centerTop"}, labels: {position: "centerTop", anchor: "centerBottom"}, negativeMarkers: {position: "centerBottom"}, negativeLabels: {position: "centerBottom", anchor: "centerTop"}, fill: "#87ceeb", negativeFill: "#ffc0cb"},
      line: {stroke: "#4682b4"},
      winLoss: {
    ...
    maxMarkers: {fill: "#f00", stroke: "#000 0.5"},
    labels: {},
    firstLabels: {},
    lastLabels: {},
    negativeLabels: {},
    ...
    tooltip: {
      title: !1,
      separator: !1, titleFormatter: function() {
        return this.x
      }, textFormatter: function() {
        return "x: " + this.x + "\ny: " + this.value
      }
  ...
  circularGauge: {
    ...
    padding: {top: 0, right: 0, bottom: 0, left: 0},
    defaultAxisSettings: {
      startAngle: null, labels: {position: "inside", adjustFontSize: !0}, minorLabels: {position: "inside", adjustFontSize: !0}, fill: "black .3", ticks: {hatchFill: !1, type: "line", position: "center", length: null, fill: "red", stroke: "none"}, minorTicks: {
    ...
    defaultPointerSettings: {
      ...
      bar: {position: "center"},
      marker: {position: "inside", type: "triangleUp"},
      needle: {},
  ...
  map: {
    defaultSeriesSettings: {
      base: {
        ...
        selectStroke: {thickness: .5, color: "#545f69"},
        hatchFill: !1,
        labels: {
        ...
        markers: {enabled: !1, disablePointerEvents: !1, size: 4},
      ...
      enabled: !1, stroke: null, orientation: "bottom", title: {enabled: !1}, colorLineSize: 20, padding: {top: 10, right: 0, bottom: 20, left: 0}, align: "center", length: "70%", marker: {
        fill: "#545f69", hoverFill: "#545f69", stroke: "#545f69", hoverStroke: "#545f69", positionFormatter: function() {
          return this.value
        }, legendItem: {iconStroke: null}, enabled: !0, disablePointerEvents: !1, position: "center", rotation: 0, anchor: "center", offsetX: 0,
        offsetY: 0, type: "triangleDown", size: 15
      }, labels: {offsetX: 0}, ticks: {stroke: {thickness: 3, color: "#fff", position: "center", length: 20}}, minorTicks: {enabled: !1}
    }, unboundRegions: {enabled: !0, fill: "#F7F7F7", stroke: "#B9B9B9"}, linearColor: {colors: ["#fff", "#ffd54f", "#ef6c00"]}, maxBubbleSize: "20%", minBubbleSize: "5%", geoIdField: "id", interactivity: {
      copyFormatter: function(a) {
        a = a.seriesStatus;
        for (var b = "", c = 0, g = a.length; c < g; c++) {
          var d = a[c];
          if (0 != d.points.length) {
            for (var b = b + ("Series " + d.series.index() + ":\n"), e = 0, h = d.points.length; e <
            h; e++) {
              var k = d.points[e], b = b + ("id: " + k.id + " index: " + k.index);
              e != h - 1 && (b += "\n")
            }
            c != g - 1 && (b += "\n")
          }
  ...
  defaultDataGrid: {
    ...
    defaultColumnSettings: {
      width: 90,
      cellTextSettings: {anchor: "leftTop", vAlign: "middle", padding: {top: 0, right: 5, bottom: 0, left: 5}, textWrap: "noWrap", background: null, rotation: 0, width: null, height: null, fontSize: 11, minFontSize: 8, maxFontSize: 72, disablePointerEvents: !0},
  ...
  gantt: {
    base: {
      ...
      rowStroke: "#ccd7e1", title: {enabled: !1}, credits: {inChart: !0}, background: {fill: "#fff"}, margin: {top: 0, right: 0, bottom: 0, left: 0}, padding: {top: 0, right: 0, bottom: 0, left: 0}, dataGrid: {}, timeline: {
        ...
        headerHeight: 70,
        editing: !1,
        connectorPreviewStroke: {color: "#0000ff", dash: "3 3", opacity: .6},
        ...
        labelsFactory: {
          anchor: "leftCenter", position: "rightCenter", padding: {top: 3, right: 5, bottom: 3, left: 5}, vAlign: "middle",
          textWrap: "noWrap", background: null, rotation: 0, width: null, height: null, fontSize: 11, minFontSize: 8, maxFontSize: 72, zIndex: 40, disablePointerEvents: !0
        },
        markersFactory: {anchor: "centerTop", zIndex: 50, type: "star4", fill: "#ff0", stroke: "#000"},
        defaultLineMarkerSettings: {layout: "vertical"},
        defaultRangeMarkerSettings: {layout: "vertical"},
        defaultTextMarkerSettings: {layout: "vertical"},
        header: {
          labelsFactory: {
            anchor: "leftTop", vAlign: "middle", padding: {top: 0, right: 5, bottom: 0, left: 5}, textWrap: "noWrap", background: null, rotation: 0,
            width: null, height: null, fontSize: 11, minFontSize: 8, maxFontSize: 72, disablePointerEvents: !0
          }
        }
      }
    }, ganttResource: {
        ...
        selectedElementStroke: "none", tooltip: {
          titleFormatter: function() {
            ...
            var a = this.periodStart ||
                this.minPeriodDate, b = this.periodEnd || this.maxPeriodDate;
            return (a ? "Start Date: " + window.anychart.format.dateTime(a) : "") + (b ? "\nEnd Date: " + window.anychart.format.dateTime(b) : "")
          }
        }
      }
  ...
  stock: {
    defaultPlotSettings: {
      ...
      defaultGridSettings: {
        enabled: !0, isMinor: !1, layout: "horizontal", drawFirstLine: !0, drawLastLine: !0, oddFill: null,
        evenFill: null, stroke: "#cecece", scale: 0, zIndex: 11
      },
      defaultMinorGridSettings: {enabled: !0, isMinor: !0, layout: "horizontal", drawFirstLine: !0, drawLastLine: !0, oddFill: null, evenFill: null, stroke: "#eaeaea", scale: 0, zIndex: 10},
      ...
      legend: {
        ...
        paginator: {
          enabled: !0, fontSize: 12, fontColor: "#545f69", background: {
            enabled: !1, fill: {keys: ["#fff", "#f3f3f3", "#fff"], angle: "90"},
            stroke: {keys: ["#ddd", "#d0d0d0"], angle: "90"}
          }, padding: {top: 0, right: 0, bottom: 0, left: 0}, margin: {top: 0, right: 0, bottom: 0, left: 0}, orientation: "right", layout: "horizontal", zIndex: 30
        },
      ...
      }, enabled: !0, fill: "#fff", selectedFill: "#1976d2 0.2",
      outlineStroke: "#cecece", height: 40, minHeight: null, maxHeight: null, thumbs: {enabled: !0, autoHide: !1, fill: "#f7f7f7", stroke: "#7c868e", hoverFill: "#ffffff", hoverStroke: "#545f69"}, zIndex: 40, xAxis: {
        background: {enabled: !1}, minorTicks: {enabled: !0, stroke: "#cecece"}, labels: {
          ...
          enabled: !0, anchor: "leftTop", fontSize: "11px", padding: {
            top: 5,
  ...
  standalones: {
    ...
    label: {
      enabled: !0, fontSize: 11, fontFamily: "Tahoma", fontWeight: "bold", textWrap: "byLetter", text: "Label text",
      background: {enabled: !1}, padding: {top: 0, right: 0, bottom: 0, left: 0}, width: null, height: null, anchor: "leftTop", position: "leftTop", offsetX: 0, offsetY: 0, minFontSize: 8, maxFontSize: 72, adjustFontSize: {width: !1, height: !1}, rotation: 0, zIndex: 0
    },
    labelsFactory: {enabled: !0, background: {enabled: !1, stroke: "#000"}, zIndex: 0},
    legend: {
      enabled: !0,
      position: "bottom",
      align: "center",
    ...
    linearAxis: {enabled: !0, zIndex: 0, minorTicks: {enabled: !0}},
    polarAxis: {enabled: !0, stroke: {color: "black", opacity: .1, lineJoin: "round", lineCap: "square"}, zIndex: 0},
    radarAxis: {enabled: !0, stroke: {color: "black", opacity: .1, lineJoin: "round", lineCap: "square"}, zIndex: 0},
    radialAxis: {enabled: !0, minorLabels: {padding: {top: 1, right: 1, bottom: 0, left: 1}}},
    linearGrid: {
      enabled: !0, isMinor: !1, layout: "horizontal",
      drawFirstLine: !0, drawLastLine: !0, oddFill: "#fff", evenFill: "#f5f5f5", stroke: "#c1c1c1", scale: null
    },
    ...
    lineAxisMarker: {enabled: !0, value: 0, layout: "horizontal", stroke: {color: "#DC0A0A", thickness: 1, opacity: 1, dash: "", lineJoin: "miter", lineCap: "square"}},
    textAxisMarker: {
      enabled: !0,
      fontSize: 11, fontFamily: "Tahoma", fontWeight: "bold", value: 0, anchor: "center", align: "center", layout: "horizontal", offsetX: 0, offsetY: 0, text: "Text marker", width: null, height: null
    },
    rangeAxisMarker: {enabled: !0, from: 0, to: 0, layout: "horizontal", fill: "#000 0.3"},
    dataGrid: {isStandalone: !0, backgroundFill: "#fff", zIndex: 0},
    scroller: {
      enabled: !0, fill: "#fff", selectedFill: "#e2e2e2", outlineStroke: "#fff", height: 40, minHeight: null, maxHeight: null, thumbs: {
        enabled: !0, autoHide: !1, fill: "#f7f7f7", stroke: "#545f69", hoverFill: "#ccc",
        hoverStroke: "#000"
      }
    }
  }
