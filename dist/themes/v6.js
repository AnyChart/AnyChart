...
window.anychart.themes.v6 = {
  ...
  defaultTooltip: {
    ...
    separator: {
      enabled: !1, width: "100%", height: 1, margin: {top: 0, right: 5, bottom: 0, left: 5}, orientation: "top", fill: ["0 #333333 0",
        "0.5 #333333 1", "1 #333333 0"], stroke: "none", zIndex: 1
    },
    content: {
      enabled: !0,
      fontSize: 10,
    ...
    background: {
      enabled: !0, fill: ["0 #fff 1", "0.5 #f3f3f3 1",
        "1 #fff 1"], stroke: ["0 #ddd 1", "1 #d0d0d0 1"], cornerType: "none", corners: 10, zIndex: 0
    },
  ...
  chart: {
    ...
    defaultLabelSettings: {
      enabled: !0, fontSize: 11, fontFamily: "Tahoma", fontWeight: "bold", textWrap: "byLetter", text: "Chart label",
      background: {enabled: !1}, padding: {top: 0, right: 0, bottom: 0, left: 0}, width: null, height: null, anchor: "leftTop", position: "leftTop", offsetX: 0, offsetY: 0, minFontSize: 8, maxFontSize: 72, adjustFontSize: {width: !1, height: !1}, rotation: 0, zIndex: 50
    },
    chartLabels: [],
    ...
    defaultSeriesSettings: {
      base: {
        ...
        hoverStroke: function() {
          ...
          mode: "both", xError: null, xUpperError: null, xLowerError: null, valueError: null, valueUpperError: null, valueLowerError: null, xErrorWidth: 10,
          valueErrorWidth: 10, xErrorStroke: "#1D8BD1", valueErrorStroke: "#1D8BD1"
        ...
        labels: {position: "center", anchor: "center"}, displayNegative: !1, negativeFill: function() {
      ...
      }, column: {markers: {position: "centerTop"}, labels: {position: "centerTop"}},
      line: {
  ...
  column: {
    title: {enabled: !0}, background: {enabled: !0}, xAxes: [{}], yAxes: [{}],
    grids: [{layout: "horizontal"}, {layout: "vertical", evenFill: "none", oddFill: "none", scale: 0}], minorGrids: [{evenFill: "none", oddFill: "none", stroke: "#000 0.075", layout: "horizontal"}], padding: {top: 10, right: 20, bottom: 10, left: 20}
  },
  financial: {
    title: {enabled: !0},
    background: {enabled: !0},
    ...
    minorGrids: [{evenFill: "none", oddFill: "none", stroke: "#000 0.075", layout: "horizontal"}],
    scales: [{
      type: "dateTime", inverted: !1, maximum: null, minimum: null, minimumGap: .1,
      maximumGap: .1, softMinimum: null, softMaximum: null, ticks: {count: 4}, minorTicks: {count: 4}
  ...
  line: {
    title: {enabled: !0}, background: {enabled: !0}, xAxes: [{}], yAxes: [{}], grids: [{layout: "horizontal"}, {
      layout: "vertical", evenFill: "none",
      oddFill: "none", scale: 0
    }], minorGrids: [{evenFill: "none", oddFill: "none", stroke: "#000 0.075", layout: "horizontal"}], padding: {top: 10, right: 20, bottom: 10, left: 20}, interactivity: {hoverMode: "byX"}
  },
  scatter: {
    defaultSeriesSettings: {
      base: {
    ...
    defaultMinorGridSettings: {
      enabled: !0, isMinor: !0, layout: "horizontal", drawFirstLine: !0, drawLastLine: !0, oddFill: "#ffffff", evenFill: "#f5f5f5",
      stroke: "#c1c1c1", zIndex: 10, scale: 1
    },
    ...
    defaultTextMarkerSettings: {
      ...
      fontColor: "#222222", fontWeight: "bold", value: 0, anchor: "center", align: "center", layout: "horizontal", offsetX: 0, offsetY: 0, text: "Text marker", width: null, height: null, zIndex: 25.3, scale: 1
    },
    defaultRangeMarkerSettings: {enabled: !0, from: 0, to: 0, layout: "horizontal", fill: "#000 0.3", zIndex: 25.1, scale: 1},
    series: [],
    grids: [{oddFill: "#f9f9f9", evenFill: "#ffffff", layout: "horizontal"}, {oddFill: "none", evenFill: "none", layout: "vertical", scale: 0}],
    minorGrids: [{oddFill: "none", evenFill: "none", stroke: "#000 0.1", layout: "horizontal"},
      {oddFill: "none", evenFill: "none", stroke: "#000 0.1", layout: "vertical", scale: 0}],
    xAxes: [{}],
    yAxes: [{}],
    lineAxesMarkers: [],
    rangeAxesMarkers: [],
    ...
    crosshair: {
      enabled: !1, displayMode: "float", xStroke: "#000", yStroke: "#000", xLabel: {
        ...
        anchor: "leftTop", offsetX: 0, offsetY: 0, position: "leftTop", minFontSize: 8, maxFontSize: 72, adjustFontSize: {width: !1, height: !1}, rotation: 0
      }
    }
  },
  marker: {},
  ...
  bullet: {
    ...
    scale: {
      type: "linear", ticks: {
        mode: "linear",
        base: 0, explicit: null, minCount: 3, maxCount: 5, interval: NaN
      }, minorTicks: {mode: "linear", base: 0, explicit: null, count: 5, interval: NaN}, stackMode: "none", stickToZero: !0, minimumGap: 0, maximumGap: 0, softMinimum: null, softMaximum: null, minimum: null, maximum: null, inverted: !1
    },
  ...
  pieFunnelPyramidBase: {
    baseWidth: "90%", connectorLength: 20, connectorStroke: "#000", overlapMode: "noOverlap", pointsPadding: 5, fill: function() {
      ...
      enabled: !0, fontSize: 13, fontFamily: "Arial", fontColor: null, disablePointerEvents: !1, background: {enabled: !1},
      padding: {top: 1, right: 1, bottom: 1, left: 1}, position: "outsideLeftInColumn", anchor: "center", rotation: 0, width: null, height: null, textFormatter: function() {
  ...
  pyramid: {
    title: {text: "Pyramid Chart"}, reversed: !1,
    legend: {inverted: !0}
  },
  radar: {
    defaultSeriesSettings: {
    ...
    defaultMinorGridSettings: {
      enabled: !1, isMinor: !0, layout: "circuit", drawFirstLine: !1, drawLastLine: !1, oddFill: "none", evenFill: "none", stroke: "#333333",
      zIndex: 10, xScale: 0, yScale: 1
    },
  ...
  polar: {
    defaultSeriesSettings: {
      base: {
        enabled: !0, hatchFill: null, labels: {enabled: !1, position: "center", anchor: "bottom"}, hoverLabels: {enabled: null, position: "center"}, markers: {
          enabled: !1, disablePointerEvents: !1, position: "center", rotation: 0, anchor: "center", offsetX: 0,
          offsetY: 0, size: 4, positionFormatter: function() {
            return this.value
          }
        }, hoverMarkers: {size: 6}, tooltip: {
          titleFormatter: function() {
    ...
    defaultGridSettings: {
      enabled: !0,
      isMinor: !1, layout: "radial", drawFirstLine: !1, drawLastLine: !1, oddFill: "none", evenFill: "none", stroke: "#DDDDDD", zIndex: 10, xScale: 0, yScale: 1
    },
  ...
  sparkline: {
    ...
    defaultSeriesSettings: {
      base: {
        markers: {
          enabled: !1, type: "circle",
          size: 1.5, position: "center"
        }, labels: {enabled: !1, background: {enabled: !1}, position: "center", anchor: "centerBottom"}, color: "#4682B4"
      },
      ...
      winLoss: {
        markers: {position: "centerTop", anchor: "centerTop"}, labels: {
          position: "centerTop",
          anchor: "centerTop"
        }, negativeMarkers: {position: "centerBottom", anchor: "centerBottom"}, negativeLabels: {position: "centerBottom", anchor: "centerBottom"}, fill: "#305374", negativeFill: "#cb6762"
      }
    },
    defaultLineMarkerSettings: {enabled: !0, value: 0, layout: "horizontal", stroke: {color: "#DC0A0A", thickness: 1, opacity: 1, dash: "", lineJoin: "miter", lineCap: "square"}, zIndex: 25.2, scale: 1},
    defaultTextMarkerSettings: {
      enabled: !0, fontSize: 11, fontFamily: "Tahoma", fontColor: "#222222", fontWeight: "bold", value: 0, anchor: "center", align: "center",
      layout: "horizontal", offsetX: 0, offsetY: 0, text: "Text marker", width: null, height: null, zIndex: 25.3, scale: 1
    },
    defaultRangeMarkerSettings: {enabled: !0, from: 0, to: 0, layout: "horizontal", fill: "#000 0.3", zIndex: 25.1, scale: 1},
    hatchFill: null,
    markers: {},
  ...
  circularGauge: {
    ...
    defaultPointerSettings: {
      base: {enabled: !0, fill: "#f22922", stroke: "#f22922", hatchFill: !1, axisIndex: 0}, bar: {position: "center"}, marker: {position: "inside", type: "triangleUp"},
      needle: {}, knob: {fill: {keys: ["rgb(255, 255, 255)", "rgb(220, 220, 220)"], angle: 135}, stroke: "2 #ccc", verticesCount: 6, verticesCurvature: .5, topRatio: .5, bottomRatio: .5}
    },
  ...
  map: {
    defaultSeriesSettings: {
      ...
      enabled: !1, stroke: null, orientation: "bottom", title: {enabled: !1}, colorLineSize: 20, padding: {top: 10, right: 0, bottom: 20, left: 0}, align: "center", length: "70%", marker: {
        fill: "#545f69", hoverFill: "#545f69", stroke: "#545f69", hoverStroke: "#545f69", positionFormatter: function() {
          return this.value
        }, legendItem: {iconStroke: null}, enabled: !0,
        disablePointerEvents: !1, position: "center", rotation: 0, anchor: "center", offsetX: 0, offsetY: 0, type: "triangleDown", size: 15
    ...
    }, maxBubbleSize: "20%", minBubbleSize: "5%"
  },
  defaultDataGrid: {
    isStandalone: !1,
    titleHeight: 25,
    ...
    defaultColumnSettings: {
      width: 90, cellTextSettings: {
        anchor: "leftTop", vAlign: "middle", padding: {top: 0, right: 5, bottom: 0, left: 5}, textWrap: "noWrap", background: null,
        rotation: 0, width: null, height: null, fontSize: 11, minFontSize: 8, maxFontSize: 72
      }, depthPaddingMultiplier: 0, collapseExpandButtons: !1, title: {margin: {top: 0, right: 0, bottom: 0, left: 0}, textWrap: "noWrap", hAlign: "center", vAlign: "middle", background: {enabled: !1}}, textFormatter: function() {
        return ""
      }
    },
    columns: [{
      ...
      dataGrid: {
        ...
        selectedElementStroke: "none", tooltip: {
          textFormatter: function(a) {
            ...
            a = b.get("name");
            var e = c ? c.start : b.get("actualStart") || b.meta("autoStart"), b = c ? c.end : b.get("actualEnd") ||
            b.meta("autoEnd");
  ...
  stock: {
    defaultPlotSettings: {
      defaultSeriesSettings: {
        ...
        enabled: !0,
        isMinor: !1, layout: "horizontal", drawFirstLine: !0, drawLastLine: !0, oddFill: null, evenFill: null, stroke: "#cecece", scale: 0, zIndex: 11
      }, defaultMinorGridSettings: {enabled: !0, isMinor: !0, layout: "horizontal", drawFirstLine: !0, drawLastLine: !0, oddFill: null, evenFill: null, stroke: "#eaeaea", scale: 0, zIndex: 10}, defaultYAxisSettings: {
        enabled: !0, orientation: "left", title: {enabled: !1, text: "Y-Axis"}, staggerMode: !1, staggerLines: null, ticks: {enabled: !0}, width: 50, labels: {fontSize: "11px", padding: {top: 0, right: 5, bottom: 0, left: 5}},
      ...
      }], yScale: 0, zIndex: 10, xAxes: [{}], yAxes: [{}]
      ...
      defaultSeriesSettings: {
        base: {pointWidth: "75%"}, line: {stroke: "#999 0.9", selectedStroke: "1.5 #64b5f6"}, column: {fill: "#64b5f6 0.6", stroke: "none", selectedFill: "#64b5f6 0.9", selectedStroke: "none"}, ohlc: {
          risingStroke: "#1976d2 0.6", fallingStroke: "#ef6c00 0.6",
          selectedRisingStroke: "#1976d2 0.9", selectedFallingStroke: "#ef6c00 0.9"
        }
      ...
      allowLeaveScreen: !1, allowLeaveChart: !0, displayMode: "union", positionMode: "float", title: {enabled: !0, fontSize: 13}, separator: {enabled: !0},
      titleFormatter: function() {
  ...
  standalones: {
    ...
    labelsFactory: {
      background: {enabled: !1, stroke: "#000"},
      zIndex: 0
    },
    legend: {
      position: "bottom",
      ...
      title: {
        enabled: !0, fontFamily: "Verdana", fontSize: 10, fontColor: "#232323", text: "Legend Title",
        background: {enabled: !1, stroke: {keys: ["0 #DDDDDD 1", "1 #D0D0D0 1"], angle: "90"}, fill: {keys: ["0 #FFFFFF 1", "0.5 #F3F3F3 1", "1 #FFFFFF 1"], angle: "90"}}, padding: {top: 0, right: 0, bottom: 0, left: 0}, margin: {top: 0, right: 0, bottom: 3, left: 0}
      },
      paginator: {
        enabled: !0, fontColor: "#232323", orientation: "right", margin: {top: 0, right: 0, bottom: 0, left: 0}, padding: {top: 0, right: 0, bottom: 0, left: 0}, background: {
    ...
    radarAxis: {
      stroke: {
        color: "black",
        opacity: .1, lineJoin: "round", lineCap: "square"
      }, zIndex: 0
    },
    radialAxis: {minorLabels: {padding: {top: 1, right: 1, bottom: 0, left: 1}}},
    ...
    radarGrid: {
      enabled: !0, isMinor: !1, layout: "circuit", drawLastLine: !0, oddFill: "#fff 0.3", evenFill: "#f5f5f5 0.3",
      stroke: "#c1c1c1"
    },
    ...
    scroller: {
      enabled: !0,
      fill: "#fff", selectedFill: "#e2e2e2", outlineStroke: "#fff", height: 40, minHeight: null, maxHeight: null, thumbs: {enabled: !0, autoHide: !1, fill: "#f7f7f7", stroke: "#545f69", hoverFill: "#ccc", hoverStroke: "#000"}
    }
  }
};
