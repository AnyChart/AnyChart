window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['es-pr'] = {
  code: 'es-pr',
  engName: 'Spanish (Puerto Rico)',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'MM/dd/y, h:mm:ss a',
    formats: {
      full_year: 'yyyy',
