window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['fi-fi'] = {
  code: 'fi-fi',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd.M.y',
    timeFormat: 'H.mm.ss',
    dateTimeFormat: 'd.M.y \'klo\' H.mm.ss',
    formats: {
      full_year: 'yyyy',
