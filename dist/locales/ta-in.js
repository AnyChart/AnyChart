window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['ta-in'] = {
  code: 'ta-in',
  engName: 'Tamil (India)',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'd MMM, y ’அன்று’ h:mm:ss a',
    formats: {
      full_year: 'yyyy',
