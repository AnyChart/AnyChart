window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['fil-ph'] = {
  code: 'fil-ph',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'MMM d, y \'nang\' h:mm:ss a',
    formats: {
      full_year: 'yyyy',
