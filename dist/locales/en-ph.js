window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['en-ph'] = {
  code: 'en-ph',
  engName: 'English (Republic of the Philippines)',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'd MMM y \'at\' h:mm:ss a',
    formats: {
      full_year: 'yyyy',
