window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['is-is'] = {
  code: 'is-is',
  engName: 'Icelandic (Iceland)',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd. MMM y',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'd. MMM y \'kl.\' HH:mm:ss',
    formats: {
      full_year: 'yyyy',
