window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['en-za'] = {
  code: 'en-za',
  engName: 'English (South Africa)',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'dd MMM y \'at\' h:mm:ss a',
    formats: {
      full_year: 'yyyy',
