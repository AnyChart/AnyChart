window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['fa-ir'] = {
  code: 'fa-ir',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd MMM y',
    timeFormat: 'H:mm:ss',
    dateTimeFormat: 'd MMM y، ساعت H:mm:ss',
    formats: {
      full_year: 'yyyy',
