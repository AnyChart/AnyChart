window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['lo-la'] = {
  code: 'lo-la',
  engName: 'Lao (Laos)',
  nativeName: 'ລາວ (ລາວ)',
  dateTimeLocale: {
    ...
    standaloneNarrowWeekdays: ['ອ', 'ຈ', 'ອ', 'ພ', 'ພຫ', 'ສຸ', 'ສ'],
