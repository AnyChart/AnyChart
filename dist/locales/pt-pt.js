window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['pt-pt'] = {
  code: 'pt-pt',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'dd/MM/y',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'dd/MM/y \'às\' HH:mm:ss',
    formats: {
      full_year: 'yyyy',
