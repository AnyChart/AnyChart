window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['lv-lv'] = {
  code: 'lv-lv',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'y. \'gada\' d. MMM',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'y. \'gada\' d. MMM HH:mm:ss',
    formats: {
      full_year: 'yyyy',
