window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['kn-in'] = {
  code: 'kn-in',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'MMM d, y hh:mm:ss a',
    formats: {
      full_year: 'yyyy',
