window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['uk-ua'] = {
  code: 'uk-ua',
  ...
  dateTimeLocale: {
    ...
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'd MMM y \'р\'. HH:mm:ss',
    formats: {
      full_year: 'yyyy',
