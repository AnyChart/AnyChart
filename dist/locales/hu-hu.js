window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['hu-hu'] = {
  code: 'hu-hu',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'y. MMM d.',
    timeFormat: 'H:mm:ss',
    dateTimeFormat: 'y. MMM d. H:mm:ss',
    formats: {
      full_year: 'yyyy',
