window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['en-ca'] = {
  code: 'en-ca',
  engName: 'English (Canada)',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'MMM d, y \'at\' h:mm:ss a',
    formats: {
      full_year: 'yyyy',
