window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['hr-ba'] = {
  code: 'hr-ba',
  engName: 'Croatian (Bosnia and Herzegovina)',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd. MMM y.',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'd. MMM y. \'u\' HH:mm:ss',
    formats: {
      full_year: 'yyyy',
