window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['en-bz'] = {
  code: 'en-bz',
  engName: 'English (Belize)',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'dd-MMM-y',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'dd-MMM-y \'at\' HH:mm:ss',
    formats: {
      full_year: 'yyyy',
