window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['uz-latn-uz'] = {
  code: 'uz-latn-uz',
  engName: 'Uzbek (Latin, Uzbekistan)',
  nativeName: 'Uzbek (Uzbekiston Respublikasi)',
  dateTimeLocale: {
    eras: ['M.A.', 'E'],
    eraNames: ['M.A.', 'E'],
