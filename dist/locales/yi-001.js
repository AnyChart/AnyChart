window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['yi-001'] = {
  code: 'yi-001',
  ...
  dateTimeLocale: {
    ...
    standaloneShortMonths: ['יאַנ', 'פֿעב', 'מערץ', 'אַפּר', 'מיי', 'יוני', 'יולי', 'אויגוסט', 'סעפּ', 'אקט', 'נאוו', 'דעצ'],
    ...
    dateFormat: 'dטן MMM y',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'dטן MMM y HH:mm:ss',
    formats: {
      full_year: 'yyyy',
