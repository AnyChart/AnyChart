window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['bn-bd'] = {
  code: 'bn-bd',
  engName: 'Bangla (Bangladesh)',
  ...
  dateTimeLocale: {
    ...
    quarters: ['ত্রৈমাসিক', 'ষাণ্মাসিক', 'তৃতীয় চতুর্থাংশ', 'চতুর্থ ত্রৈমাসিক'],
    ampms: ['am', 'pm'],
    firstDayOfWeek: 4,
    weekendRange: [5, 6],
