window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['ml-in'] = {
  code: 'ml-in',
  ...
  dateTimeLocale: {
    ...
    narrowMonths: ['ജ', 'ഫ', 'മാ', 'ഏ', 'മെ', 'ജൂ', 'ജൂ', 'ഓ', 'സ', 'ഒ', 'ന', 'ഡി'],
    standaloneNarrowMonths: ['ജ', 'ഫ', 'മാ', 'ഏ', 'മേ', 'ജൂ', 'ജൂ', 'ഓ', 'സ', 'ഒ', 'ന', 'ഡി'],
    months: ['ജനുവരി', 'ഫെബ്രുവരി', 'മാർച്ച്', 'ഏപ്രിൽ', 'മേയ്', 'ജൂൺ', 'ജൂലൈ', 'ആഗസ്റ്റ്', 'സെപ്റ്റംബർ', 'ഒക്‌ടോബർ', 'നവംബർ', 'ഡിസംബർ'],
    standaloneMonths: ['ജനുവരി', 'ഫെബ്രുവരി', 'മാർച്ച്', 'ഏപ്രിൽ', 'മേയ്', 'ജൂൺ', 'ജൂലൈ', 'ആഗസ്റ്റ്', 'സെപ്റ്റംബർ', 'ഒക്‌ടോബർ', 'നവംബർ', 'ഡിസംബർ'],
    ...
    standaloneNarrowWeekdays: ['ഞ', 'തി', 'ച', 'ബു', 'വ', 'വെ', 'ശ'],
    ...
    dateTimeFormat: 'y, MMM d h:mm:ss a',
    formats: {
      full_year: 'yyyy',
