window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['sq-al'] = {
  code: 'sq-al',
  engName: 'Albanian (Albania)',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd MMM y',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'd MMM y \'në\' HH:mm:ss',
    formats: {
      full_year: 'yyyy',
