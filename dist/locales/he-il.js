window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['he-il'] = {
  code: 'he-il',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd בMMM y',
    timeFormat: 'H:mm:ss',
    dateTimeFormat: 'd בMMM y בשעה H:mm:ss',
    formats: {
      full_year: 'yyyy',
