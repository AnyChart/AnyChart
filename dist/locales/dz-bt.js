window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['dz-bt'] = {
  code: 'dz-bt',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'སྤྱི་ལོ་y ཟླ་MMM ཚེས་dd',
    timeFormat: 'ཆུ་ཚོད་h:mm:ss a',
    dateTimeFormat: 'སྤྱི་ལོ་y ཟླ་MMM ཚེས་dd ཆུ་ཚོད་h:mm:ss a',
    formats: {
      full_year: 'yyyy',
