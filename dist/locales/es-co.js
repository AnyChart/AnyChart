window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['es-co'] = {
  code: 'es-co',
  engName: 'Spanish (Colombia)',
  ...
  dateTimeLocale: {
    ...
    dateTimeFormat: 'd/MM/y, h:mm:ss a',
    formats: {
      full_year: 'yyyy',
