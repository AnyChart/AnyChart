window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['bg-bg'] = {
  code: 'bg-bg',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd.MM.y \'г\'.',
    timeFormat: 'H:mm:ss',
    dateTimeFormat: 'd.MM.y \'г\'., H:mm:ss',
    formats: {
      full_year: 'yyyy',
