window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['cy-gb'] = {
  code: 'cy-gb',
  engName: 'Welsh (United Kingdom)',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'd MMM y',
    timeFormat: 'HH:mm:ss',
    dateTimeFormat: 'd MMM y \'am\' HH:mm:ss',
    formats: {
      full_year: 'yyyy',
