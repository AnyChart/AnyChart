window['anychart']=window['anychart']||{};window['anychart']['format']=window['anychart']['format']||{};window['anychart']['format']['locales']=window['anychart']['format']['locales']||{};window['anychart']['format']['locales']['hy-am'] = {
  code: 'hy-am',
  ...
  dateTimeLocale: {
    ...
    dateFormat: 'dd MMM, yթ.',
    timeFormat: 'H:mm:ss',
    dateTimeFormat: 'dd MMM, yթ., H:mm:ss',
    formats: {
      full_year: 'yyyy',
